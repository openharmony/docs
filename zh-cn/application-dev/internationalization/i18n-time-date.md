...
2. 创建DateTimeFormat对象。
   ...
   构造函数支持通过DateTimeOptions设置不同的时间日期格式，具体请参考表1-表9。
...
以时间：2021年9月17日 13:04:00、2021年9月17日 00:25:00，locale: zh-CN为例，说明[DateTimeOptions](../reference/apis-localization-kit/js-apis-intl.md#datetimeoptions)不同的取值和显示结果。

**表1** 日期显示格式(dateStyle)

| 取值 | 2021年9月17日 13:04:00显示结果 |
| -------- | -------- |
| full | 2021年9月17日星期五 |
| long | 2021年9月17日 |
| short | 2021/9/17 |
...
| 取值 | 2021年9月17日 13:04:00显示效果 | 2021年9月17日 00:25:00显示效果 |
| -------- | -------- | -------- |
| h11 | 设置dateStyle或timeStyle时显示效果：下午13:04<br>不设置dateStyle或timeStyle时显示效果：下午1:04 |  设置dateStyle或timeStyle时显示效果：上午24:25<br>不设置dateStyle或timeStyle时显示效果：上午0:25 |
| h12 | 设置dateStyle或timeStyle时显示效果：下午1:04<br>不设置dateStyle或timeStyle时显示效果：下午1:04 |  设置dateStyle或timeStyle时显示效果：上午12:25<br>不设置dateStyle或timeStyle时显示效果：上午12:25 |
| h23 | 设置dateStyle或timeStyle时显示效果：1:04<br>不设置dateStyle或timeStyle时显示效果：13:04 | 设置dateStyle或timeStyle时显示效果：0:25<br>不设置dateStyle或timeStyle时显示效果：00:25 |
| h24 | 设置dateStyle或timeStyle时显示效果：13:04<br>不设置dateStyle或timeStyle时显示效果：13:04 | 设置dateStyle或timeStyle时显示效果：0:25<br>不设置dateStyle或timeStyle时显示效果：24:25 |
