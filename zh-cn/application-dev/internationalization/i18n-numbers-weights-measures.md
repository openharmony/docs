...
数字格式化通过[NumberFormat](../reference/apis/js-apis-intl.md#numberformat)的[format](../reference/apis/js-apis-intl.md#format-1)接口实现，具体开发步骤如下。
...
单位转换并根据区域和风格进行格式化，通过[I18NUtil](../reference/apis/js-apis-i18n.md#i18nutil9)类的[unitConvert](../reference/apis/js-apis-i18n.md#unitconvert9)接口实现，具体开发步骤如下。
