# <!--RP1-->Background Tasks Kit简介<!--RP1End-->
...
为了保障后台音乐播放、日历提醒等功能的正常使用，Background Tasks Kit提供了规范内受约束的后台任务，扩展应用在后台的运行时间。对于系统特权应用，Background Tasks Kit还支持统计设备使用信息，包括统计应用的使用时长等。
