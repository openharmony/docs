...
- AP模式（热点模式）：AP模式为加入无线局域网的成员设备（即客户端）提供下行数据业务，它提供以无线方式组建无线局域网WLAN，相当与WLAN的中心设备。详情请参考[@ohos.wifiManager API参考](../../reference/apis-connectivity-kit/js-apis-wifiManager.md)。
