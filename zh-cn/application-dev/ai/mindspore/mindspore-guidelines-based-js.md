...
- [基于ArkTS接口的MindSpore Lite应用开发（ArkTS）（API11）](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-5.0.1-Release/code/DocsSample/ApplicationModels/MindSporeLiteArkTSDemo)
