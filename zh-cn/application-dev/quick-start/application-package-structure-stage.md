...
- 在开发态，一个应用包含一个或者多个Module，可以在[DevEco Studio](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V1/tools-overview-0000001558763037-V1)工程中[创建一个或者多个Module](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V1/add_new_module-0000001053223741-V1 )。Module是应用/服务的基本功能单元，包含了源代码、资源文件、第三方库及应用/服务配置文件，每一个Module都可以独立进行编译和运行。Module分为“Ability”和“Library”两种类型，“Ability”类型的Module对应于编译后的HAP（Harmony Ability Package）；“Library”类型的Module对应于[HAR](har-package.md)（Harmony Archive），或者[HSP](shared-guide.md)（Harmony Shared Package）。
