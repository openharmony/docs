...
| debug | 标识应用是否可调试。<br/>-&nbsp;true：可以进行断点调试。<br/>-&nbsp;false：不可以进行断点调试。 | 布尔值 | 由IDE编译构建时生成。该标签可缺省，缺省值为false。 |
...
| multiProjects | 标识当前工程是否支持多个工程的联合开发。<br/>-&nbsp;true：当前工程支持多个工程的联合开发。多工程开发可参考<!--RP1-->[多工程构建](https://developer.harmonyos.com/cn/docs/documentation/doc-guides-V3/build_overview-0000001055075201-V3#section73401914284)<!--RP1End-->。<br/>-&nbsp;false：当前工程不支持多个工程的联合开发。 | 布尔值 | 该标签可缺省，缺省值为false。 |
...
| maxCount         | 标识最大允许的应用多开个数，支持的取值如下：<br/>-&nbsp;multiInstance模式：取值范围1\~10。<br/>-&nbsp;appClone模式：取值范围1\~5。<br/>注意：在appClone模式下，maxCount在应用更新时不允许减小。      | 数值  | 该标签可缺省，缺省值为0。 |
