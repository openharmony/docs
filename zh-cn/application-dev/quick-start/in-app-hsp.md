...
- 系统级HSP和应用间HSP不支持在配置文件中声明[ExtensionAbility](../application-models/extensionability-overview.md)组件和[UIAbility](../application-models/uiability-overview.md)组件。HSP不支持在配置文件中声明入口Ability。
