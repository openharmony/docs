...
创建Stage模型的卡片，需实现FormExtensionAbility生命周期接口。先参考<!--RP-->[DevEco Studio服务卡片开发指南](https://developer.harmonyos.com/cn/docs/documentation/doc-guides-V3/ide_service_widget-0000001078566997-V3)<!--RPEnd-->生成服务卡片模板。
