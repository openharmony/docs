...
开发者可以使用[声明式范式开发ArkTS卡片页面](../ui/arkts-ui-development-overview.md)。ArkTS卡片开发采用通用ArkTS语言，详见<!--RP1-->[学习ArkTS语言](../quick-start/arkts-get-started.md)<!--RP1End-->。
...
ArkTS支持的页面能力详见[ArkUI](../reference/apis-arkui)
