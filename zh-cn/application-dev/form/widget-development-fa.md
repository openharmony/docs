...
创建FA模型的卡片，需实现卡片的生命周期接口。先参考<!--RP-->[IDE开发服务卡片指南](https://developer.harmonyos.com/cn/docs/documentation/doc-guides/ohos-development-service-widget-0000001263280425)<!--RPEnd-->生成服务卡片模板。
