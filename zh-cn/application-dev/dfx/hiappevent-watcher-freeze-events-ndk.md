...
8. 点击IDE界面中的运行按钮，运行应用工程，然后在应用界面中点击按钮“appFreeze”，触发一次崩溃事件。
...
9. 应用工程崩溃退出后再次运行可以在Log窗口看到对系统事件数据的处理日志:
   ...
   08-07 03:54:42.909 1719-1719/? I A00000/testTag: Ability onBackground
   ```
