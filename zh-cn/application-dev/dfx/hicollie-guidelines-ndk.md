...
>
> 业务线程卡顿故障日志规格，可参考：[主线程超时事件时间规格](./hiappevent-watcher-mainthreadjank-events.md#主线程超时事件时间规格) 和 [主线程超时事件规格](./hiappevent-watcher-mainthreadjank-events.md#主线程超时事件规格)。
