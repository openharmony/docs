...
系统提供了通用的NativeCrash崩溃日志生成功能，但一些应用对崩溃日志打印内容有个性化的需求，因此从**API version 20**开始hiAppEvent的[setEventConfig](hiappevent-watcher-crash-events.md#崩溃日志配置参数设置介绍)接口支持设置崩溃日志配置参数。以下是一份DevEco Studio归档在FaultLog的32位系统崩溃日志的核心内容：
