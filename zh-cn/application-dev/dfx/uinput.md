...
### 设置鼠标事件间隔
设置鼠标事件的程序间隔，以毫秒为单位。需与其它命令搭配使用，否则无意义。
...
### 设置键盘事件间隔
设置键盘事件以毫秒为单位的程序间隔。需与其它命令搭配使用，否则无意义。
...
### 触控笔按下事件
模拟触控笔在（dx dy）按下，建议与抬起事件搭配使用，确保事件闭环。
...
### 触控笔抬起事件
模拟触控笔在（dx dy）抬起，建议与按下事件搭配使用，确保事件闭环。
...
### 设置触控笔事件间隔
设置触控笔事件以毫秒为单位的程序间隔。需与其它命令搭配使用，否则无意义。
...
### 触摸按下事件
模拟手指触摸在（dx dy）按下，建议与抬起事件搭配使用，确保事件闭环。
...
### 触摸抬起事件
模拟手指触摸在（dx dy）抬起，建议与按下事件搭配使用，确保事件闭环。
