...
> **说明：**
>
> 与坐标相关的参数，单位均为[px(屏幕物理像素单位)](../reference/apis-arkui/arkui-ts/ts-pixel-units.md)。
...
**使用示例**
```bash
# 鼠标移动到相对位置(100, 200)，该位置属于可滚动区域，鼠标滚轴向后滚动三个刻度。
