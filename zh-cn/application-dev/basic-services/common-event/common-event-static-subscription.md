...
- [静态订阅（ArkTS）（Full SDK）（API10）](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-5.0.3-Release/code/SystemFeature/ApplicationModels/StaticSubscriber)
