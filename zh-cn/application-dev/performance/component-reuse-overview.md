...
关于组件复用的原理机制可以参考资料[组件复用原理机制](./component-recycle-case.md#组件复用原理机制)，便于理解本文内容。
...
|**有限变化型**|复用组件之间有不同，但是类型有限|使用reuseId或者独立成两个自定义组件|[组件复用性能优化指导](./component-recycle-case.md)|
