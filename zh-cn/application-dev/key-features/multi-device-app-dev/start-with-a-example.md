...
> 
> - OpenHarmony当前仅有默认设备和平板两种设备形态，DevEco Studio在创建OpenHarmony工程时也仅可以选择默认设备和平板。随着演进，其支持的设备形态会不断丰富，本文也会定期刷新相关介绍。
...
在本文[DevEco Studio使用章节](ide-using.md)中，将详细介绍一多的工程创建及管理等，本小节仅介绍最基础的工程创建及多设备预览调试。
...
天气应用：[天气应用示例](https://gitcode.com/openharmony/applications_app_samples/tree/master/code/SuperFeature/MultiDeviceAppDev/Weather)
