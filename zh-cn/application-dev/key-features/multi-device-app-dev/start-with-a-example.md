...
在[应用UX设计章节](https://docs.openharmony.cn/pages/v4.0/zh-ch/design/ux-design/app-ux-design.md)中，将详细介绍应用的UX设计规则。
...
天气应用：[天气应用示例](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-4.0-Beta2/code/SuperFeature/MultiDeviceAppDev/Weather)
