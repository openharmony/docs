...
| [一多导航栏](https://gitee.com/openharmony/applications_app_samples/tree/samples_monthly_20230930/code/SuperFeature/MultiDeviceAppDev/MultiNavBar) | 声明式开发范式 | 基于自适应布局能力和响应式布局能力进行多设备（或多窗口尺寸）适配，主要通过组件提供窗口断点事件，保证应用在不同设备或不同窗口尺寸下可以正常显示。 |
