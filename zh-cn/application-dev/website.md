  ...
  - 应用框架<!--app-framework-api-->
    ...
    - ArkWeb（方舟Web）<!--arkweb-api-->
      ...
      - C API<!--arkweb-c-->
        ...
        - 结构体<!--arkweb-struct-->
          - [ArkWeb_AnyNativeAPI](reference/apis-arkweb/capi-arkweb-anynativeapi.md)
          - [ArkWeb_SchemeHandler_](reference/apis-arkweb/capi-arkweb-schemehandler.md)
          - [ArkWeb_ResourceHandler_](reference/apis-arkweb/capi-arkweb-resourcehandler.md)
          - [ArkWeb_Response_](reference/apis-arkweb/capi-arkweb-response.md)
          - [ArkWeb_ResourceRequest_](reference/apis-arkweb/capi-arkweb-resourcerequest.md)
          - [ArkWeb_RequestHeaderList_](reference/apis-arkweb/capi-arkweb-requestheaderlist.md)
          - [ArkWeb_HttpBodyStream_](reference/apis-arkweb/capi-arkweb-httpbodystream.md)
          - [ArkWeb_JavaScriptBridgeData](reference/apis-arkweb/capi-arkweb-javascriptbridgedata.md)
          - [ArkWeb_WebMessage*](reference/apis-arkweb/capi-arkweb-webmessage8h.md)
          - [ArkWeb_JavaScriptValue*](reference/apis-arkweb/capi-arkweb-javascriptvalue8h.md)
          - [ArkWeb_WebMessagePort*](reference/apis-arkweb/capi-arkweb-webmessageport8h.md)
          - [ArkWeb_JavaScriptObject](reference/apis-arkweb/capi-arkweb-javascriptobject.md)
          - [ArkWeb_ProxyMethod](reference/apis-arkweb/capi-arkweb-proxymethod.md)
          - [ArkWeb_ProxyMethodWithResult](reference/apis-arkweb/capi-arkweb-proxymethodwithresult.md)
          - [ArkWeb_ProxyObject](reference/apis-arkweb/capi-arkweb-proxyobject.md)
          - [ArkWeb_ProxyObjectWithResult](reference/apis-arkweb/capi-arkweb-proxyobjectwithresult.md)
          - [ArkWeb_ControllerAPI](reference/apis-arkweb/capi-arkweb-controllerapi.md)
          - [ArkWeb_ComponentAPI](reference/apis-arkweb/capi-arkweb-componentapi.md)
          - [ArkWeb_WebMessagePortAPI](reference/apis-arkweb/capi-arkweb-webmessageportapi.md)
          - [ArkWeb_WebMessageAPI](reference/apis-arkweb/capi-arkweb-webmessageapi.md)
          - [ArkWeb_CookieManagerAPI](reference/apis-arkweb/capi-arkweb-cookiemanagerapi.md)
          - [ArkWeb_JavaScriptValueAPI](reference/apis-arkweb/capi-arkweb-javascriptvalueapi.md)
    ...
    - Audio Kit（音频服务）<!--audio-api-->
      ...
      - C API<!--audio-c-->
        ...
        - 结构体<!--audio-struct-->
          ...
          - [OH_AudioResourceManager](reference/apis-audio-kit/capi-oh-audioresourcemanager.md)
          - [OH_AudioWorkgroup](reference/apis-audio-kit/capi-oh-audioworkgroup.md)
    ...
    - ArkGraphics 2D（方舟2D图形服务）<!--arkgraphics-api-->
      ...
      - C API<!--arkgraphics-c-->
        ...
        - 结构体<!--arkgraphics-struct-->
          ...
          - [ColorSpacePrimaries](reference/apis-arkgraphics2d/capi-colorspaceprimaries.md)
          - [WhitePointArray](reference/apis-arkgraphics2d/capi-whitepointarray.md)
          - [DisplaySoloist_ExpectedRateRange](reference/apis-arkgraphics2d/capi-displaysoloist-expectedraterange.md)
          - [OH_Drawing_BitmapFormat](reference/apis-arkgraphics2d/capi-oh-drawing-bitmapformat.md)
          - [OH_Drawing_Font_Metrics](reference/apis-arkgraphics2d/capi-oh-drawing-font-metrics.md)
          - [OH_Drawing_GpuContextOptions](reference/apis-arkgraphics2d/capi-oh-drawing-gpucontextoptions.md)
          - [OH_Drawing_RunBuffer](reference/apis-arkgraphics2d/capi-oh-drawing-runbuffer.md)
          - [OH_Drawing_PlaceholderSpan](reference/apis-arkgraphics2d/capi-oh-drawing-placeholderspan.md)
          - [OH_Drawing_FontDescriptor](reference/apis-arkgraphics2d/capi-oh-drawing-fontdescriptor.md)
          - [OH_Drawing_LineMetrics](reference/apis-arkgraphics2d/capi-oh-drawing-linemetrics.md)
          - [OH_Drawing_FontFallbackInfo](reference/apis-arkgraphics2d/capi-oh-drawing-fontfallbackinfo.md)
          - [OH_Drawing_FontFallbackGroup](reference/apis-arkgraphics2d/capi-oh-drawing-fontfallbackgroup.md)
          - [OH_Drawing_FontAdjustInfo](reference/apis-arkgraphics2d/capi-oh-drawing-fontadjustinfo.md)
          - [OH_Drawing_FontAliasInfo](reference/apis-arkgraphics2d/capi-oh-drawing-fontaliasinfo.md)
          - [OH_Drawing_FontGenericInfo](reference/apis-arkgraphics2d/capi-oh-drawing-fontgenericinfo.md)
          - [OH_Drawing_FontConfigInfo](reference/apis-arkgraphics2d/capi-oh-drawing-fontconfiginfo.md)
          - [OH_Drawing_FontStyleStruct](reference/apis-arkgraphics2d/capi-oh-drawing-fontstylestruct.md)
          - [OH_Drawing_FontFeature](reference/apis-arkgraphics2d/capi-oh-drawing-fontfeature.md)
          - [OH_Drawing_StrutStyle](reference/apis-arkgraphics2d/capi-oh-drawing-strutstyle.md)
          - [OH_Drawing_Point2D](reference/apis-arkgraphics2d/capi-oh-drawing-point2d.md)
          - [OH_Drawing_Point3D](reference/apis-arkgraphics2d/capi-oh-drawing-point3d.md)
          - [OH_Drawing_Image_Info](reference/apis-arkgraphics2d/capi-oh-drawing-image-info.md)
          - [OH_Drawing_RectStyle_Info](reference/apis-arkgraphics2d/capi-oh-drawing-rectstyle-info.md)
          - [OH_Drawing_String](reference/apis-arkgraphics2d/capi-oh-drawing-string.md)
          - [OH_Filter_ColorMatrix](reference/apis-arkgraphics2d/capi-oh-filter-colormatrix.md)
          - [OH_OnFrameAvailableListener](reference/apis-arkgraphics2d/capi-oh-onframeavailablelistener.md)
          - [OH_NativeVSync_ExpectedRateRange](reference/apis-arkgraphics2d/capi-oh-nativevsync-expectedraterange.md)
          - [BufferHandle](reference/apis-arkgraphics2d/capi-bufferhandle.md)
          - [Region](reference/apis-arkgraphics2d/capi-region.md)
          - [Rect](reference/apis-arkgraphics2d/capi-rect.md)
          - [OHHDRMetaData](reference/apis-arkgraphics2d/capi-ohhdrmetadata.md)
          - [OHExtDataHandle](reference/apis-arkgraphics2d/capi-ohextdatahandle.md)
          - [OH_NativeBuffer](reference/apis-arkgraphics2d/capi-oh-nativebuffer.md)
          - [OH_NativeColorSpaceManager](reference/apis-arkgraphics2d/capi-oh-nativecolorspacemanager.md)
          - [OH_DisplaySoloist](reference/apis-arkgraphics2d/capi-oh-displaysoloist.md)
          - [NativePixelMap_](reference/apis-arkgraphics2d/capi-nativepixelmap-.md)
          - [OH_PixelmapNative](reference/apis-arkgraphics2d/capi-oh-pixelmapnative.md)
          - [OH_Drawing_FontCollection](reference/apis-arkgraphics2d/capi-oh-drawing-fontcollection.md)
          - [OH_Drawing_Typography](reference/apis-arkgraphics2d/capi-oh-drawing-typography.md)
          - [OH_Drawing_TextStyle](reference/apis-arkgraphics2d/capi-oh-drawing-textstyle.md)
          - [OH_Drawing_TypographyStyle](reference/apis-arkgraphics2d/capi-oh-drawing-typographystyle.md)
          - [OH_Drawing_LineTypography](reference/apis-arkgraphics2d/capi-oh-drawing-linetypography.md)
          - [OH_Drawing_TypographyCreate](reference/apis-arkgraphics2d/capi-oh-drawing-typographycreate.md)
          - [OH_Drawing_TextBox](reference/apis-arkgraphics2d/capi-oh-drawing-textbox.md)
          - [OH_Drawing_PositionAndAffinity](reference/apis-arkgraphics2d/capi-oh-drawing-positionandaffinity.md)
          - [OH_Drawing_Range](reference/apis-arkgraphics2d/capi-oh-drawing-range.md)
          - [OH_Drawing_TextShadow](reference/apis-arkgraphics2d/capi-oh-drawing-textshadow.md)
          - [OH_Drawing_FontParser](reference/apis-arkgraphics2d/capi-oh-drawing-fontparser.md)
          - [OH_Drawing_TextTab](reference/apis-arkgraphics2d/capi-oh-drawing-texttab.md)
          - [OH_Drawing_TextLine](reference/apis-arkgraphics2d/capi-oh-drawing-textline.md)
          - [OH_Drawing_Run](reference/apis-arkgraphics2d/capi-oh-drawing-run.md)
          - [OH_Drawing_Canvas](reference/apis-arkgraphics2d/capi-oh-drawing-canvas.md)
          - [OH_Drawing_Pen](reference/apis-arkgraphics2d/capi-oh-drawing-pen.md)
          - [OH_Drawing_Region](reference/apis-arkgraphics2d/capi-oh-drawing-region.md)
          - [OH_Drawing_Brush](reference/apis-arkgraphics2d/capi-oh-drawing-brush.md)
          - [OH_Drawing_Path](reference/apis-arkgraphics2d/capi-oh-drawing-path.md)
          - [OH_Drawing_Bitmap](reference/apis-arkgraphics2d/capi-oh-drawing-bitmap.md)
          - [OH_Drawing_Point](reference/apis-arkgraphics2d/capi-oh-drawing-point.md)
          - [OH_Drawing_PixelMap](reference/apis-arkgraphics2d/capi-oh-drawing-pixelmap.md)
          - [OH_Drawing_ColorSpace](reference/apis-arkgraphics2d/capi-oh-drawing-colorspace.md)
          - [OH_Drawing_PathEffect](reference/apis-arkgraphics2d/capi-oh-drawing-patheffect.md)
          - [OH_Drawing_Rect](reference/apis-arkgraphics2d/capi-oh-drawing-rect.md)
          - [OH_Drawing_RoundRect](reference/apis-arkgraphics2d/capi-oh-drawing-roundrect.md)
          - [OH_Drawing_Matrix](reference/apis-arkgraphics2d/capi-oh-drawing-matrix.md)
          - [OH_Drawing_ShaderEffect](reference/apis-arkgraphics2d/capi-oh-drawing-shadereffect.md)
          - [OH_Drawing_ShadowLayer](reference/apis-arkgraphics2d/capi-oh-drawing-shadowlayer.md)
          - [OH_Drawing_Filter](reference/apis-arkgraphics2d/capi-oh-drawing-filter.md)
          - [OH_Drawing_MaskFilter](reference/apis-arkgraphics2d/capi-oh-drawing-maskfilter.md)
          - [OH_Drawing_ColorFilter](reference/apis-arkgraphics2d/capi-oh-drawing-colorfilter.md)
          - [OH_Drawing_Font](reference/apis-arkgraphics2d/capi-oh-drawing-font.md)
          - [OH_Drawing_MemoryStream](reference/apis-arkgraphics2d/capi-oh-drawing-memorystream.md)
          - [OH_Drawing_FontArguments](reference/apis-arkgraphics2d/capi-oh-drawing-fontarguments.md)
          - [OH_Drawing_Typeface](reference/apis-arkgraphics2d/capi-oh-drawing-typeface.md)
          - [OH_Drawing_TextBlob](reference/apis-arkgraphics2d/capi-oh-drawing-textblob.md)
          - [OH_Drawing_Image](reference/apis-arkgraphics2d/capi-oh-drawing-image.md)
          - [OH_Drawing_ImageFilter](reference/apis-arkgraphics2d/capi-oh-drawing-imagefilter.md)
          - [OH_Drawing_SamplingOptions](reference/apis-arkgraphics2d/capi-oh-drawing-samplingoptions.md)
          - [OH_Drawing_TextBlobBuilder](reference/apis-arkgraphics2d/capi-oh-drawing-textblobbuilder.md)
          - [OH_Drawing_GpuContext](reference/apis-arkgraphics2d/capi-oh-drawing-gpucontext.md)
          - [OH_Drawing_Surface](reference/apis-arkgraphics2d/capi-oh-drawing-surface.md)
          - [OH_Drawing_FontMgr](reference/apis-arkgraphics2d/capi-oh-drawing-fontmgr.md)
          - [OH_Drawing_FontStyleSet](reference/apis-arkgraphics2d/capi-oh-drawing-fontstyleset.md)
          - [OH_Drawing_RecordCmdUtils](reference/apis-arkgraphics2d/capi-oh-drawing-recordcmdutils.md)
          - [OH_Drawing_RecordCmd](reference/apis-arkgraphics2d/capi-oh-drawing-recordcmd.md)
          - [OH_Drawing_Array](reference/apis-arkgraphics2d/capi-oh-drawing-array.md)
          - [OH_Filter](reference/apis-arkgraphics2d/capi-oh-filter.md)
          - [OH_NativeImage](reference/apis-arkgraphics2d/capi-oh-nativeimage.md)
          - [NativeWindow](reference/apis-arkgraphics2d/capi-nativewindow.md)
          - [NativeWindowBuffer](reference/apis-arkgraphics2d/capi-nativewindowbuffer.md)
          - [OH_NativeVSync](reference/apis-arkgraphics2d/capi-oh-nativevsync.md)
