    ...
    - Ability框架
      ...
      - 接口依赖的元素及定义
        - ability
          ...
          - [connectOptions（ConnectOptions）](reference/apis/js-apis-inner-ability-connectOptions.md)
          - [dataAbilityHelper (DataAbilityHelper模块)](reference/apis/js-apis-inner-ability-dataAbilityHelper.md)
          - [dataAbilityOperation (DataAbilityOperation)](reference/apis/js-apis-inner-ability-dataAbilityOperation.md)
          - [dataAbilityResult (DataAbilityResult)](reference/apis/js-apis-inner-ability-dataAbilityResult.md)
          - [startAbilityParameter (StartAbilityParameter)](reference/apis/js-apis-inner-ability-startAbilityParameter.md)
          - [want](reference/apis/js-apis-inner-ability-want.md)
        - app
          - [appVersionInfo (AppVersionInfo)](reference/apis/js-apis-inner-app-appVersionInfo.md)
          - [context (Context模块)](reference/apis/js-apis-inner-app-context.md)
          - [processInfo (ProcessInfo)](reference/apis/js-apis-inner-app-processInfo.md)
        - application
          ...
          - [abilityMonitor (AbilityMonitor)](reference/apis/js-apis-inner-application-abilityMonitor.md)
          ...
          - [AbilityStateData (AbilityStateData)](reference/apis/js-apis-inner-application-abilityStateData.md)
          - [abilityStageMonitor (AbilityStageMonitor)](reference/apis/js-apis-inner-application-abilityStageMonitor.md)
          - [ApplicationContext (ApplicationContext)](reference/apis/js-apis-inner-application-applicationContext.md)
          - [ApplicationStateObserver (ApplicationStateObserver)](reference/apis/js-apis-inner-application-applicationStateObserver.md)
          - [AppStateData (AppStateData)](reference/apis/js-apis-inner-application-appStateData.md)
          - [BaseContext (BaseContext)](reference/apis/js-apis-inner-application-baseContext.md)
          - [Context (Context)](reference/apis/js-apis-inner-application-context.md)
          - [ContinueCallback (ContinueCallback)](reference/apis/js-apis-inner-application-continueCallback.md)
          - [ContinueDeviceInfo (ContinueDeviceInfo)](reference/apis/js-apis-inner-application-continueDeviceInfo.md)
          - [ErrorObserver (ErrorObserver)](reference/apis/js-apis-inner-application-errorObserver.md)
          ...
          - [MissionCallbacks (MissionCallbacks)](reference/apis/js-apis-inner-application-missionCallbacks.md)
          - [MissionDeviceInfo (MissionDeviceInfo)](reference/apis/js-apis-inner-application-missionDeviceInfo.md)
          - [MissionInfo (MissionInfo)](reference/apis/js-apis-inner-application-missionInfo.md)
          - [MissionListener (MissionListener)](reference/apis/js-apis-inner-application-missionListener.md)
          - [MissionParameter (MissionParameter)](reference/apis/js-apis-inner-application-missionParameter.md)
          ...
          - [ProcessData (ProcessData)](reference/apis/js-apis-inner-application-processData.md)
          ...
          - [UIAbilityContext (UIAbilityContext)](reference/apis/js-apis-inner-application-uiAbilityContext.md)
          - [shellCmdResult (ShellCmdResult)](reference/apis/js-apis-inner-application-shellCmdResult.md)
        - wantAgent
          - [triggerInfo (TriggerInfo)](reference/apis/js-apis-inner-wantAgent-triggerInfo.md)
          - [wantAgentInfo (WantAgentInfo)](reference/apis/js-apis-inner-wantAgent-wantAgentInfo.md)
      - 流转
