  ...
  - 媒体<!--media-reference-->
    ...
    - Image Kit（图片处理服务）<!--image-api-->
      ...
      - C API<!--image-c-->
        ...
        - 结构体<!--image-struct-->
          - [OH_ImageSourceNative](reference/apis-image-kit/capi-oh-imagesourcenative.md)
          - [OH_ImageSource_Info](reference/apis-image-kit/capi-imagesource-info.md)
          ...
          - [OH_Pixelmap_InitializationOptions](reference/apis-image-kit/capi-oh-pixelmap-initializationoptions.md)
          - [OH_Pixelmap_ImageInfo](reference/apis-image-kit/capi-oh-pixelmap-imageinfo.md)
          - [Image_Size](reference/apis-image-kit/capi-image-size.md)
          - [Image_Region](reference/apis-image-kit/capi-image-region.md)
          - [OH_PictureMetadata](reference/apis-image-kit/capi-oh-picturemetadata.md)
          - [Image_String](reference/apis-image-kit/capi-image-string.md)
          - [OH_ImageNative](reference/apis-image-kit/capi-oh-imagenative.md)
          - [OH_ImagePackerNative](reference/apis-image-kit/capi-oh-imagepackernative.md)
          - [OH_PackingOptions](reference/apis-image-kit/capi-oh-packingoptions.md)
          - [OH_PackingOptionsForSequence](reference/apis-image-kit/capi-oh-packingoptionsforsequence.md)
          - [OH_ImageReceiverNative](reference/apis-image-kit/capi-oh-imagereceivernative.md)
          - [OH_ImageReceiverOptions](reference/apis-image-kit/capi-oh-imagereceiveroptions.md)
          - [OH_PictureNative](reference/apis-image-kit/capi-oh-picturenative.md)
          - [OH_AuxiliaryPictureNative](reference/apis-image-kit/capi-oh-auxiliarypicturenative.md)
          - [OH_AuxiliaryPictureInfo](reference/apis-image-kit/capi-oh-auxiliarypictureinfo.md)
          - [OhosImageRect](reference/apis-image-kit/capi-ohosimagerect.md)
          - [ImageNative_](reference/apis-image-kit/capi-imagenative-.md)
          - [OhosImageComponent](reference/apis-image-kit/capi-ohosimagecomponent.md)
          - [OhosImageSize](reference/apis-image-kit/capi-ohosimagesize.md)
          - [ImagePacker_Opts_](reference/apis-image-kit/capi-imagepacker-opts-.md)
          - [ImagePacker_Native_](reference/apis-image-kit/capi-imagepacker-native-.md)
          - [OhosPixelMapInfos](reference/apis-image-kit/capi-ohospixelmapinfos.md)
          - [NativePixelMap_](reference/apis-image-kit/capi-nativepixelmap-.md)
          - [OhosPixelMapCreateOps](reference/apis-image-kit/capi-ohospixelmapcreateops.md)
          - [OhosPixelMapInfo](reference/apis-image-kit/capi-ohospixelmapinfo.md)
          - [OhosImageReceiverInfo](reference/apis-image-kit/capi-ohosimagereceiverinfo.md)
          - [ImageReceiverNative_](reference/apis-image-kit/capi-imagereceivernative-.md)
          - [OhosImageRegion](reference/apis-image-kit/capi-ohosimageregion.md)
          - [ImageSourceNative_](reference/apis-image-kit/capi-imagesourcenative-.md)
          - [OhosImageSourceOps](reference/apis-image-kit/capi-ohosimagesourceops.md)
          - [OhosImageDecodingOps](reference/apis-image-kit/capi-ohosimagedecodingops.md)
          - [OhosImageSourceInfo](reference/apis-image-kit/capi-ohosimagesourceinfo.md)
          - [OhosImageSource](reference/apis-image-kit/capi-ohosimagesource.md)
          - [OhosImageSourceDelayTimeList](reference/apis-image-kit/capi-ohosimagesourcedelaytimelist.md)
          - [OhosImageSourceSupportedFormat](reference/apis-image-kit/capi-ohosimagesourcesupportedformat.md)
          - [OhosImageSourceSupportedFormatList](reference/apis-image-kit/capi-ohosimagesourcesupportedformatlist.md)
          - [OhosImageSourceProperty](reference/apis-image-kit/capi-ohosimagesourceproperty.md)
          - [OhosImageSourceUpdateData](reference/apis-image-kit/capi-ohosimagesourceupdatedata.md)
          - [OH_ImageEffect](reference/apis-image-kit/capi-oh-imageeffect.md)
          - [ImageEffect_DataValue](reference/apis-image-kit/capi-imageeffect-datavalue.md)
          - [OH_EffectFilter](reference/apis-image-kit/capi-oh-effectfilter.md)
          - [OH_EffectFilterInfo](reference/apis-image-kit/capi-oh-effectfilterinfo.md)
          - [OH_EffectBufferInfo](reference/apis-image-kit/capi-oh-effectbufferinfo.md)
          - [ImageEffect_Any](reference/apis-image-kit/capi-imageeffect-any.md)
          - [ImageEffect_FilterNames](reference/apis-image-kit/capi-imageeffect-filternames.md)
          - [ImageEffect_FilterDelegate](reference/apis-image-kit/capi-imageeffect-filterdelegate.md)
          - [ImageEffect_Region](reference/apis-image-kit/capi-imageeffect-region.md)
          - [ImageEffect_Size](reference/apis-image-kit/capi-imageeffect-size.md)
          - [ImageProcessing_ColorSpaceInfo](reference/apis-image-kit/capi-imageprocessing-colorspaceinfo.md)
