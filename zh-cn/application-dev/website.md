...
- 开发
  ...
  - 一次开发，多端部署
     - [前言](multi-device-app-dev/foreword.md)
     - [简介](multi-device-app-dev/introduction.md)
     - [从一个例子开始](multi-device-app-dev/start-with-a-example.md)
     - 应用UX设计
       - [设计原则和要点](multi-device-app-dev/design-principles.md)
       - 应用架构设计
         - [应用导航结构设计要求](multi-device-app-dev/navigation-design.md)
         - [应用页面结构设计](multi-device-app-dev/page-design.md)
       - 界面布局
         - [概述](multi-device-app-dev/interface-layout-design-intro.md)
         - 布局基础
           - [栅格系统](multi-device-app-dev/design-grid.md)
           - [自适应布局](multi-device-app-dev/design-adaptive-layout.md)
           - [响应式布局](multi-device-app-dev/design-responsive-layout.md)
         - [布局基础运用案例](multi-device-app-dev/design-layout-cases.md)
       - 人机交互
         - [交互基础](multi-device-app-dev/interaction-basics.md)
         - [常见输入方式](multi-device-app-dev/common-input-modes.md)
         - [交互事件归一](multi-device-app-dev/design-interaction-event-normalization.md)
       - 视觉风格
         - [视觉基础](multi-device-app-dev/visual-basics.md)
         - [色彩](multi-device-app-dev/visual-style-color.md)
         - [字体](multi-device-app-dev/visual-style-font.md)
         - [图标](multi-device-app-dev/visual-style-icon.md)
       - [多态控件](multi-device-app-dev/design-polymorphic-controls.md)
       - [设计自检表](multi-device-app-dev/design-checklist.md)
       - [设计交付](multi-device-app-dev/design-delivery.md)
       - [资源](multi-device-app-dev/design-resources.md)
     - [工程管理](multi-device-app-dev/ide-using.md)
     - 页面开发的一多能力介绍
       - [简介](multi-device-app-dev/page-development-intro.md)
       - 布局能力
         - [布局简介](multi-device-app-dev/layout-intro.md)
         - [自适应布局](multi-device-app-dev/adaptive-layout.md)
         - [响应式布局](multi-device-app-dev/responsive-layout.md)
         - [典型布局场景](multi-device-app-dev/typical-layout-scenario.md)
         - 典型页面场景
           - [应用市场首页](multi-device-app-dev/appgallery-home-page.md)
           - [音乐专辑页](multi-device-app-dev/music-album-page.md)
           - [设置应用页面](multi-device-app-dev/settings-application-page.md)
       - [交互归一](multi-device-app-dev/interaction-event-normalization.md)
       - [多态组件](multi-device-app-dev/polymorphic-controls.md)
       - [资源使用](multi-device-app-dev/resource-usage.md)
     - [功能开发的一多能力介绍](multi-device-app-dev/development-intro.md)
     - [案例应用](multi-device-app-dev/case.md)
     - [常见问题](multi-device-app-dev/faq.md)
...
- API参考
  ...
  - 错误码参考
     - [通用错误码](errorcodes/errorcode-universal.md)
     - Ability框架
       - [元能力子系统错误码](errorcodes/errorcode-ability.md)
       - [DistributedSchedule错误码](errorcodes/errorcode-DistributedSchedule.md)
       - [卡片错误码](errorcodes/errorcode-form.md)
     - 包管理
       - [包管理子系统通用错误码](errorcodes/errorcode-bundle.md)
       - [zlib子系统错误码](errorcodes/errorcode-zlib.md)
     - 公共事件与通知
       - [事件错误码](errorcodes/errorcode-CommonEventService.md)
       - [通知错误码](errorcodes/errorcode-notification.md)
       - [DistributedNotificationService错误码](errorcodes/errorcode-DistributedNotificationService.md)
     - UI界面
       - [动画错误码](errorcodes/errorcode-animator.md)
       - [弹窗错误码](errorcodes/errorcode-promptAction.md)
       - [页面路由错误码](errorcodes/errorcode-router.md)
     - 图形图像
       - [色彩管理错误码](errorcodes/errorcode-colorspace-manager.md)
       - [屏幕错误码](errorcodes/errorcode-display.md)
       - [窗口错误码](errorcodes/errorcode-window.md)
     - 媒体
       - [Audio错误码](errorcodes/errorcode-audio.md)
       - [Media错误码](errorcodes/errorcode-media.md)
       - [媒体会话管理错误码](errorcodes/errorcode-avsession.md)
     - 资源管理
       - [I18n错误码](errorcodes/errorcode-i18n.md)
       - [资源管理错误码](errorcodes/errorcode-resource-manager.md)
     - 后台任务
       - [backgroundTaskManager错误码](errorcodes/errorcode-backgroundTaskMgr.md)
       - [DeviceUsageStatistics错误码](errorcodes/errorcode-DeviceUsageStatistics.md)
       - [reminderAgentManager错误码](errorcodes/errorcode-reminderAgentManager.md)
       - [workScheduler错误码](errorcodes/errorcode-workScheduler.md)
     - 安全
       - [AccessToken错误码](errorcodes/errorcode-access-token.md)
       - [HUKS错误码](errorcodes/errorcode-huks.md)
       - [crypto framework错误码](errorcodes/errorcode-crypto-framework.md)
       - [cert错误码](errorcodes/errorcode-cert.md)
       - [用户认证错误码](errorcodes/errorcode-useriam.md)
     - 数据管理
       - [关系型数据库错误码](errorcodes/errorcode-data-rdb.md)
       - [数据共享错误码](errorcodes/errorcode-datashare.md)
       - [分布式数据对象错误码](errorcodes/errorcode-distributed-dataObject.md)
       - [分布式键值数据库错误码](errorcodes/errorcode-distributedKVStore.md)
       - [首选项错误码](errorcodes/errorcode-preferences.md)
     - 文件管理
       - [文件管理子系统错误码](errorcodes/errorcode-filemanagement.md)
     - 电话服务
       - [电话子系统错误码](errorcodes/errorcode-telephony.md)
     - 网络管理
       - [上传下载错误码](errorcodes/errorcode-request.md)
       - [HTTP错误码](errorcodes/errorcode-net-http.md)
       - [Socket错误码](errorcodes/errorcode-net-socket.md)
       - [网络连接管理错误码](errorcodes/errorcode-net-connection.md)
       - [以太网连接错误码](errorcodes/errorcode-net-ethernet.md)
       - [网络共享错误码](errorcodes/errorcode-net-sharing.md)
       - [策略管理错误码](errorcodes/errorcode-net-policy.md)
     - 通信与连接
       - [NFC错误码](errorcodes/errorcode-nfc.md)
       - [RPC错误码](errorcodes/errorcode-rpc.md)
       - [蓝牙服务子系统错误码](errorcodes/errorcode-bluetoothManager.md)
     - 系统基础能力
       - [无障碍子系统错误码](errorcodes/errorcode-accessibility.md)
       - [Faultlogger错误码](errorcodes/errorcode-faultlogger.md)
       - [应用事件打点错误码](errorcodes/errorcode-hiappevent.md)
       - [系统事件错误码](errorcodes/errorcode-hisysevent.md)
       - [Hidebug错误码](errorcodes/errorcode-hiviewdfx-hidebug.md)
       - [输入法框架错误码](errorcodes/errorcode-inputmethod-framework.md)
       - [剪贴板错误码](errorcodes/errorcode-pasteboard.md)
       - [时间时区服务错误码](errorcodes/errorcode-time.md)
       - [Webview错误码](errorcodes/errorcode-webview.md)
     - 帐号管理
       - [帐号管理错误码](errorcodes/errorcode-account.md)
     - 设备管理
       - [耗电统计错误码](errorcodes/errorcode-batteryStatistics.md)
       - [屏幕亮度错误码](errorcodes/errorcode-brightness.md)
       - [系统电源管理错误码](errorcodes/errorcode-power.md)
       - [RunningLock锁错误码](errorcodes/errorcode-runninglock.md)
       - [热管理错误码](errorcodes/errorcode-thermal.md)
       - [设备管理错误码](errorcodes/errorcode-device-manager.md)
       - [位置服务子系统错误码](errorcodes/errorcode-geoLocationManager.md)
       - [键鼠穿越管理错误码](errorcodes/errorcode-multimodalinput.md)
       - [传感器错误码](errorcodes/errorcode-sensor.md)
       - [振动错误码](errorcodes/errorcode-vibrator.md)
       - [系统参数错误码](errorcodes/errorcode-system-parameterV9.md)
       - [USB服务错误码](errorcodes/errorcode-usb.md)
       - [升级错误码](errorcodes/errorcode-update.md)
     - 定制管理
       - [企业设备管理错误码](errorcodes/errorcode-enterpriseDeviceManager.md)
     - 语言基础类库
       - [语言基础类库错误码](errorcodes/errorcode-utils.md)
     - 测试
       - [uitest错误码](errorcodes/errorcode-uitest.md)
  - Native接口参考
     - 模块
       - [Native XComponent](native-apis/_o_h___native_x_component.md)
       - [HiLog](native-apis/_hi_log.md)
       - [NativeWindow](native-apis/_native_window.md)
       - [OH_NativeBuffer](native-apis/_o_h___native_buffer.md)
       - [Drawing](native-apis/_drawing.md)
       - [OH_NativeImage](native-apis/_o_h___native_image.md)
       - [NativeVsync](native-apis/_native_vsync.md)
       - [Image](native-apis/image.md)
       - [Rawfile](native-apis/rawfile.md)
       - [MindSpore](native-apis/_mind_spore.md)
       - [NeuralNeworkRuntime](native-apis/_neural_nework_runtime.md)
       - [AudioDecoder](native-apis/_audio_decoder.md)
       - [AudioEncoder](native-apis/_audio_encoder.md)
       - [CodecBase](native-apis/_codec_base.md)
       - [VideoDecoder](native-apis/_video_decoder.md)
       - [VideoEncoder](native-apis/_video_encoder.md)
       - [Core](native-apis/_core.md)
       - [HuksKeyApi](native-apis/_huks_key_api.md)
       - [HuksParamSetApi](native-apis/_huks_param_set_api.md)
       - [HuksTypeApi](native-apis/_huks_type_api.md)
     - 头文件
       - [drawing_bitmap.h](native-apis/drawing__bitmap_8h.md)
       - [drawing_brush.h](native-apis/drawing__brush_8h.md)
       - [drawing_canvas.h](native-apis/drawing__canvas_8h.md)
       - [drawing_color.h](native-apis/drawing__color_8h.md)
       - [drawing_font_collection.h](native-apis/drawing__font__collection_8h.md)
       - [drawing_path.h](native-apis/drawing__path_8h.md)
       - [drawing_pen.h](native-apis/drawing__pen_8h.md)
       - [drawing_text_declaration.h](native-apis/drawing__text__declaration_8h.md)
       - [drawing_text_typography.h](native-apis/drawing__text__typography_8h.md)
       - [drawing_types.h](native-apis/drawing__types_8h.md)
       - [external_window.h](native-apis/external__window_8h.md)
       - [image_pixel_map_napi.h](native-apis/image__pixel__map__napi_8h.md)
       - [log.h](native-apis/log_8h.md)
       - [native_buffer.h](native-apis/native__buffer_8h.md)
       - [native_image.h](native-apis/native__image_8h.md)
       - [native_interface_xcomponent.h](native-apis/native__interface__xcomponent_8h.md)
       - [native_vsync.h](native-apis/native__vsync_8h.md)
       - [raw_dir.h](native-apis/raw__dir_8h.md)
       - [raw_file_manager.h](native-apis/raw__file__manager_8h.md)
       - [raw_file.h](native-apis/raw__file_8h.md)
       - [context.h](native-apis/context_8h.md)
       - [data_type.h](native-apis/data__type_8h.md)
       - [format.h](native-apis/format_8h.md)
       - [model.h](native-apis/model_8h.md)
       - [status.h](native-apis/status_8h.md)
       - [tensor.h](native-apis/tensor_8h.md)
       - [types.h](native-apis/types_8h.md)
       - [neural_network_runtime_type.h](native-apis/neural__network__runtime__type_8h.md)
       - [neural_network_runtime.h](native-apis/neural__network__runtime_8h.md)
       - [native_avcodec_audiodecoder.h](native-apis/native__avcodec__audiodecoder_8h.md)
       - [native_avcodec_audioencoder.h](native-apis/native__avcodec__audioencoder_8h.md)
       - [native_avcodec_base.h](native-apis/native__avcodec__base_8h.md)
       - [native_avcodec_videodecoder.h](native-apis/native__avcodec__videodecoder_8h.md)
       - [native_avcodec_videoencoder.h](native-apis/native__avcodec__videoencoder_8h.md)
       - [native_averrors.h](native-apis/native__averrors_8h.md)
       - [native_avformat.h](native-apis/native__avformat_8h.md)
       - [native_avmemory.h](native-apis/native__avmemory_8h.md)
       - [native_huks_api.h](native-apis/native__huks__api_8h.md)
       - [native_huks_param.h](native-apis/native__huks__param_8h.md)
       - [native_huks_type.h](native-apis/native__huks__type_8h.md)
     - 结构体
       - [OH_Drawing_BitmapFormat](native-apis/_o_h___drawing___bitmap_format.md)
       - [OH_NativeBuffer_Config](native-apis/_o_h___native_buffer___config.md)
       - [OH_NativeXComponent_Callback](native-apis/_o_h___native_x_component___callback.md)
       - [OH_NativeXComponent_MouseEvent](native-apis/_o_h___native_x_component___mouse_event.md)
       - [OH_NativeXComponent_MouseEvent_Callback](native-apis/_o_h___native_x_component___mouse_event___callback.md)
       - [OH_NativeXComponent_TouchEvent](native-apis/_o_h___native_x_component___touch_event.md)
       - [OH_NativeXComponent_TouchPoint](native-apis/_o_h___native_x_component___touch_point.md)
       - [OHExtDataHandle](native-apis/_o_h_ext_data_handle.md)
       - [OHHDRMetaData](native-apis/_o_h_h_d_r_meta_data.md)
       - [OhosPixelMapCreateOps](native-apis/_ohos_pixel_map_create_ops.md)
       - [OhosPixelMapInfo](native-apis/_ohos_pixel_map_info.md)
       - [RawFileDescriptor](native-apis/_raw_file_descriptor.md)
       - [Region](native-apis/_region.md)
       - [Rect](native-apis/_rect.md)
       - [OH_AI_CallBackParam](native-apis/_o_h___a_i___call_back_param.md)
       - [OH_AI_ShapeInfo](native-apis/_o_h___a_i___shape_info.md)
       - [OH_AI_TensorHandleArray](native-apis/_o_h___a_i___tensor_handle_array.md)
       - [OH_NN_Memory](native-apis/_o_h___n_n___memory.md)
       - [OH_NN_QuantParam](native-apis/_o_h___n_n___quant_param.md)
       - [OH_NN_Tensor](native-apis/_o_h___n_n___tensor.md)
       - [OH_NN_UInt32Array](native-apis/_o_h___n_n___u_int32_array.md)
       - [OH_AVCodecAsyncCallback](native-apis/_o_h___a_v_codec_async_callback.md)
       - [OH_AVCodecBufferAttr](native-apis/_o_h___a_v_codec_buffer_attr.md)
       - [OH_Huks_Blob](native-apis/_o_h___huks___blob.md)
       - [OH_Huks_CertChain](native-apis/_o_h___huks___cert_chain.md)
       - [OH_Huks_KeyInfo](native-apis/_o_h___huks___key_info.md)
       - [OH_Huks_KeyMaterial25519](native-apis/_o_h___huks___key_material25519.md)
       - [OH_Huks_KeyMaterialDh](native-apis/_o_h___huks___key_material_dh.md)
       - [OH_Huks_KeyMaterialDsa](native-apis/_o_h___huks___key_material_dsa.md)
       - [OH_Huks_KeyMaterialEcc](native-apis/_o_h___huks___key_material_ecc.md)
       - [OH_Huks_KeyMaterialRsa](native-apis/_o_h___huks___key_material_rsa.md)
       - [OH_Huks_Param](native-apis/_o_h___huks___param.md)
       - [OH_Huks_ParamSet](native-apis/_o_h___huks___param_set.md)
       - [OH_Huks_PubKeyInfo](native-apis/_o_h___huks___pub_key_info.md)
       - [OH_Huks_Result](native-apis/_o_h___huks___result.md)
    - 标准库
       - [Node_API](native-lib/third_party_napi/napi.md)
       - [libuv](native-lib/third_party_libuv/libuv.md)
       - [支持的标准库介绍](native-lib/third_party_libc/musl.md)
       - 附录
         - [Native api中没有导出的符号列表](native-lib/third_party_libc/musl-peculiar-symbol.md)
         - [Native api中导出的EGL符号列表](native-lib/third_party_opengl/egl-symbol.md)
         - [Native api中导出的OpenGL ES 3.0符号列表](native-lib/third_party_opengl/openglesv3-symbol.md)  
- 常见问题
