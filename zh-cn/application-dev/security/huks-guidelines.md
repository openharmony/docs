...
> **说明**
>
> 本开发指导基于 API version 9及以上版本SDK，仅适用于JS语言开发。
...
- [`Huks`：通用密钥库系统（ArkTS）（API9）](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-4.0-Beta2/code/BasicFeature/Security/Huks)