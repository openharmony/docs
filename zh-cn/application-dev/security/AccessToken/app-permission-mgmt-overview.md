...
- **访问控制列表（ACL）**
  ...
  系统权限均定义了“ACL使能”字段，当该权限的ACL使能为TRUE，应用可以使用ACL方式跨级别申请该权限。具体单个权限的定义，可参考[系统应用可用的权限](permissions-for-system-apps.md)和[系统服务可用的权限](permissions-for-system-services.md)。
