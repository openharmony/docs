...
3. 调用[KeyAgreement.generateSecret](../../gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-cryptoFramework.md#generatesecret-1)，基于传入的私钥（KeyPair.pubKey）与公钥（KeyPair.priKey）进行密钥协商，返回共享秘密。
