...
5. 调用[OH_Huks_FinishSession](../../reference/native-apis/_huks_key_api.md#oh_huks_finishsession)结束密钥会话，获取加密后的密文。
...
5. 调用[OH_Huks_FinishSession](../../reference/native-apis/_huks_key_api.md#oh_huks_finishsession)结束密钥会话，获取解密后的数据。
