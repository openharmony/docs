...
密钥生成时，可指定参数[HUKS_TAG_DERIVED_AGREED_KEY_STORAGE_FLAG](../../reference/apis-universal-keystore-kit/_huks_type_api.md#oh_huks_keystoragetype)（可选），用于标识基于该密钥协商出的密钥是否由HUKS管理。
