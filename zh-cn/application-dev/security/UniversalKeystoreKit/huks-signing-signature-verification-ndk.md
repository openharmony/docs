...
3. 调用[OH_Huks_InitParamSet](../../reference/native-apis/_huks_param_set_api.md#oh_huks_initparamset)指定算法参数配置。

4. 调用[OH_Huks_InitSession](../../reference/native-apis/_huks_key_api.md#oh_huks_initsession)初始化密钥会话，并获取会话的句柄handle。

5. 调用[OH_Huks_FinishSession](../../reference/native-apis/_huks_key_api.md#oh_huks_finishsession)结束密钥会话，获取签名signature。
...
3. 指定[算法参数配置](../../reference/native-apis/_huks_param_set_api.md#oh_huks_initparamset)。

4. 调用[OH_Huks_FinishSession](../../reference/native-apis/_huks_key_api.md#oh_huks_finishsession)初始化密钥会话，并获取会话的句柄handle。

5. 调用[OH_Huks_UpdateSession](../../reference/native-apis/_huks_key_api.md#oh_huks_updatesession)更新密钥会话。

6. 调用[OH_Huks_FinishSession](../../reference/native-apis/_huks_key_api.md#oh_huks_finishsession)结束密钥会话，验证签名。
