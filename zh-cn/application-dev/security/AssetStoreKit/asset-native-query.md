...
[int32_t OH_Asset_Query(const Asset_Attr *query, uint32_t queryCnt, Asset_ResultSet *resultSet)](../../reference/apis-asset-store-kit/_asset_api.md#ohassetquery())
...
| ASSET_TAG_RETURN_TYPE           | 类型为uint32_t，取值范围详见[Asset_ReturnType](../../reference/apis-asset-store-kit/_asset_type.md#assetreturntype) | 可选     | 关键资产查询返回的结果类型                                         |
