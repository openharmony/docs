...
>**注意：**
>
>名称包含“ASSET_TAG_DATA_LABEL”的属性用于存储业务自定义信息，内容不加密，勿存放个人数据。
...
* 基于别名的访问
  ...
  关键资产存储在ASSET数据库中，以业务身份和别名作为唯一索引。业务需保证每条关键资产的别名唯一。
...
新增一条密码是demo_pwd，别名是demo_alias，附属信息是demo_label的关键资产。用户首次解锁设备后，该关键资产可被访问。
