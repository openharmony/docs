...
- 默认不支持由于同层标签CSS样式或宽高变化导致的同层标签可见状态变化上报，具体规格参考[onNativeEmbedVisibilityChange](../reference/apis-arkweb/ts-basic-components-web.md#onnativeembedvisibilitychange12)。
