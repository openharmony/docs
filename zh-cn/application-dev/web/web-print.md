...
## 通过调用应用侧接口拉起打印。
应用侧通过调用[createWebPrintDocumentAdapter](../reference/apis-arkweb/js-apis-webview.md#createwebprintdocumentadapter)创建打印适配器，通过将适配器传入打印的[print](../reference/apis/js-apis-print.md#print11-2)接口调起打印。
