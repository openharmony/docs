...
Web组件提供位置权限管理能力（[隐私保护说明](../../device-dev/security/security-privacy-protection.md)）。开发者可以通过[onGeolocationShow()](../reference/apis-arkweb/ts-basic-components-web.md#ongeolocationshow)接口对某个网站进行位置权限管理。Web组件根据接口响应结果，决定是否赋予前端页面权限。
