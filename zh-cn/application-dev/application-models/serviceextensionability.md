...
- [跨任务链返回（ArkTS）（Full SDK）（API9）](https://gitee.com/openharmony/applications_app_samples/tree/monthly_20230815/code/SystemFeature/ApplicationModels/TestRely/LauncherTest/CrossChainBack)
