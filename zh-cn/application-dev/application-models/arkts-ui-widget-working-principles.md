...
- [Stage模型卡片（ArkTS）(Full SDK)（API10）](https://gitee.com/openharmony/applications_app_samples/tree/monthly_20230815/code/SuperFeature/Widget/FormExtAbility)

- [Stage模型卡片JS与C++通信（ArkTS）（API9）](https://gitee.com/openharmony/applications_app_samples/tree/monthly_20230815/code/SuperFeature/Widget/FormGame)