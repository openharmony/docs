...
**1、一句话**
- 默认支持拖出能力的组件（可从组件上拖出数据）：Search、TextInput、TextArea、RichEditor、Text、Image、<!--Del-->FormComponent、UIExtensionComponent<!--DelEnd-->Hyperlink
...
- 卡片管理服务：用于管理系统中所添加卡片的常驻代理服务，提供formProvider<!--Del-->和formHost的<!--DelEnd-->接口能力，同时提供卡片对象的管理与使用以及卡片周期性刷新等能力。
<!--Del-->
