...
| 名称 | 描述 | 
| -------- | -------- |
| [neural_network_core.h](capi-neural__network__core_8h.md) | Neural Network Core模块接口定义，AI推理框架使用Neural Network Core提供的Native接口，完成模型编译，并在加速硬件上执行推理和计算。 | 
| [neural_network_runtime.h](capi-neural__network__runtime_8h.md) | Neural Network Runtime模块接口定义，AI推理框架使用Neural Network Runtime提供的Native接口，完成模型构建。 | 
| [neural_network_runtime_type.h](capi-neural__network__runtime__type_8h.md) | Neural Network Runtime定义的结构体和枚举值。 | 
