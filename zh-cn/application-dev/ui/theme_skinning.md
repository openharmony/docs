...
注：如果setDefaultTheme的参数为undefined时，默认token值对应的色值参考[系统缺省token参数值](#系统缺省token参数值)：
...
|---------------|-------------------------------|--------------------------------------------------------|-----------|
| 鸿蒙品牌色         | brand | #0A59F7 | #317AF7 |
| 一级警示色         | warning | #E84026 | #D94838 |
| 二级警示色         | alert | #ED6F21 | #DB6B42 |
| 确认色           | confirm | #64BB5C | #5BA854 |
| 一级文本          | fontPrimary                   | <font style=background:#E5000000>    </font> #E5000000 | #E5FFFFFF |
