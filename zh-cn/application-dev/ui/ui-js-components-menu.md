...
提供菜单组件，作为临时性弹出窗口，用于展示用户可执行的操作，具体用法请参考[menu](../reference/apis-arkui/arkui-jsjs-components-basic-menu.md)。
...
> **说明：**
> - menu仅支持[option](../reference/apis-arkui/arkui-jsjs-components-basic-option.md)子组件。
>
