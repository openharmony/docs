...
- [页面布局和连接（ArkTS）（API9）](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-5.0.1-Release/code/UI/ArkTsComponentCollection/DefiningPageLayoutAndConnection)