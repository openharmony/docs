...
| 添加组件        | 介绍了几种常用的系统组件、以及通过API方式支持的界面元素。 | -&nbsp;[常用组件](arkts-common-components-button.md)<br/>-&nbsp;[气泡和菜单](arkts-popup-and-menu-components-popup.md)<br/>- [使用文本](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/ui/arkts-styled-string.md) |
...
| 主题设置       | 介绍了应用级和页面级的主题设置能力。       | <!--RP1--><!--RP1End--><br/>-&nbsp;[设置主题换肤](theme_skinning.md) |
