...
在前面的章节中，构建的页面多为静态界面。如果希望构建一个动态、有交互的界面，需要引入“状态”的概念。

  **图1** 效果图  

![Video_2023-03-06_152548](figures/Video_2023-03-06_152548.gif)

以上示例中，用户与应用的交互触发了文本状态变更，状态变更引起了UI渲染，UI从“Hello World”变更为“Hello ArkUI”。
...
| \@Track      | \@Trace                                                | V1装饰器@Track为精确观察，可以不依赖@Observed单独使用。不使用@Track将无法做到类属性的精准观察。<br/>V2\@Trace装饰的属性可以被精确跟踪观察。 |
