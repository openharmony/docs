...
text是文本组件，用于呈现一段文本信息。具体用法请参考[text API](../reference/apis-arkui/arkui-jsjs-components-basic-text.md)。
...
- text组件支持[Span](../reference/apis-arkui/arkui-jsjs-components-basic-span.md)子组件
