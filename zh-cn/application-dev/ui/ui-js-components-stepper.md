...
当一个任务需要多个步骤时，可以使用stepper组件展示当前进展。具体用法请参考[stepper API](../reference/apis-arkui/arkui-jsjs-components-container-stepper.md)。
...
用stepper组件实现分步，再创建[Toggle](../reference/apis-arkui/arkui-jsjs-components-basic-toggle.md)组件实现选择显示功能，再使用[Select](../reference/apis-arkui/arkui-jsjs-components-basic-select.md)组件实现改变选中值动态修改字体颜色或大小。
