...
<!--Del-->
下拉刷新与上拉加载的具体实现可参考[相关实例](#相关实例)中新闻数据加载。若开发者希望快速实现此功能，也可使用三方组件[PullToRefresh](https://gitcode.com/openharmony-sig/PullToRefresh)。<!--DelEnd-->
...
- [PullToRefresh](https://gitcode.com/openharmony-sig/PullToRefresh)
