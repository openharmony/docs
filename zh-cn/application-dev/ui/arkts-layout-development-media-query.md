...
- (height &lt;= 800px) ：表示当高度小于等于800px时条件成立。（媒体特性不确定具体值时推荐使用媒体逻辑范围操作符）
...
- [横竖屏切换（ArkTS）（API9）](https://gitee.com/openharmony/applications_app_samples/tree/OpenHarmony-4.0-Release/code/UI/ArkTsComponentCollection/MediaQuery)
