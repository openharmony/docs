...
> **说明：**
>
> 在ArkTS-ST中，取消了UI中无法使用非\@Track装饰的属性的限制，不会运行时报错。如果class类中使用了\@Track装饰器，非\@Track装饰的属性能在UI中正常显示，但变化时不会刷新UI。
