...
| 名称 | 描述 | 
| -------- | -------- |
| [ffrt_queue_type_t](_f_f_r_t.md#ffrt_queue_type_t) { [ffrt_queue_serial](_f_f_r_t.md) = 0, [ffrt_queue_concurrent](_f_f_r_t.md), [ffrt_queue_max](_f_f_r_t.md) } | 队列类型。  | 
...
| FFRT_C_API int [ffrt_queue_attr_get_max_concurrency](_f_f_r_t.md#ffrt_queue_attr_get_max_concurrency) ([ffrt_queue_attr_t](ffrt__queue__attr__t.md)\* attr) | 获取并行队列最大并发度。  | 
...
| FFRT_C_API [ffrt_queue_t](_f_f_r_t.md)[ffrt_get_main_queue](_f_f_r_t.md#ffrt_get_main_queue) () | 获取主线程队列。  | 
| FFRT_C_API [ffrt_queue_t](_f_f_r_t.md)[ffrt_get_current_queue](_f_f_r_t.md#ffrt_get_current_queue) () | 获取应用 Worker(ArkTs)线程队列。  | 
