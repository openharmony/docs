...
| Input_TouchEventCallback touchCallback | 触摸事件的回调函数。<br>**起始版本：** 12 |
...
| [typedef void (\*Input_TouchEventCallback)(const Input_TouchEvent* touchEvent)](#input_toucheventcallback) | Input_TouchEventCallback() | 触摸事件的回调函数，touchEvent的生命周期为回调函数内。<br>**起始版本：** 12 |
...
| 参数项 | 描述 |
| -- | -- |
| const [Input_TouchEvent](capi-input-touchevent.md)* touchEvent | 触摸事件对象。 |
