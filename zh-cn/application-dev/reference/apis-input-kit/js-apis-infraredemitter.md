...
| pattern | Array&lt;number&gt; | 是    | 红外电平信号，单位是us。电平信号的数量取值范围为[0,1024]，且需为偶数。电平信号取值需为正数。<br/>比如[100,200,300,400]该电平信号数组，其中表示100us为高电平信号、200us为低电平信号、300us为高电平信号、400us为低电平信号。 |
