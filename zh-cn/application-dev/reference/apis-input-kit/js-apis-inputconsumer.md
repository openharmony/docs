...
| 名称        | 类型   | 只读   | 可选   | 说明      |
| --------- | ------ | ------- | ------- | ------- |
| key       | number  | 否      | 否      | 按键键值。该属性仅在手机和平板设备上生效。<br>当前仅支持[KEYCODE_VOLUME_UP](js-apis-keycode.md#keycode)键和[KEYCODE_VOLUME_DOWN](js-apis-keycode.md#keycode)键。 | // 误报，不知道怎么修改
