...
| [OH_NetConn_SetPacUrl](_net_connection.md#oh_netconn_setpacurl) (const char \*pacUrl) | 设置系统级自动代理配置（PAC）脚本地址。 |
| [OH_NetConn_GetPacUrl](_net_connection.md#oh_netconn_getpacurl) (char \*pacUrl) | 获取系统级自动代理配置（PAC）脚本地址。 |