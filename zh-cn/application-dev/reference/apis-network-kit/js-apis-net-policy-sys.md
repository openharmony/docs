...
| 参数名   | 类型                                                                | 必填 | 说明                                   |
| -------- | ------------------------------------------------------------------- | ---- | -------------------------------------- |
| type     | string                                                              | 是   | on：订阅的事件类型。'netUidPolicyChange'：注册 policy 发生改变事件。                  |
...
| 参数名   | 类型                                                                | 必填 | 说明                                   |
| -------- | ------------------------------------------------------------------- | ---- | -------------------------------------- |
| type     | string                                                              | 是   | off：注销的事件类型。'netUidPolicyChange'：注销 policy 发生改变事件。               |
...
| 参数名   | 类型                                                          | 必填 | 说明                                   |
| -------- | ------------------------------------------------------------- | ---- | -------------------------------------- |
| type     | string                                                        | 是   | on：订阅的事件类型。'netUidRuleChange'：注册 rule 发生改变事件。                    |
...
| 参数名   | 类型                                                          | 必填 | 说明                                   |
| -------- | ------------------------------------------------------------- | ---- | -------------------------------------- |
| type     | string                                                        | 是   | off：注销的事件类型。'netUidRuleChange'：注销 rule 发生改变事件。                    |
...
| 参数名   | 类型                      | 必填 | 说明                                      |
| -------- | ------------------------- | ---- | ----------------------------------------- |
| type     | string                    | 是   | on：订阅的事件类型。'netMeteredIfacesChange'：注册计量 iface 发生改变事件。                 |
...
| 参数名   | 类型                      | 必填 | 说明                                      |
| -------- | ------------------------- | ---- | ----------------------------------------- |
| type     | string                    | 是   | off：注销的事件类型。'netMeteredIfacesChange'：注销计量 iface 发生改变事件。                 |
...
| 参数名   | 类型                                                   | 必填 | 说明                                       |
| -------- | ------------------------------------------------------ | ---- | ------------------------------------------ |
| type     | string                                                 | 是   | on：订阅的事件类型。'netQuotaPolicyChange'：注册计量网络策略发生改变事件。                 |
...
| 参数名   | 类型                                                   | 必填 | 说明                                       |
| -------- | ------------------------------------------------------ | ---- | ------------------------------------------ |
| type     | string                                                 | 是   | off：注销的事件类型。'netQuotaPolicyChange'：注销计量网络策略发生改变事件。                 |
...
| 参数名   | 类型               | 必填 | 说明                                       |
| -------- | ------------------ | ---- | ------------------------------------------ |
| type     | string             | 是   | on：订阅的事件类型。'netBackgroundPolicyChange'：注册后台网络策略发生改变事件。                 |
...
| 参数名   | 类型               | 必填 | 说明                                       |
| -------- | ------------------ | ---- | ------------------------------------------ |
| type     | string             | 是   | off：注销的事件类型。'netBackgroundPolicyChange'：注销后台网络策略发生改变事件。                 |
