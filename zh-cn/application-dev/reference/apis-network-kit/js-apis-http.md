...
| callback | AsyncCallback\<Object\> | 是   | 回调函数。当订阅成功，error为undefined，data为获取到的Object x；否则为错误对象。 |
...
| callback | AsyncCallback\<ArrayBuffer\> | 是   | 回调函数。当订阅成功时，error为undefined，data为获取到的ArrayBuffer x；否则为错误对象。 |
