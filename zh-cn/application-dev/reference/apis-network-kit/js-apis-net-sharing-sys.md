...
| 参数名   | 类型                    | 必填 | 说明                         |
| -------- | ----------------------- | ---- | ---------------------------- |
| type     | string                  | 是   | on：订阅的事件类型。'sharingStateChange'：注册网络共享状态变化事件。                   |
...
| 参数名   | 类型                    | 必填 | 说明                         |
| -------- | ----------------------- | ---- | ---------------------------- |
| type     | string                  | 是   | off：注销的事件类型。'sharingStateChange'：注销网络共享状态变化事件。                   |
...
| 参数名   | 类型                                                                   | 必填 | 说明                                  |
| -------- | -------------------------------------------------------------------- | ---- | ------------------------------------- |
| type     | string                                                                | 是   | on：订阅的事件类型。'interfaceSharingStateChange'：注册网卡网络共享状态变化事件。                            |
...
| 参数名   | 类型                                                                        | 必填 | 说明                                     |
| -------- | --------------------------------------------------------------------------- | ---- | ---------------------------------------- |
| type     | string                                                                     | 是   | off：注销的事件类型。'interfaceSharingStateChange'：注销网卡网络共享状态变化事件。                               |
...
| 参数名   | 类型                      | 必填 | 说明                           |
| -------- | ------------------------- | ---- | ------------------------------ |
| type     | string                    | 是   | on：订阅的事件类型。'sharingUpstreamChange'：注册上行网络变化事件。                     |
...
| 参数名   | 类型                      | 必填 | 说明                             |
| -------- | ------------------------- | ---- | -------------------------------- |
| type     | string                    | 是   | off：注销的事件类型。'sharingUpstreamChange'：注销上行网络变化事件。                       |
