...
- ArkTS API 
  ...
  - [@ohos.net.mdns (MDNS管理)（系统接口）](js-apis-net-mdns-sys.md)
  - [@ohos.net.sharing (网络共享管理)（系统接口）](js-apis-net-sharing-sys.md)
  - [@ohos.net.socket (Socket连接)（系统接口）](js-apis-socket-sys.md)
  ...
  - [@ohos.net.webSocket (WebSocket连接)（系统接口）](js-apis-webSocket-sys.md)
  - [@ohos.net.networkSecurity (Network Security)（系统接口）](js-apis-networkSecurity-sys.md)
- C API
  - 模块
