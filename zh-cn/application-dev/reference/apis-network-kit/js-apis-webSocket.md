...
| callback | ClientConnectionCloseCallback\<[ClientConnectionCloseCallback](#clientconnectionclosecallback19)\> | 是  | 回调函数。<br>close：close错误码；reason：错误码说明。 |
...
| callback | ClientConnectionCloseCallback\<[ClientConnectionCloseCallback](#clientconnectionclosecallback19)\> | 否  | 回调函数。<br>close：close错误码；reason：错误码说明。 |
