...
| 名称 | 描述 | 
| -------- | -------- |
| [NetConn_NetCap](_net_connection.md#netconn_netcap) {<br/>NETCONN_NET_CAPABILITY_MMS = 0,<br/>NETCONN_NET_CAPABILITY_NOT_METERED = 11,<br/>[NETCONN_NET_CAPABILITY_INTERNET](_net_connection.md) = 12,<br/>[NETCONN_NET_CAPABILITY_NOT_VPN](_net_connection.md) = 15,<br/>[NETCONN_NET_CAPABILITY_VALIDATED](_net_connection.md) = 16<br/>} | 网络能力集。 | 
