...
| [Camera_ErrorCode](_o_h___camera.md#camera_errorcode) [OH_PreviewOutput_GetPreviewRotation](_o_h___camera.md#oh_previewoutput_getpreviewrotation) ([Camera_PreviewOutput](_o_h___camera.md#camera_previewoutput) \*previewOutput, int displayRotation, [Camera_ImageRotation](_o_h___camera.md#camera_imagerotation) \*imageRotation) | 获得相机预览旋转角度。 | 
| [Camera_ErrorCode](_o_h___camera.md#camera_errorcode) [OH_PreviewOutput_SetPreviewRotation](_o_h___camera.md#oh_previewoutput_setpreviewrotation) ([Camera_PreviewOutput](_o_h___camera.md#camera_previewoutput) \*previewOutput, [Camera_ImageRotation](_o_h___camera.md#camera_imagerotation) \*previewRotation, bool isDisplayLocked) | 设置相机预览旋转角度。 | 
