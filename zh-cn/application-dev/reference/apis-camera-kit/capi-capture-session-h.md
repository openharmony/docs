...
| [Camera_CaptureSession](capi-camera-capturesession.md) | Camera_CaptureSession | 捕获会话对象。<br> 可以使用{@link OH_CameraManager_CreateCaptureSession}方法创建指针。 |
...
| -- | -- |
| Camera_CaptureSession* session | 传递回调的Camera_CaptureSession实例。 |
| [OH_CaptureSession_OnSystemPressureLevel](capi-capture-session-h.md#oh_capturesession_onsystempressurelevel) systemPressureLevel | 要注册的系统压力状态回调。 |
...
| -- | -- |
| Camera_CaptureSession* session | 传递回调的Camera_CaptureSession实例。 |
| [OH_CaptureSession_OnSystemPressureLevel](capi-capture-session-h.md#oh_capturesession_onsystempressurelevel) systemPressureLevel | 要注销的系统压力状态回调。 |
