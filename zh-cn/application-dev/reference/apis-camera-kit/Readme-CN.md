...
- ArkTS API<!--camera-arkts-->
  - @ohos.multimedia.camera (相机管理)<!--js-apis-camera-->
    ...
    - [Interfaces (AutoDeviceSwitchQuery)](arkts-apis-camera-AutoDeviceSwitchQuery.md)
    - [Interfaces (AutoExposure)](arkts-apis-camera-AutoExposure.md)
    - [Interfaces (AutoExposureQuery)](arkts-apis-camera-AutoExposureQuery.md)
    - [Interfaces (CameraInput)](arkts-apis-camera-CameraInput.md)
    - [Interfaces (CameraManager)](arkts-apis-camera-CameraManager.md)
    - [Interfaces (CameraOutput)](arkts-apis-camera-CameraOutput.md)
    - [Interfaces (ColorManagement)](arkts-apis-camera-ColorManagement.md)
    - [Interfaces (ColorManagementQuery)](arkts-apis-camera-ColorManagementQuery.md)
    - [Interfaces (Flash)](arkts-apis-camera-Flash.md)
    - [Interfaces (FlashQuery)](arkts-apis-camera-FlashQuery.md)
    - [Interfaces (Focus)](arkts-apis-camera-Focus.md)
    - [Interfaces (FocusQuery)](arkts-apis-camera-FocusQuery.md)
    - [Interfaces (Macro)](arkts-apis-camera-Macro.md)
    - [Interfaces (MacroQuery)](arkts-apis-camera-MacroQuery.md)
    - [Interfaces (MetadataOutput)](arkts-apis-camera-MetadataOutput.md)
    - [Interfaces (Photo)](arkts-apis-camera-Photo.md)
    - [Interfaces (PhotoOutput)](arkts-apis-camera-PhotoOutput.md)
    - [Interfaces (PhotoSession)](arkts-apis-camera-PhotoSession.md)
    - [Interfaces (PreviewOutput)](arkts-apis-camera-PreviewOutput.md)
    - [Interfaces (SecureSession)](arkts-apis-camera-SecureSession.md)
    - [Interfaces (Session)](arkts-apis-camera-Session.md)
    - [Interfaces (Stabilization)](arkts-apis-camera-Stabilization.md)
    - [Interfaces (StabilizationQuery)](arkts-apis-camera-StabilizationQuery.md)
    - [Interfaces (VideoOutput)](arkts-apis-camera-VideoOutput.md)
    - [Interfaces (VideoSession)](arkts-apis-camera-VideoSession.md)
    - [Interfaces (WhiteBalance)](arkts-apis-camera-WhiteBalance.md)
    - [Interfaces (WhiteBalanceQuery)](arkts-apis-camera-WhiteBalanceQuery.md)
    - [Interfaces (Zoom)](arkts-apis-camera-Zoom.md)
    - [Interfaces (ZoomQuery)](arkts-apis-camera-ZoomQuery.md)
