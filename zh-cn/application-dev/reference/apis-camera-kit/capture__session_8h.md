...
| [Camera_ErrorCode](_o_h___camera.md#camera_errorcode) [OH_CaptureSession_IsMacroSupported](_o_h___camera.md#oh_capturesession_ismacrosupported)([Camera_CaptureSession](_o_h___camera.md#camera_capturesession)\* session, bool* isSupported) | 检查是否支持微距能力。 |
| [Camera_ErrorCode](_o_h___camera.md#camera_errorcode) [OH_CaptureSession_EnableMacro](_o_h___camera.md#oh_capturesession_enablemacro)([Camera_CaptureSession](_o_h___camera.md#camera_capturesession)\* session, bool enabled) | 启用或不启用相机设备的微距能力。 |
