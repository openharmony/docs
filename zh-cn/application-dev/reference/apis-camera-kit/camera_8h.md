...
| struct [Camera_SmoothZoomInfo](_camera___smooth_zoom_info.md) | 平滑变焦信息对象。 |
...
| typedef enum [Camera_PreconfigType](_o_h___camera.md#camera_preconfigtype) [Camera_PreconfigType](_o_h___camera.md#camera_preconfigtype) | 预配置类型的枚举。 |
| typedef enum [Camera_PreconfigRatio](_o_h___camera.md#camera_preconfigratio) [Camera_PreconfigRatio](_o_h___camera.md#camera_preconfigratio) | 预配置比率的枚举。 |
...
| typedef struct [Camera_SmoothZoomInfo](_camera___smooth_zoom_info.md) [Camera_SmoothZoomInfo](_o_h___camera.md#camera_smoothzoominfo) | 平滑变焦信息对象。 |
| typedef struct [Camera_CaptureStartInfo](_camera___capture_start_info.md) [Camera_CaptureStartInfo](_o_h___camera.md#camera_capturestartinfo) | 捕获开始信息。 |
| typedef struct [Camera_FrameShutterEndInfo](_camera___frame_shutter_end_info.md) [Camera_FrameShutterEndInfo](_o_h___camera.md#camera_frameshutterendinfo) | 帧快门回调结束信息。 |
...
| 名称 | 描述 |
| -------- | -------- |
| [Camera_ErrorCode](_o_h___camera.md#camera_errorcode) {<br/>CAMERA_OK = 0,<br/>CAMERA_INVALID_ARGUMENT = 7400101,<br/>CAMERA_OPERATION_NOT_ALLOWED = 7400102,<br/>CAMERA_SESSION_NOT_CONFIG = 7400103,<br/>CAMERA_SESSION_NOT_RUNNING = 7400104,<br/>CAMERA_SESSION_CONFIG_LOCKED = 7400105,<br/>CAMERA_DEVICE_SETTING_LOCKED = 7400106,<br/>CAMERA_CONFLICT_CAMERA = 7400107,<br/>CAMERA_DEVICE_DISABLED = 7400108,<br/>CAMERA_DEVICE_PREEMPTED = 7400109,<br/>CAMERA_UNRESOLVED_CONFLICTS_WITH_CURRENT_CONFIGURATIONS = 7400110,<br/>CAMERA_SERVICE_FATAL_ERROR = 7400201<br/>} | 相机错误代码的枚举。 |
...
| [Camera_SceneMode](_o_h___camera.md#camera_scenemode) {<br/>NORMAL_PHOTO = 1,<br/>NORMAL_VIDEO = 2,<br/>SECURE_PHOTO = 12 } | 相机模式的枚举。  |
...
| [Camera_Format](_o_h___camera.md#camera_format) {<br/>CAMERA_FORMAT_RGBA_8888 = 3,<br/>CAMERA_FORMAT_YUV_420_SP = 1003,<br/>CAMERA_FORMAT_JPEG = 2000,<br/>CAMERA_FORMAT_YCBCR_P010 = 2001,<br/>CAMERA_FORMAT_YCRCB_P010 = 2002<br/>} | 相机格式类型的枚举。 |
...
| [Camera_TorchMode](_o_h___camera.md#camera_metadataobjecttype) {<br/>OFF = 0,<br/>ON = 1,<br/>AUTO = 2<br/>} | 手电筒模式的枚举。 |
| [Camera_SmoothZoomMode](_o_h___camera.md#camera_metadataobjecttype) {<br/>NORMAL = 0<br/>} | 平滑变焦模式的枚举。 |
| [Camera_PreconfigType](_o_h___camera.md#camera_metadataobjecttype) {<br/>PRECONFIG_720P = 0,<br/>PRECONFIG_1080P = 1,<br/>PRECONFIG_4K = 2,<br/>PRECONFIG_HIGH_QUALITY = 3<br/>} | 预配置类型的枚举。 |
| [Camera_PreconfigRatio](_o_h___camera.md#camera_metadataobjecttype) {<br/>PRECONFIG_RATIO_1_1 = 0,<br/>PRECONFIG_RATIO_4_3 = 1,<br/>PRECONFIG_RATIO_16_9 = 2<br/>} | 预配置比率的枚举。 |
