...
| bool [OH_Drawing_RegionOp](_drawing.md#oh_drawing_regionop) ([OH_Drawing_Region](_drawing.md#oh_drawing_region) \*region, const [OH_Drawing_Region](_drawing.md#oh_drawing_region) \*dst, [OH_Drawing_RegionOpMode](_drawing.md#oh_drawing_regionopmode) op) | 将两个区域按照指定的区域操作类型合并。 | 
