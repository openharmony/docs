...
| 枚举值 | 描述 | 
| -------- | -------- |
| NATIVEBUFFER_PIXEL_FMT_CLUT8<sup>12+</sup> | CLUT8格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_CLUT1<sup>12+</sup> | CLUT1格式<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_CLUT4<sup>12+</sup> | CLUT4格式。<br/>从API version 12开始，支持此枚举。 | 
...
| NATIVEBUFFER_PIXEL_FMT_YUV_422_I<sup>12+</sup> | YUV422 interleaved格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCBCR_422_SP<sup>12+</sup> | YCBCR422 semi-plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCRCB_422_SP<sup>12+</sup> | YCRCB422 semi-plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCBCR_420_SP<sup>12+</sup> | YCBCR420 semi-plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCRCB_420_SP<sup>12+</sup> | YCRCB420 semi-plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCBCR_422_P<sup>12+</sup> | YCBCR422 plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCRCB_422_P<sup>12+</sup> | YCRCB422 plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCBCR_420_P<sup>12+</sup> | YCBCR420 plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YCRCB_420_P<sup>12+</sup> | YCRCB420 plannar格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YUYV_422_PKG<sup>12+</sup> | YUYV422 packed格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_UYVY_422_PKG<sup>12+</sup> | UYVY422 packed格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_YVYU_422_PKG<sup>12+</sup> | YVYU422 packed格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_VYUY_422_PKG<sup>12+</sup> | VYUY422 packed格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_RGBA_1010102<sup>12+</sup> | RGBA_1010102 packed格式。<br/>从API version 12开始，支持此枚举。 | 
| NATIVEBUFFER_PIXEL_FMT_VENDER_MASK<sup>12+</sup> | vender mask格式。<br/>从API version 12开始，支持此枚举。 | 
