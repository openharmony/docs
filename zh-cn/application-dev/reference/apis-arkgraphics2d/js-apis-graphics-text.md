...
| verticalAlign<sup>20+</sup>   | [TextVerticalAlign](#textverticalalign20) | 是   | 是   | 文本垂直对齐方式，开启行高缩放或行内不同字号文本混排时生效。BOTTOM表示底部对齐，CENTER表示居中对齐，TOP表示顶部对齐，默认值为BASELINE表示基线对齐。|
