...
| lineSpacing<sup>21+</sup>   | number | 否   | 是   | 行间距，默认值为0。\nlineSpacing不受TextStyle中lineHeightMaximum和lineHeightMinimum限制。\n尾行默认添加行间距，可通过设置TextStyle.textHeightBehavior为DISABLE_ALL或DISABLE_LAST_ASCENT禁用尾行行间距。 |
