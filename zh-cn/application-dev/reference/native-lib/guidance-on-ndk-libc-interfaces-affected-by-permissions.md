...
1. 受Seccomp机制影响。
    <!--RP1-->Seccomp机制可参考[Seccomp策略与开发指导](../../../device-dev/subsystems/subsys-boot-init-seccomp.md)<!--RP1End-->。
...
3. 受SELinux限制影响。
    <!--RP2-->SELinux的说明可参考[SELinux概述](../../../device-dev/subsystems/subsys-security-selinux-overview.md)<!--RP2End-->。
