...
与这个公共事件相关的接口：具体可见[setPortRoles](../../apis-basic-services-kit/js-apis-usbManager-sys.md#usbsetportroles)中的dataRole参数。
...
与这个公共事件相关的接口：具体可见[USBDevice](../../apis-basic-services-kit/js-apis-usbManager-sys.md#usbdevice)。 
