...
与这个公共事件相关的接口：具体可见[setPortRoles](../../apis/js-apis-usbManager.md#usbsetportroles)中的dataRole参数。
...
与这个公共事件相关的接口：具体可见[USBDevice](../../apis/js-apis-usbManager.md#usbdevice)。 
