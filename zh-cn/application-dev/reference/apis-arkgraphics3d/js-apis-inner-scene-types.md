...
| 名称 | 类型 | 只读 | 必填 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| x | number | 否 | 是 | x轴分量，取值范围是实数。 |
| y | number | 否 | 是 | y轴分量，取值范围是实数。|
...
| 名称 | 类型 | 只读 | 必填 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| aabbMin | [Vec3](#vec3) | 否 | 是 | 轴对齐边界盒的小值点。 |
| aabbMax | [Vec3](#vec3) | 否 | 是 | 轴对齐边界盒的大值点。 |
...
| 名称 | 类型 | 只读 | 必填 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| r | number | 否 | 是 | 红色分量，取值范围是[0, 1]。 |
| g | number | 否 | 是 | 绿色分量，取值范围是[0, 1]。 |
| b | number | 否 | 是 | 蓝色分量，取值范围是[0, 1]。 |
| a | number | 否 | 是 | 透明度分量，取值范围是[0, 1]。 |
...
| 名称 | 类型 | 只读 | 必填 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| x | number | 否 | 是 | 矩形左下角x轴分量，取值范围是实数。 |
| y | number | 否 | 是 | 矩形左下角y轴分量，取值范围是实数。 |
