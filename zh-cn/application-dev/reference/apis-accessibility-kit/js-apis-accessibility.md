...
| fontColor       | number \| string                         | 否    | 否    | 描述字幕字体颜色。number：HEX 格式颜色，支持 rgb 或 argb。string：支持 '#rrggbb', '#rrggbbaa', '#rgb', '#rgba' 格式。例如，不透明红色：number 0xffff0000，string '#ff0000', '#ff0000ff', '#f00', '#f00f'。 |
| fontEdgeType    | [CaptionsFontEdgeType](#captionsfontedgetype8) | 否    | 否    | 描述字幕字体边缘。   |
| backgroundColor | number \| string                         | 否    | 否    | 描述字幕背景颜色。number：HEX 格式颜色，支持 rgb 或 argb。string：支持 '#rrggbb', '#rrggbbaa', '#rgb', '#rgba' 格式。例如，不透明红色：number 0xffff0000，string '#ff0000', '#ff0000ff', '#f00', '#f00f'。   |
| windowColor     | number \| string                         | 否    | 否    | 描述字幕窗口颜色。number：HEX 格式颜色，支持 rgb 或 argb。string：支持 '#rrggbb', '#rrggbbaa', '#rgb', '#rgba' 格式。例如，不透明红色：number 0xffff0000，string '#ff0000', '#ff0000ff', '#f00', '#f00f'。   |
