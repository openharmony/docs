...
| accessibilityNextFocusId<sup>16+</sup>             | number                | 是   | 否   | 下一个要聚焦的组件ID。通过findElement('elementId')查询节点信息，接着通过attributeValue获取属性的值。 |
| accessibilityPreviousFocusId<sup>16+</sup>             | number                | 是   | 否   | 上一个聚焦的组件ID。通过findElement('elementId')查询节点信息，接着通过attributeValue获取属性的值。 |
