...
| checked              | boolean                                                            | 是   | 否   | 表示元素当前的可点击状态。true表示元素当前是可点击的，false表示元素当前是不可点击的，默认值为false。 |
| children             | Array&lt;[AccessibilityElement](#accessibilityelement9)&gt;        | 是   | 否   | 所有子元素。 |
| clickable            | boolean                                                            | 是   | 否   | 表示元素是否可点击。true表示元素可点击，false表示元素不可点击，默认值为false。|
| componentId          | number                                                             | 是   | 否   | 元素所属的组件ID。默认值为-1。|
| componentType        | string                                                             | 是   | 否   | 元素所属的组件类型。 |
| contents             | Array&lt;string&gt;                                                | 是   | 否   | 内容。 |
| currentIndex         | number                                                             | 是   | 否   | 当前项的索引。默认值为0。|
| description          | string                                                             | 是   | 否   | 元素的描述信息。 |
| editable             | boolean                                                            | 是   | 否   | 表示元素是否可编辑。true表示元素可编辑，false表示元素不可编辑，默认值为false。 |
| endIndex             | number                                                             | 是   | 否   | 屏幕最后显示项的列表索引。默认值为0。 |
| error                | string                                                             | 是   | 否   | 错误状态字符串。 |
| focusable            | boolean                                                            | 是   | 否   | 表示元素是否可聚焦。true表示元素可聚焦，false表示元素不可聚焦，默认值为false。 |
| hintText             | string                                                             | 是   | 否   | 提示文本。 |
| inputType            | number                                                             | 是   | 否   | 输入文本的类型。默认值为0。 |
| inspectorKey         | string                                                             | 是   | 否   | 检查键。 |
| isActive             | boolean                                                            | 是   | 否   | 表示元素是否处于活动状态。true表示元素处于活动状态，false表示元素不处于活动状态，默认值为true。 |
| isEnable             | boolean                                                            | 是   | 否   | 表示元素是否启用。true表示元素已启用，false表示元素未启用，默认值为false。 |
| isHint               | boolean                                                            | 是   | 否   | 表示元素是否为提示状态。true表示元素处于提示状态，false表示元素不处于提示状态，默认值为false。 |
| isFocused            | boolean                                                            | 是   | 否   | 表示元素是否聚焦。true表示元素处于聚焦状态，false表示元素不处于聚焦状态，默认值为false。 |
| isPassword           | boolean                                                            | 是   | 否   | 表示元素是否为密码。true表示元素为密码，false表示元素不为密码，默认值为false。 |
| isVisible            | boolean                                                            | 是   | 否   | 表示元素是否可见。true表示元素可见，false表示元素不可见，默认值为false。 |
| itemCount            | number                                                             | 是   | 否   | 项目的总数。默认值为0。 |
| lastContent          | string                                                             | 是   | 否   | 最后的内容。 |
| layer                | number                                                             | 是   | 否   | 该元素的显示层。 |
| longClickable        | boolean                                                            | 是   | 否   | 表示元素是否可长单击。true表示元素可长单击，false表示元素不可长单击，默认值为false。 |
| pageId               | number                                                             | 是   | 否   | 页码id。默认值为-1。 |
| parent               | [AccessibilityElement](#accessibilityelement9)                     | 是   | 否   | 元素的父元素。 |
| pluralLineSupported  | boolean                                                            | 是   | 否   | 表示元素是否支持多行文本。true表示元素支持多行文本，false表示元素不支持多行文本，默认值为false。|
...
| scrollable           | boolean                                                            | 是   | 否   | 表示元素是否可滚动。true表示元素可滚动，false表示元素不可滚动，默认值为false。 |
| selected             | boolean                                                            | 是   | 否   | 表示元素是否被选中。true表示元素被选中，false表示元素未被选中，默认值为false。 |
| startIndex           | number                                                             | 是   | 否   | 在屏幕上的第一个项目的列表索引。默认值为0。 |
...
| valueMax             | number                                                             | 是   | 否   | 最大值。默认值为0。 |
| valueMin             | number                                                             | 是   | 否   | 最小值。默认值为0。|
| valueNow             | number                                                             | 是   | 否   | 当前值。默认值为0。 |
| windowId             | number                                                             | 是   | 否   | 窗口ID。默认值为-1。 |
...
| accessibilityNextFocusId<sup>18+</sup>             | number                | 是   | 否   | 下一个要聚焦的组件ID。通过findElement('elementId')查询到的AccessibilityElementInfo对象中可获取到用户在控件上设置的该属性值。默认值为-1。 |
| accessibilityPreviousFocusId<sup>18+</sup>             | number                | 是   | 否   | 上一个聚焦的组件ID。通过findElement('elementId')查询到的AccessibilityElementInfo对象中可获取到用户在控件上设置的该属性值。默认值为-1。 |
...
| accessibilityScrollable<sup>18+</sup>             | boolean                 | 是   | 否   | 表示无障碍模式下元素是否滚动，优先级高于scrollable。其中，true表示可滚动，false表示不可滚动，默认值为true。|
