...
> **说明：** 
>
> 其中deviceIds为[DeviceInfo](../apis/js-apis-device-manager.md#deviceinfo)中的networkId, 通过调用[deviceManager.getTrustedDeviceListSync](../apis/js-apis-device-manager.md#gettrusteddevicelistsync)方法得到。deviceManager模块的接口均为系统接口，仅系统应用可用。
