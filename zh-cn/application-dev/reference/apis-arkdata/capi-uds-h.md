...
| [void OH_UdsPixelMap_GetPixelMap(OH_UdsPixelMap* pThis, OH_PixelmapNative* pixelmapNative)](#oh_udspixelmap_getpixelmap) | 从像素图片类型[OH_UdsPixelMap](capi-oh-udspixelmap.md)实例中获取像素图片[OH_PixelmapNative](../ImageKit/_image___native_module.md#oh_pixelmapnative_antialiasinglevel)实例的指针。 |
...
从像素图片类型[OH_UdsPixelMap](capi-oh-udspixelmap.md)实例中获取像素图片[OH_PixelmapNative](../ImageKit/_image___native_module.md#oh_pixelmapnative_antialiasinglevel)实例的指针。
...
| ----------------------------------------------- | ------------------------------------------------------------ |
| [OH_UdsPixelMap](capi-oh-udspixelmap.md)* pThis | 表示指向像素图片类型[OH_UdsPixelMap](capi-oh-udspixelmap.md)实例的指针。 |
| OH_PixelmapNative* pixelmapNative               | 该参数是输出参数，表示指向像素图片[OH_PixelmapNative](../ImageKit/_image___native_module.md#oh_pixelmapnative_antialiasinglevel)实例的指针。 |
...
| ----------------------------------------------- | ------------------------------------------------------------ |
| [OH_UdsPixelMap](capi-oh-udspixelmap.md)* pThis | 表示指向像素图片类型[OH_UdsPixelMap](capi-oh-udspixelmap.md)实例的指针。 |
| OH_PixelmapNative* pixelmapNative               | 表示指向像素图片[OH_PixelmapNative](../ImageKit/_image___native_module.md#oh_pixelmapnative_antialiasinglevel)实例的指针 |
