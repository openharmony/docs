...
| ACCESSIBILITY    | 4   | [AccessibilityExtensionAbility](../reference/apis-accessibility-kit/js-apis-inner-application-accessibilityExtensionContext.md)：无障碍服务扩展能力，支持访问与操作前台界面。 |
