...
| 名称 | 值 | 说明 |
|:----------------:|:---:|-----|
| FORM             | 0   | [FormExtensionAbility](../apis/js-apis-app-form-formExtensionAbility.md)：卡片扩展能力，提供卡片开发能力。 |
...
| BACKUP           |  9  | [BackupExtensionAbility](../apis/js-apis-application-backupExtensionAbility.md)：数据备份扩展能力，提供应用数据的备份恢复能力。 |
