...
| 名称 | 类型 | 只读 | 必填 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| permissions | Array&lt;string&gt; | 是 | 是 | 用户传入的权限。<br> **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| dialogShownResults? | Array&lt;bool&gt; | 是 | 否 | 此权限申请是否有弹窗：<br>- true：有弹窗。<br>- false：无弹窗。<br> **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
