...
开发者通过实现EmbeddableUIAbility，为其他应用提供跳出式启动和嵌入式启动原子化服务方式。例如，开发者使用EmbeddableUIAbility实现原子化服务。其他应用与该原子化服务未建立契约授权，将以跳出式运行该服务；其他应用与该服务建立契约授权，使用全屏启动原子化服务组件运行该服务，将以全屏嵌入式运行该服务。
