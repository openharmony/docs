...
| [AbilityRuntime_StartVisibility](_ability_runtime.md#abilityruntime_startvisibility) {<br/>    ABILITY_RUNTIME_START_HIDE = 0,<br/>    ABILITY_RUNTIME_START_SHOW = 1<br/>} | 定义启动时支持的窗口显示模式。     |
