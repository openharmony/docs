...
ElementName信息，通过接口[Context.getElementName](../apis/js-apis-inner-app-context.md)获取。
...
ElementName信息，标识Ability的基本信息，通过接口[Context.getElementName](../apis/js-apis-inner-app-context.md)获取。
