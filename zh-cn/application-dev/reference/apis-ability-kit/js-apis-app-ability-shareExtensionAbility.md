...
ShareExtensionAbility为开发者提供了具有分享操作能力的业务模板，继承自[UIExtensionAbility](js-apis-app-ability-uiExtensionAbility.md)。ShareExtension提供了一种便捷的方式，用于通过应用程序、社交媒体和其他服务共享当前上下文信息。各类Ability的继承关系详见[继承关系说明](./js-apis-app-ability-ability.md#ability的继承关系说明)。
