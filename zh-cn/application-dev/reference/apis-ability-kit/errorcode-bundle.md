...
## 17700077 安装预置版本应用成功，但目标版本应用安装失败
**错误信息**<br/>
Failed to install the HAP and restore to preinstalled bundle.

**错误描述**<br/>
安装一个已卸载的预置系统应用，先安装预置版本应用成功，然后再继续安装目标版本应用时，目标版本应用安装失败。

**可能原因**<br/>
预置版本应用已经安装成功，安装目标版本应用时出现字段不符合更新逻辑的错误，如版本号小于预置版本。

**处理步骤**<br/>
检查设备上存在具有相同包名称且签名信息一致的已安装应用程序时，目标版本应用是否能安装成功。
