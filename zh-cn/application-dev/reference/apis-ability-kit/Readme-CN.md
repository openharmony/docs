...
- ArkTS API
  - Stage模型能力的接口
    ...
    - [@ohos.app.ability.ChildProcess（自动填充框架）](js-apis-app-ability-childProcess.md)
    - [@ohos.app.ability.childProcessManager (子进程基类)](js-apis-app-ability-childProcessManager.md)
