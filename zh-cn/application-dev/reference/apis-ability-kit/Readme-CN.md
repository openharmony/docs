...
- ArkTS API
  - Stage模型能力的接口
    ...
    - [js-apis-app-ability-photoEditorExtensionAbility](./js-apis-app-ability-photoEditorExtensionAbility.md)
    - [js-apis-app-ability-photoEditorExtensionContext](./js-apis-app-ability-photoEditorExtensionContext.md)
