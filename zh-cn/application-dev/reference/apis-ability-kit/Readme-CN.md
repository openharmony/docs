...
- ArkTS API<!--ability-arkts-->
  - Stage模型能力的接口<!--stage-model-->
    ...
    - [@ohos.app.ability.ActionExtensionAbility (支持自定义服务能力的ExtensionAbility组件)](js-apis-app-ability-actionExtensionAbility.md)
    ...
    - [@ohos.app.ability.EmbeddedUIExtensionAbility (支持跨进程界面嵌入能力的ExtensionAbility组件)](js-apis-app-ability-embeddedUIExtensionAbility.md)
    ...
    - [@ohos.app.ability.ShareExtensionAbility (支持接入分享详情页能力的ExtensionAbility组件)](js-apis-app-ability-shareExtensionAbility.md)
