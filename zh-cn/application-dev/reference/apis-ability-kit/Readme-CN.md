...
- ArkTS API
  - Stage模型能力的接口
    ...
    - [js-apis-app-ability-photoEditorExtensionAbility（图片编辑扩展能力）](./js-apis-app-ability-photoEditorExtensionAbility.md)
    - [js-apis-app-ability-photoEditorExtensionContext（图片编辑扩展能力上下文）](./js-apis-app-ability-photoEditorExtensionContext.md)
