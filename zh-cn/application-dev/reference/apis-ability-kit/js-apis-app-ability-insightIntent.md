...
| flags<sup>16+</sup> | number | 否 | 是 | （API16及之后版本支持）意图调用时，意图执行方给意图调用方授权的uris的标志位[insightIntent.ExecuteResult.flags](js-apis-app-ability-insightIntent.md#ExecuteResult.flags<sup>16+</sup>)。 |
