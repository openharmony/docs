...
| accessTokenId             | number                                                       | 是   | 否   | 应用程序的accessTokenId，应用程序的身份标识，[程序访问控制](js-apis-abilityAccessCtrl.md#checkaccesstoken9)校验接口中使用。<br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 |
