...
| typedef void(\* [OH_Ability_OnNativeChildProcessExit](c-apis-ability-childprocess.md#oh_ability_onnativechildprocesseexit)) (int32_t pid, int32_t signal) | 定义感知子进程异常退出的回调函数。 |
