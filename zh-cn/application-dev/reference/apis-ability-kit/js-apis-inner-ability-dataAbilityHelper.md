...
可以通过[acquireDataAbilityHelper](../apis/js-apis-ability-featureAbility.md#featureabilityacquiredataabilityhelper7)接口获取DataAbilityHelper对象。

> **说明：**
> 
> 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。  
> 除了[PacMap](../apis/js-apis-inner-ability-dataAbilityHelper.md#pacmap)，本模块接口仅可在FA模型下使用。Stage模型下需使用[dataAbility模块](../apis/js-apis-data-ability.md)和[dataShare模块](../apis/js-apis-data-dataShare.md)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[FileAccessHelper.openFile](../apis/js-apis-fileAccess.md#openfile-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[FileAccessHelper.openFile](../apis/js-apis-fileAccess.md#openfile)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.on('dataChange')](../apis/js-apis-data-dataShare.md#ondatachange)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.off('dataChange')](../apis/js-apis-data-dataShare.md#offdatachange)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.normalizeUri](../apis/js-apis-data-dataShare.md#normalizeuri)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.normalizeUri](../apis/js-apis-data-dataShare.md#normalizeuri-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.denormalizeUri](../apis/js-apis-data-dataShare.md#denormalizeuri)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.denormalizeUri](../apis/js-apis-data-dataShare.md#denormalizeuri-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.notifyChange](../apis/js-apis-data-dataShare.md#notifychange)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.notifyChange](../apis/js-apis-data-dataShare.md#notifychange-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.insert](../apis/js-apis-data-dataShare.md#insert)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.insert](../apis/js-apis-data-dataShare.md#insert-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.batchInsert](../apis/js-apis-data-dataShare.md#batchinsert)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.batchInsert](../apis/js-apis-data-dataShare.md#batchinsert-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.delete](../apis/js-apis-data-dataShare.md#delete)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.delete](../apis/js-apis-data-dataShare.md#delete-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.update](../apis/js-apis-data-dataShare.md#update)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.update](../apis/js-apis-data-dataShare.md#update-1)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.query](../apis/js-apis-data-dataShare.md#query)。
...
**模型约束**：此接口仅可在FA模型下使用。Stage模型下需使用[DataShareHelper.query](../apis/js-apis-data-dataShare.md#query-1)。
...
| extras   | [PacMap](../apis/js-apis-inner-ability-dataAbilityHelper.md#pacmap)        | 是   | 表示扩展的键值对参数。       |
| callback | AsyncCallback\<[PacMap](../apis/js-apis-inner-ability-dataAbilityHelper.md#pacmap)> | 是 | 表示数据操作的回调方法，返回操作结果。     |
...
| 类型 | 说明 |
|------ | ------- |
|Promise\<[PacMap](../apis/js-apis-inner-ability-dataAbilityHelper.md#pacmap)> | 返回操作结果。 |
...
| ----------| ---------------------------------| ---- | ------------------------------------------------ |
| uri       | string                           | 是   | 表示待处理的DataAbility。例：'dataability:///com.example.xxx.xxxx'。|
| operations    |  Array\<[DataAbilityOperation](../apis/js-apis-inner-ability-dataAbilityOperation.md)>        | 是   | 表示数据操作数组，其中可以包含对数据库的多个不同操作。   |
| callback      |  AsyncCallback\<Array\<[DataAbilityResult](../apis/js-apis-inner-ability-dataAbilityResult.md)>>    | 是   | 表示批量操作的回调方法，在DataAbilityResult数组中返回每个操作的结果。      |
...
| 类型 | 说明 |
|------ | ------- |
|Promise\<Array\<[DataAbilityResult](../apis/js-apis-inner-ability-dataAbilityResult.md)>> | 在DataAbilityResult数组中返回每个操作的结果。 |
