...
| minWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最小的宽度，单位为px，可以通过[getWindowLimits](../apis-arkui/js-apis-window.md#getwindowlimits11)获得当前的窗口尺寸限制。<br>**约束：**<br/>仅在2in1和tablet设备上生效。 |
| minWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最小的高度，单位为px，可以通过[getWindowLimits](../apis-arkui/js-apis-window.md#getwindowlimits11)获得当前的窗口尺寸限制。<br/>**约束：**<br/>仅在2in1和tablet设备上生效。 |
| maxWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最大的宽度，单位为px，可以通过[getWindowLimits](../apis-arkui/js-apis-window.md#getwindowlimits11)获得当前的窗口尺寸限制。<br/>**约束：**<br/>仅在2in1和tablet设备上生效。 |
| maxWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最大的高度，单位为px，可以通过[getWindowLimits](../apis-arkui/js-apis-window.md#getwindowlimits11)获得当前的窗口尺寸限制。<br/>**约束：**<br/>仅在2in1和tablet设备上生效。 |
