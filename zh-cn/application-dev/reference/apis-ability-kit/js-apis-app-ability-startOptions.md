...
| withAnimation<sup>11+</sup> | boolean | 否 | 是 | Ability是否具有动画效果。true表示具有动画效果，false表示不具有动画效果。<br>**约束：**<br>1.该功能仅在2in1和tablet设备上生效。<br>2.调用方与目标方必须为同一应用。 |
...
| minWindowWidth<sup>18+</sup> | number | 否 | 是 | 窗口最小的宽度，单位为vp。<br>**约束：**<br/>仅在2in1设备上生效。 |
| minWindowHeight<sup>18+</sup> | number | 否 | 是 | 窗口最小的高度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。 |
| maxWindowWidth<sup>18+</sup> | number | 否 | 是 | 窗口最大的宽度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。 |
| maxWindowHeight<sup>18+</sup> | number | 否 | 是 | 窗口最大的高度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。 |
