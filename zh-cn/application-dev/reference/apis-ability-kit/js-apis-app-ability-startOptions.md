...
| minWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最小的宽度，单位为px。<br>**约束：**<br/>1.仅在2in1和tablet设备上生效。<br/>2.可以通过[getWindowLimits](js-apis-window.md#getwindowlimits11)获得当前的窗口尺寸限制。 |
