...
| minWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最小的宽度，单位为vp。<br>**约束：**<br/>仅在2in1设备上生效。最小值为320vp。 |
| minWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最小的高度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。最小值为72vp。 |
| maxWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最大的宽度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。最大值为1920vp。 |
| maxWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最大的高度，单位为vp。<br/>**约束：**<br/>仅在2in1设备上生效。最大值为1920vp。 |
