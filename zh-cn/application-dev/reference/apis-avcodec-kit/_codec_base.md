...
| [OH_MD_KEY_VIDEO_ENCODER_ROI_PARAMS](#oh_md_key_video_encoder_roi_params)    | 描述ROI编码参数，包括ROI位置和deltaQp，值类型为string。该键值是可选的且只用于视频编码。 |
...
| const char \* [OH_MD_KEY_VIDEO_ENCODER_ROI_PARAMS](#oh_md_key_video_encoder_roi_params)    | 描述ROI编码参数，包括ROI位置和deltaQp，值类型为string。 |
...
```
**描述**
指定ROI编码参数，包括ROI区域和deltaQp，随帧下发且实时生效。
