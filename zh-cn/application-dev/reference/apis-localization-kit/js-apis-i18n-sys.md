...
若设置系统语言后，需要[监听事件](../apis/commonEventManager-definitions.md#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON_EVENT_LOCALE_CHANGED，可以[订阅](../apis/js-apis-commonEventManager.md#commoneventmanagercreatesubscriber-1)该事件。
