...
| bool [OH_ResourceManager_ReleaseRawFileDescriptorData](#OH_ResourceManager_ReleaseRawFileDescriptorData) (const [RawFileDescriptor](_raw_file_descriptor.md) \*descriptor) | 待补充 |
