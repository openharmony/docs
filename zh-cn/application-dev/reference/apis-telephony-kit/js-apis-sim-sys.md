...
| -------- | --------------------------------------------------- | ---- | -------------------------------------- |
| slotId   | number                                              | 是   | 卡槽ID。<br/>- 0：卡槽1<br/>- 1：卡槽2 |
| callback | AsyncCallback\<[IccAccountInfo](js-api-sim.md#iccaccountinfo10)\> | 是   | 回调函数。返回指定卡槽SIM卡的帐户信息。                             |
...
| 类型                                         | 说明                                       |
| -------------------------------------------- | ------------------------------------------ |
| Promise\<[IccAccountInfo](js-api-sim.md#iccaccountinfo10)\> | 以Promise形式返回指定卡槽SIM卡的帐户信息。 |
...
| 参数名   | 类型                                                        | 必填 | 说明       |
| -------- | ----------------------------------------------------------- | ---- | ---------- |
| callback | AsyncCallback\<Array\<[IccAccountInfo](js-api-sim.md#iccaccountinfo10)\>\> | 是   | 回调函数。返回激活SIM卡帐户信息列表。 |
...
| 类型                                                 | 说明                                           |
| ---------------------------------------------------- | ---------------------------------------------- |
| Promise\<Array\<[IccAccountInfo](js-api-sim.md#iccaccountinfo10)\>\> | 以Promise形式返回激活卡槽SIM卡的帐户信息列表。 |
