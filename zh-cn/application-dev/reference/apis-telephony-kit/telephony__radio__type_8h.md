...
| [Telephony_RegState](ndk-apis-telephony-radio.md#telephony_regstate) {<br />TEL_REG_STATE_NO_SERVICE = 0,<br />TEL_REG_STATE_IN_SERVICE = 1,<br />TEL_REG_STATE_EMERGENCY_CALL_ONLY = 2,<br />TEL_REG_STATE_POWER_OFF = 3,<br />} | 设备的网络注册状态类型。 |
...
| [Telephony_NsaState](ndk-apis-telephony-radio.md#telephony_nsastate) {<br />TEL_NSA_STATE_NOT_SUPPORTED = 1,<br />TEL_NSA_STATE_NO_DETECTED= 2,<br />TEL_NSA_STATE_CONNECTED_DETECTED = 3,<br />TEL_NSA_STATE_IDLE_DETECTED = 4,<br />TEL_NSA_STATE_DUAL_CONNECTED = 5,<br />TEL_NSA_STATE_SA_ATTACHED = 6,<br />} | 设备的NSA网络注册状态类型。 |
