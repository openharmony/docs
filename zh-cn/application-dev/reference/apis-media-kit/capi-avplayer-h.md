...
| [OH_AVErrCode OH_AVPlayer_SetLoudnessGain(OH_AVPlayer *player, float loudnessGain)](#oh_avplayer_setloudnessgain) | - | 设置播放器的响度。<br>可以在已准备、正在播放、已暂停、已完成、已停止的状态中使用。取值范围为[-90.0, 24.0]，负值表示响度降低，正值表示响度提升。 |
