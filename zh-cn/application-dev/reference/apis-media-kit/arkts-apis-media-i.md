...
| mutedMediaType | [MediaType](arkts-apis-media-e.md#mediatype8) | 否   | 是   | 关闭输出的媒体类型。<br>API版本12-19，仅支持设置MediaType.MEDIA_TYPE_AUD。API版本20起，增加支持MediaType.MEDIA_TYPE_VID。 |
