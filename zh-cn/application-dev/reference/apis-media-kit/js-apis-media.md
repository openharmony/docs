...
|fileGenerationMode<sup>12+</sup> | [FileGenerationMode](#filegenerationmode12)  | 否   |  创建媒体文件模式的枚举，配合[on('photoAssetAvailable')](#onphotoassetavailable12)监听使用。枚举详情见[FileGenerationMode](#filegenerationmode12)。|
