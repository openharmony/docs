...
| maxDuration<sup>16+</sup>        | number             | 否   | 设置录制的最大时长。录制到达设定时长后，录制会自动停止，并通过stateChange回调录制状态，[AVRecorderState](#avrecorderstate9) = 'stopped'，[StateChangeReason](#statechangereason9) = BACKGROUND。|
