...
Audio/Video播放demo可参考：[音频播放开发指导](../../media/mediausing-avplayer-for-playback.md)、[视频播放开发指导](../../media/mediavideo-playback.md)。
...
[AVPlayer](#avplayer9)的状态机，可通过state属性主动获取当前状态，也可通过监听[stateChange](#onstatechange9)事件上报当前状态，状态机之间的切换规则，可参考[音频播放开发指导](../../media/mediausing-avplayer-for-playback.md)。
...
音视频录制demo可参考：[音频录制开发指导](../../media/mediausing-avrecorder-for-recording.md)、[视频录制开发指导](../../media/mediavideo-recording.md)。
...
获取音频或视频元数据的demo可参考：[获取音视频元数据开发指导](../../media/mediaavmetadataextractor.md)。
...
获取视频缩略图的demo可参考：[获取视频缩略图开发指导](../../media/mediaavimagegenerator.md)。
