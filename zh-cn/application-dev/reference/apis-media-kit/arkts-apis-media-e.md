...
| MD_KEY_ORIGINAL_WIDTH<sup>21+</sup>  | 'hdr_type'  | 表示视频原始宽度，其对应键值类型为number。<br>**原子化服务API：** 从API version 21开始，该接口支持在原子化服务中使用。|
| MD_KEY_ORIGINAL_HEIGHT<sup>21+</sup>  | 'hdr_type'  | 表示视频原始高度，其对应键值类型为number。<br>**原子化服务API：** 从API version 21开始，该接口支持在原子化服务中使用。|
