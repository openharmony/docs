...
| 名称 | 描述 |
| -- | -- |
| int32_t audioSampleRate | 音频采样率，支持列表请查阅Audio Kit的[AudioSamplingRate](../apis-audio-kit/arkts-apis-audio-e.md#audiosamplingrate8)。单位：Hz。当audioSampleRate与audioChannels同时为0时，将忽略该类型音频相关参数。 |
