...
| [OH_AVRecorder_ContainerFormatType](#oh_avrecorder_containerformattype-1) {<br/>AVRECORDER_CFT_MPEG_4 = 2,<br/>AVRECORDER_CFT_MPEG_4A = 6,<br/>AVRECORDER_CFT_AMR = 8,<br/>AVRECORDER_CFT_MP3 = 9,<br/>AVRECORDER_CFT_WAV = 10,<br/>AVRECORDER_CFT_AAC = 11<br/>} | 枚举容器格式类型（容器格式类型的缩写是 CFT）。 | 
