...
| [OH_AudioDevice_Role](#oh_audiodevice_role) | OH_AudioDevice_Role | 定义音频设备设备角色。 |
| [OH_AudioDevice_Type](#oh_audiodevice_type) | OH_AudioDevice_Type | 定义音频设备设备类型。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| [OH_AudioDevice_Role](#oh_audiodevice_role) *deviceRole | deviceRole 将设置设备角色值的变量，指向OH_AudioDevice_DeviceRole。         |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_AudioCommon_Result](capi-native-audio-common-h.md#oh_audiocommon_result) | [AUDIOCOMMON_RESULT_SUCCESS](capi-native-audio-common-h.md#oh_audiocommon_result) 或 [AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM](capi-native-audio-common-h.md#oh_audiocommon_result)。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者 OH_AudioRouterManager_OnDeviceChangedCallback。 |
| [OH_AudioDevice_Type](#oh_audiodevice_type) *deviceType | deviceType 将设置设备类型值的变量，指向[OH_AudioDevice_Type](capi-native-audio-device-base-h.md#oh_audiodevice_type)。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| uint32_t *id | id 设备id指针，将设置设备角色值的变量。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_AudioCommon_Result](capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIODEVICE_SUCCESS 或 [AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM](capi-native-audio-common-h.md#oh_audiocommon_result)。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| char **name | name 设备名称指针，将设置设备名称值的变量。不要单独释放音频设备名称指针，而是调用[OH_AudioRoutingManager_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)，以便在不再使用时释放所有DeviceDescriptor数组。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| char **address | address 设备MAC地址指针，将设置设备MAC地址值的变量。不要单独释放音频设备MAC地址指针，而是调用[OH_AudioRoutingManager_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)，以便在不再使用时释放所有DeviceDescriptor数组。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| uint32_t **sampleRates | sampleRates 设置采样率数组值的数组指针变量。不要单独释放音频设备采样率指针，而是调用[OH_AudioRoutingManager_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)，以便在不再使用时释放所有DeviceDescriptor数组。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| uint32_t **channelCounts | channelCounts 数组指针变量，该变量将设置通道计数数组值。不要单独释放音频设备通道数指针，而是调用[OH_AudioRoutingManager_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)，以便在不再使用时释放所有DeviceDescriptor数组。 |
| uint32_t *size | size 设置通道计数大小值的指针变量。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | audioDeviceDescriptor 音频设备描述符获取通过 [OH_AudioRoutingManager_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices) 或者OH_AudioRouterManager_OnDeviceChangedCallback。 |
| char **displayName | displayName 设置显示名称值的指针变量。不要单独释放音频设备显示名称指针，而是调用[OH_AudioRoutingManager_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)，以便在不再使用时释放所有DeviceDescriptor数组。 |
