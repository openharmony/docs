...
| 名称 | 描述 |
| -------- | -------- |
| [asset_type.h](asset__type_8h.md) | 定义关键资产存储开发套件中通用的枚举值、数据结构和错误码。 |
