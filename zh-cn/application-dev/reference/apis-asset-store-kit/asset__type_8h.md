...
| [Asset_WrapType](_asset_type.md#asset_wraptype)<sup>18+</sup> {<br/>ASSET_WRAP_TYPE_NEVER = 0,<br/>ASSET_WRAP_TYPE_TRUSTED_ACCOUNT = 1<br/>} | 关键资产支持的加密导入导出类型。 |
