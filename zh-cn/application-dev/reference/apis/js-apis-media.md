...
| audioEffectMode<sup>10+</sup>                       | [audio.AudioEffectMode](js-apis-audio.md#audioeffectmode10)  | 是   | 是   | 设置音频音效模式，audioRendererInfo的contentType和streamUsage变动时会恢复为默认值，默认值参考[audio.AudioEffectMode](js-apis-audio.md#audioeffectmode10)，动态属性。只允许在**prepared**/**playing**/**paused**/**completed**状态下设置。 |
