...
| audioRendererInfo<sup>10+</sup>                     | [audio.AudioRendererInfo](js-apis-audio.md#audiorendererinfo8) | 是   | 是   | 设置音频渲染信息，默认值content为CONTENT_TYPE_MUSIC，usage为STREAM_USAGE_MEDIA，rendererFlags为非必填入参，默认值为0，0代表普通音频渲染器，1代表低时延音频渲染器。JS接口暂不支持低时延音频渲染器。<br/>只允许在**initialized**状态下设置 |
