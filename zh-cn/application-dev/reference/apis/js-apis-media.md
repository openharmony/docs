...
| audioEffectMode<sup>10+</sup>                       | [audio.AudioEffectMode](js-apis-audio.md#audioeffectmode)    | 是   | 是   | 设置音频音效模式，audioRendererInfo变动时会恢复为默认值，默认值参考[audio.AudioEffectMode](js-apis-audio.md#audioeffectmode)，动态属性。只允许在**prepared**/**playing**/**paused**/**completed**状态下读取或者设置。 |
