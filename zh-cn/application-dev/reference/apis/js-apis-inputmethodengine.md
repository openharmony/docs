...
| CURSOR_UP | number | 是 | 否 | 光标上移 |
| CURSOR_DOWN | number | 是 | 否 | 光标下移 |
| CURSOR_LEFT | number | 是 | 否 | 光标左移 |
| CURSOR_RIGHT | number | 是 | 否 | 光标右移 |
| WINDOW_TYPE_INPUT_METHOD_FLOAT | number | 是 | 否 | 输入法应用窗口风格标识 |
