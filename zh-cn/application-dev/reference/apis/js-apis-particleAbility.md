...
向系统申请长时任务，使用callback形式返回结果。（此接口为api7接口，[建议使用新接口](js-apis-backgroundTaskManager.md#backgroundtaskmanagerstartbackgroundrunning8)）
...
向系统申请长时任务，使用promise形式返回结果。（此接口为api7接口，[建议使用新接口](js-apis-backgroundTaskManager.md#backgroundtaskmanagerstartbackgroundrunning8-1)）
...
向系统申请取消长时任务，使用callback形式返回结果。（此接口为api7接口，[建议使用新接口](js-apis-backgroundTaskManager.md#backgroundtaskmanagerstopbackgroundrunning8)）
...
向系统申请取消长时任务，使用promise形式返回结果。（此接口为api7接口，[建议使用新接口](js-apis-backgroundTaskManager.md#backgroundtaskmanagerstopbackgroundrunning8-1)）
