...
| navigationId        | string                                                                | 否   | 当前page导航ID。如果当前页面是通过[NavRouter](../arkui-ts/ts-basic-components-navrouter.md)跳转而来，取其参数[RouteInfo](../arkui-ts/ts-basic-components-navrouter.md/#%E5%B1%9E%E6%80%A7)的name值；否则取空值。 |
