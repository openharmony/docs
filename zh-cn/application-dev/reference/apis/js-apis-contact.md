...
| 参数名   | 类型                        | 必填 | 说明                                                         |
| -------- | --------------------------- | ---- | ------------------------------------------------------------ |
| context  | Context                     | 是   | 应用上下文Context，Stage模型的应用Context定义见[Context](https://gitee.com/openharmony/docs/blob/monthly_20230815/zh-cn/application-dev/reference/apis/js-apis-inner-application-context.md)。 |
