...
在调用PasteData的接口前，需要先通过[createPlainTextData()](#createplaintextdata())、[createHtmlData()](#createhtmldata())、[createUriData()](#createuridata())、[createWantData()](#createwantdata())或[getPasteData()](#getpastedata())获取一个PasteData对象。
