...
- 设备管理
  ...
  - [@ohos.multimodalInput.keyCode (键值)](js-apis-inputkeycode.md)
  - [@ohos.multimodalInput.keyEvent (按键输入事件)](js-apis-inputkeyevent.md)
  - [@ohos.multimodalInput.mouseEvent (鼠标输入事件)](js-apis-inputmouseevent.md)
  - [@ohos.multimodalInput.ToucEvent (触摸输入事件)](js-apis-inputtouchevent.md)
