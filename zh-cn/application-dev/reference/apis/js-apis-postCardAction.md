...
| bundleName | string | action为router&nbsp;/&nbsp;call&nbsp;类型时跳转的包名，可选。 |
| moduleName | string | action为router&nbsp;/&nbsp;call"&nbsp;类型时跳转的模块名，可选。 |
| abilityName | string | action为router&nbsp;/&nbsp;call&nbsp;类型时跳转的UIAbility名，必填。 |
