...
| callback | Callback<[ImsCallModeInfo](#imscallmode8)> | 是   | 回调函数。                 |
...
| callback | Callback<[CallSessionEvent](#callsessionevent11)> | 是   | 回调函数。                 |
...
| callback | Callback<[PeerDimensionsDetail](#peerdimensionsdetail11)> | 是   | 回调函数。                 |
...
| callback | Callback<[CameraCapabilities](#cameracapabilities11)> | 是   | 回调函数。                 |
...
| TYPE_DOWNGRADE_RTP_OR_RTCP_TIMEOUT         | 100    | RTP或RTCP超时 |
| TYPE_DOWNGRADE_RTP_AND_RTCP_TIMEOUT        | 101    | RTP和RTCP超时 |
...
| DEVICE_DIRECTIO_90   | 90     | 视频画面90度方向 |
| DEVICE_DIRECTIO_180  | 180    | 视频画面180度方向 |
| DEVICE_DIRECTIO_270  | 270    | 视频画面270度方向 |
...
| ------- | ------------ | ---- | ------------- |
| callId  | number       | 是   | 呼叫Id         |
| width   | number       | 是   | 对端画面分辨率  |
| height  | number       | 是   | 对端画面分辨率  |
...
| ------- | ------------ | ---- | ------------- |
| callId  | number       | 是   | 呼叫Id         |
| width   | number       | 是   | 本端画面分辨率  |
| height  | number       | 是   | 本端画面分辨率  |
