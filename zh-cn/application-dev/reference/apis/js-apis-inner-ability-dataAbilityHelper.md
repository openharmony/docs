...
> 本模块接口仅可在FA模型下使用，推荐使用Stage模型下的[dataAbility模块](js-apis-data-ability.md)和[dataShare模块](js-apis-data-dataShare.md)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[FileAccessHelper.openFile](js-apis-fileAccess.md#openfile-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[FileAccessHelper.openFile](js-apis-fileAccess.md#openfile)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.on('dataChange')](js-apis-data-dataShare.md#ondatachange)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.off('dataChange')](js-apis-data-dataShare.md#offdatachange)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.normalizeUri](js-apis-data-dataShare.md#normalizeuri)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.normalizeUri](js-apis-data-dataShare.md#normalizeuri-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.denormalizeUri](js-apis-data-dataShare.md#denormalizeuri)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.denormalizeUri](js-apis-data-dataShare.md#denormalizeuri-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.notifyChange](js-apis-data-dataShare.md#notifychange)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.notifyChange](js-apis-data-dataShare.md#notifychange-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.insert](js-apis-data-dataShare.md#insert)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.insert](js-apis-data-dataShare.md#insert-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.batchInsert](js-apis-data-dataShare.md#batchinsert)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.batchInsert](js-apis-data-dataShare.md#batchinsert-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.delete](js-apis-data-dataShare.md#delete)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.delete](js-apis-data-dataShare.md#delete-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.update](js-apis-data-dataShare.md#update)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.update](js-apis-data-dataShare.md#update-1)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.query](js-apis-data-dataShare.md#query)。
...
**说明**：本接口仅可在FA模型下使用，推荐使用Stage模型下的接口[DataShareHelper.query](js-apis-data-dataShare.md#query-1)。
