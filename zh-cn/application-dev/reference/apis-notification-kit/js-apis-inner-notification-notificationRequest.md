...
| isStopwatch                   | boolean                                                  |   否  | 是  | 是否显示已用时间。                                                             |
| isCountDown                   | boolean                                                  |   否  | 是  | 是否显示倒计时时间。                                                            |
| isFloatingIcon                | boolean                                                  |   否  | 是  | 是否显示状态栏图标。                                                            |
| label                         | string                                                   |   否  | 是  | 通知标签。                                                                 |
| badgeIconStyle                | number                                                   |   否  | 是  | 通知角标类型。预留能力，暂未支持。                                                     |
| showDeliveryTime              | boolean                                                  |   否  | 是  | 是否显示分发时间。                                                             |
| actionButtons                 | Array\<[NotificationActionButton](js-apis-inner-notification-notificationActionButton.md)\>             |   否  | 是  | 通知按钮，最多三个按钮。                                                          |
