...
添加应用至应用程序包安装禁用名单，添加至禁用名单的应用不允许在当前/指定用户下安装。
...
在应用程序包安装禁用名单中移除应用，在禁用名单存在的情况下，在应用程序包安装禁用名单中的应用不允许在当前/指定用户下安装。
...
| 类型                | 说明                           |
| ------------------- | ------------------------------ |
| Array&lt;string&gt; | 返回当前用户下的应用程序包安装禁用名单。 |
...
添加应用至包卸载禁用名单，添加至禁用名单的应用不允许在当前/指定用户下卸载。
...
在包卸载禁用名单中移除应用。在禁用名单存在的情况下，在包卸载禁用名单中的应用不允许在当前/指定用户下卸载。
