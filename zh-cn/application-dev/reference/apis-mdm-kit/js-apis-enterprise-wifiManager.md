...
| bssid         | string                           | 否   | 是 | Wi-Fi热点的mac地址，例如：00:11:22:33:44:55。<br/>作为addDisallowedWifiList和removeDisallowedWifiList接口的入参时，该属性可选，默认值为空字符串。<br/>作为addAllowedWifiList和removeAllowedWifiList接口入参时，从API version 21开始，该属性可选，默认值为空字符串。API version 20及之前的版本，该属性必填。            |
