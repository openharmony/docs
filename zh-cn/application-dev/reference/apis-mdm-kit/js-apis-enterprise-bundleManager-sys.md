...
添加应用至应用程序包安装禁用名单，添加至禁用名单的应用不允许在当前用户下安装，使用callback异步回调。
...
添加应用至应用程序包安装禁用名单，添加至禁用名单的应用不允许在指定用户（通过userId指定）下安装。使用callback异步回调。
...
添加应用至应用程序包安装禁用名单，添加至禁用名单的应用不允许在当前/指定用户下安装。使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当添加应用程序包安装禁用名单失败时，会抛出错误对象。  |
...
移除在应用程序包安装禁用名单中的应用，在禁用名单存在的情况下，在禁用名单中的应用不允许在当前用户下安装。使用callback异步回调。
...
移除在应用程序包安装禁用名单中的应用，在禁用名单存在的情况下，在禁用名单中的应用不允许在指定用户（通过userId指定）下安装，使用callback异步回调。
...
移除在应用程序包安装禁用名单中的应用，在禁用名单存在的情况下，在禁用名单中的应用不允许在当前/指定用户下安装。使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当移除应用程序包安装禁用名单失败时，会抛出错误对象。  |
...
获取当前用户下的应用程序包安装禁用名单，使用callback异步回调。
...
获取指定用户（通过userId指定）下的应用程序包安装禁用名单，使用callback异步回调。
...
获取当前/指定用户下的应用程序包安装禁用名单，使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise对象，返回当前/指定用户下的应用程序包安装禁用名单。 |
...
添加应用至应用程序包卸载禁用名单，添加至禁用名单的应用不允许在当前用户下卸载，使用callback异步回调。
...
添加应用至应用程序包卸载禁用名单，添加至禁用名单的应用不允许在指定用户（通过userId指定）下卸载。使用callback异步回调。
...
添加应用至应用程序包卸载禁用名单，添加至禁用名单的应用不允许在当前/指定用户下卸载。使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当添加应用程序包卸载禁用名单失败时，会抛出错误对象。  |
...
移除在应用程序包卸载禁用名单中的应用，在禁用名单存在的情况下，在禁用名单中的应用不允许在当前用户下卸载，使用callback异步回调。
...
移除在应用程序包卸载禁用名单中的应用，在禁用名单存在的情况下，在禁用名单中的应用不允许在指定用户（通过userId指定）下卸载。使用callback异步回调。
...
移除在应用程序包卸载禁用名单中的应用。在禁用名单存在的情况下，在禁用名单中的应用不允许在当前/指定用户下卸载。使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当移除应用程序包卸载禁用名单失败时会抛出错误对象。  |
...
获取当前用户下的应用程序包卸载禁用名单，使用callback异步回调。
...
获取指定用户（通过userId指定）下的应用程序包卸载禁用名单，使用callback异步回调。
...
获取当前/指定用户下应用程序包卸载禁用名单接口，使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise对象，返回当前/指定用户下的应用程序包卸载禁用名单。 |
