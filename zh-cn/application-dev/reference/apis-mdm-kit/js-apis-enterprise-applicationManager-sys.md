...
本模块提供应用管理能力，包括添加应用运行禁用名单、获取应用运行禁用名单、移除应用运行禁用名单等。
...
添加应用至应用运行禁用名单，添加至禁用名单的应用不允许在当前用户下运行，不在禁用名单中的应用允许运行。使用callback异步回调。
...
添加应用至应用运行禁用名单，添加至禁用名单的应用不允许在指定用户（通过userId指定）下运行，不在禁用名单中的应用允许运行。使用callback异步回调。
...
添加应用至应用运行禁用名单，添加至禁用名单的应用不允许在当前/指定用户下运行。使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当添加应用运行禁用名单失败时，会抛出错误对象。  |
...
移除在应用运行禁用名单中的应用，在禁用名单存在的情况下，在应用运行禁用名单中的应用不允许在当前用户下运行。使用callback异步回调。
...
移除在应用运行禁用名单中的应用，在禁用名单存在的情况下，在应用运行禁用名单中的应用不允许在指定用户（通过userId指定）下运行。使用callback异步回调。
...
移除当前/指定用户在应用运行禁用名单中的应用，使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;void&gt; | 无返回结果的Promise对象。当移除应用运行禁用名单失败时，会抛出错误对象。  |
...
获取当前用户下的应用运行禁用名单。使用callback异步回调。
...
获取指定用户（通过userId指定）下的应用运行禁用名单。使用callback异步回调。
...
获取当前/指定用户下的应用运行禁用名单，使用promise异步回调。
...
| 类型                   | 说明                      |
| --------------------- | ------------------------- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise对象，返回当前/指定用户下的应用运行禁用名单。 |
