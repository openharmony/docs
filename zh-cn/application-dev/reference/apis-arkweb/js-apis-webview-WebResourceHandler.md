...
| 参数名          | 类型    |  必填  | 说明                                            |
| ---------------| ------- | ---- | ------------- |
| response      | [WebSchemeHandlerResponse](./js-apis-webview-WebSchemeHandlerResponse.md#class-webschemehandlerresponse)  | 是   | 该拦截请求的响应。 |
...
示例请参考[OnRequestStart](./js-apis-webview-WebSchemeHandler.md#onrequeststart12)。
