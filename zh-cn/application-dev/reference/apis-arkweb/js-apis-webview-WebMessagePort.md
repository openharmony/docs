...
| 参数名  | 类型   | 必填 | 说明           |
| ------- | ------ | ---- | :------------- |
| message | [WebMessage](./js-apis-webview-t.md#webmessage) | 是   | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessage](./js-apis-webview-t.md#webmessage)类型消息。完整示例代码参考[postMessage](./js-apis-webview-WebviewController.md#postmessage)。
...
| 参数名   | 类型     | 必填 | 说明                 |
| -------- | -------- | ---- | :------------------- |
| callback | (result: [WebMessage](./js-apis-webview-t.md#webmessage)) => void | 是   | 接收到的消息。 |
...
发送[WebMessageType](./js-apis-webview-e.md#webmessagetype10)类型消息给HTML5侧，必须先调用[onMessageEventExt](#onmessageeventext10)，否则会发送失败。完整示例代码参考[onMessageEventExt](#onmessageeventext10)。
...
| 参数名  | 类型   | 必填 | 说明           |
| ------- | ------ | ---- | :------------- |
| message | [WebMessageExt](./js-apis-webview-WebMessageExt.md#class-webmessageext) | 是   | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessageType](./js-apis-webview-e.md#webmessagetype10)类型消息。
...
| 参数名   | 类型     | 必填 | 说明                 |
| -------- | -------- | ---- | :------------------- |
| callback | (result: [WebMessageExt](./js-apis-webview-WebMessageExt.md#class-webmessageext)) => void | 是   | 接收到的消息。 |
...
不需要发送消息时关闭该消息端口。在使用close前，请先使用[createWebMessagePorts](./js-apis-webview-WebviewController.md#createwebmessageports)创建消息端口。
