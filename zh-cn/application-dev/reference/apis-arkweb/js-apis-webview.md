...
发送消息，必须先调用[onMessageEvent](#onmessageevent)。完整示例代码参考[postMessage](#postmessage)。
...
发送消息，必须先调用[onMessageEventExt](#onmessageeventext10)。完整示例代码参考[onMessageEventExt](#onmessageeventext10)。
