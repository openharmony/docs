...
设置有声视频的自动播放是否需要用户手动点击，静音视频的自动播放不受该接口管控，默认是需要。
...
| 参数名    | 类型    | 必填   | 说明                |
| ------ | ------- | ---- | ------------------- |
| access | boolean | 是    | 设置有声视频的自动播放是否需要用户手动点击。<br>true表示设置有声视频的自动播放需要用户手动点击，false表示设置有声视频的自动播放不需要用户手动点击。<br>默认值：true。 |
