...
| 名称 | 描述 | 
| -------- | -------- |
| [ArkWeb_ErrorCode](#arkweb_errorcode) {<br/>ARKWEB_SUCCESS = 0, ARKWEB_INIT_ERROR = 17100001, ARKWEB_ERROR_UNKNOWN = 17100100, ARKWEB_INVALID_PARAM = 17100101,<br/>ARKWEB_SCHEME_REGISTER_FAILED = 17100102<br/>} | 定义ArkWeb NDK接口异常错误码。  | 
| [ArkWeb_NativeAPIVariantKind](#arkweb_nativeapivariantkind) { ARKWEB_NATIVE_COMPONENT, ARKWEB_NATIVE_CONTROLLER, ARKWEB_NATIVE_WEB_MESSAGE_PORT, ARKWEB_NATIVE_WEB_MESSAGE } | 定义Native API的类型枚举。  | 
...
```
typedef enum ArkWeb_ResourceTypeArkWeb_ResourceType
```
**描述：**
...
```
typedef enum ArkWeb_WebMessageTypeArkWeb_WebMessageType
```
**描述：**
