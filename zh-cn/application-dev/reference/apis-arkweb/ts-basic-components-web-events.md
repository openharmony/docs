...
| 参数名  | 类型   | 必填   | 说明      |
| ---- | ------ | ---- | --------- |
| callback  | Callback\<[OnLoadStartedEvent](./ts-basic-components-web-i.md#onloadstartedevent20)\> | 是    | 网页加载开始时触发。 |
...
| 参数名  | 类型   | 必填   | 说明      |
| ---- | ------ | ---- | --------- |
| callback  | Callback\<[OnLoadFinishedEvent](./ts-basic-components-web-i.md#onloadfinishedevent20)\> | 是    | 网页加载结束时触发。 |
