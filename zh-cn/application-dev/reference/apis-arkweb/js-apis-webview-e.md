...
[getLastHitTest](./js-apis-webview-WebviewController.md#getlasthittest18)接口用于指示游标节点。
...
[runJavaScriptExt](./js-apis-webview-WebviewController.md#runjavascriptext10)接口脚本执行后返回的结果的类型。
...
[OfflineResourceMap](./js-apis-webview-WebviewController.md#offlineresourcemap12)对象对应的本地离线资源的接口类型。
...
Scroll滚动类型，用于[setScrollable](./js-apis-webview-WebviewController.md#setscrollable12)。
...
[handleStatusChanged](./js-apis-webview.md#handlestatuschanged12) 接口参数， 用于表示播放器的播放状态。
