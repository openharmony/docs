...
完整示例代码参考[onRequestStart](./js-apis-webview-WebSchemeHandler.md#onrequeststart12)。
...
| 类型     | 说明            |
| ------ | ------------- |
| [WebHttpBodyStream](./js-apis-webview-WebSchemeHandler.md#class-webschemehandler) \| null | 返回资源请求中的WebHttpBodyStream，如果没有则返回null。 |
