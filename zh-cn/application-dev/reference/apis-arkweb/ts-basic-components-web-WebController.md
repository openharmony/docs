...
| 类型        | 说明                                       |
| --------- | ---------------------------------------- |
| WebCookie | Web组件cookie管理对象，参考[WebCookie](./ts-basic-components-web-WebCookie.md#class-webcookie)定义。 |
...
| headers  | Array\<[Header](./ts-basic-components-web-i.md#header)\> | 否    | URL的附加HTTP请求头。<br>默认值：[]。 |
