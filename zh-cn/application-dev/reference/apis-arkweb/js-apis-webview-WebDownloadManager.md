...
| 参数名          | 类型    |  必填  | 说明                                            |
| ---------------| ------- | ---- | ------------- |
| delegate      | [WebDownloadDelegate](./js-apis-webview-WebDownloadDelegate.md#class-webdownloaddelegate)  | 是   | 用来接收下载进回调的委托。 |
...
| 参数名          | 类型    |  必填  | 说明                                            |
| ---------------| ------- | ---- | ------------- |
| webDownloadItem      | [WebDownloadItem](./js-apis-webview-WebDownloadItem.md#class-webdownloaditem)  | 是   | 待恢复的下载任务。 |
