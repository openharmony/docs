...
| 参数名      | 类型                  | 必填 | 说明                                  |
| -------- | -------------------- | ---- | ------------------------------------- |
| type     | string               | 是   | 事件类型，MediaKeySystem实例[createMediaKeySystem](arkts-apis-drm-f.md#drmcreatemediakeysystem)创建成功后可监听，需要设备证书时触发该事件。 |
...
| 参数名      | 类型                  | 必填 | 说明                                  |
| -------- | -------------------- | ---- | ------------------------------------- |
| type     | string               | 是   | 监听事件类型，MediaKeySystem实例[createMediaKeySystem](arkts-apis-drm-f.md#drmcreatemediakeysystem)创建成功后可监听。 |
