...
The USBDevicePipe validity check failed. Possible causes: <br>1. The validity of the input parameters is checked failed. <br>2. The input parameters are obtained through a rational call chain, first using connectDevice to acquire the USBDevicePipe.
