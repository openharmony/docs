...
<!--Del-->
与这个公共事件相关的接口：power，具体参看[接口文档](../../apis-backgroundtasks-kit/Readme-CN.md)。<!--DelEnd-->
...
<!--Del-->
与这个公共事件相关的接口：deviceStandby，具体参看[接口文档](../../apis-backgroundtasks-kit/Readme-CN.md)。<!--DelEnd-->