...
与这个公共事件相关的接口：setSlotByBundle、setNotificationEnableSlot、setNotificationEnable，这些为系统API，一般都是通知设置应用调用，具体参看[通知接口文档](../../apis-notification-kit/js-apis-notificationManager.md)。
