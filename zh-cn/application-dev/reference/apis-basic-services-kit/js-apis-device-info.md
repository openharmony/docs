...
| performanceClass<sup>18+</sup> | [PerformanceClassLevel](#performanceclasslevel) | 是 | 否 | 描述整机设备能力等级，从API version 18开始支持，取值范围为0-2,0代表设备能力定级为高；1代表设备能力定级为中；2代表设备能力定级为低。<br/>示例：0 |
