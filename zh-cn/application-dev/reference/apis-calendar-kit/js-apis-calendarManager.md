...
| 名称           | 类型                              | 只读 | 可选 | 说明                                                                                                                                                                                                      |
| -------------- | --------------------------------- | ---- |----|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| id             | number                            | 否   | 是  | 日程id。当调用[addEvent()](#addevent)、[addEvents()](#addevents)创建日程时，不填写此参数；当调用[deleteEvent()](#deleteevent)、[deleteEvents()](#deleteevents)删除日程时，id > 0。  <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 |
| type           | [EventType](#eventtype)           | 否   | 否  | 日程类型。   <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。                                                                                                                                            |
| title          | string                            | 否   | 是  | 日程标题。限制5000字符，不填时，默认为空字符串。   <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。                                                                                                                         |
...
| 名称      | 类型   | 只读 | 可选 | 说明                     |
| --------- | ------ | ---- |----| ------------------------ |
| location  | string | 否   | 是  | 地点位置。限制5000字符，不填时，默认为空字符串。 |
| longitude | number | 否   | 是  | 地点经度。取值范围-180至180，默认为0。    |
| latitude  | number | 否   | 是  | 地点纬度。取值范围-180至180，默认为0。    |
...
| 参数名 | 类型   | 必填 | 说明       |
| ------ | ------ | ---- | ---------- |
| start  | number | 是   | 开始时间。需要13位时间戳。 |
| end    | number | 是   | 结束时间。需要13位时间戳。 |
...
| expire              | number                                      | 否   | 是  | 重复周期截止日。需要13位时间戳，不填时，默认为0。   <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。                                                                                                                                                                                                                                               |
...
| 名称  | 类型   | 只读 | 可选 | 说明                                                                 |
| ----- | ------ | ---- |----|--------------------------------------------------------------------|
| name  | string | 否   | 否  | 会议日程参与者的姓名。限制5000字符。  <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。  |
| email | string | 否   | 否  | 会议日程参与者的邮箱。限制5000字符。   <br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 |
...
| uri         | string                      | 否   | 否  | 服务的uri，格式为Deeplink类型。可以跳转到三方应用相应界面。限制5000字符。 |
| description | string                      | 否   | 是  | 服务辅助描述。限制5000字符，不填时，默认为空字符串。                 |
