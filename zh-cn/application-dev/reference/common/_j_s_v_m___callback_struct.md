...
| 名称 | 描述 | 
| -------- | -------- |
| [JSVM_Value](_j_s_v_m.md#jsvm_value) (JSVM_CDECL\* callback)([JSVM_Env](_j_s_v_m.md#jsvm_env) env, [JSVM_CallbackInfo](_j_s_v_m.md#jsvm_callbackinfo) info); | 用户提供的native函数的回调函数指针。 | 
