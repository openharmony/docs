...
| pickerStyle<sup>12+</sup> | [AVCastPickerStyle](js-apis-avCastPickerParam.md#avcastpickerstyle12) | 否 | @Prop | 投播样式。<br>- 当时sessionType是audio或者vedio时，默认值为STYLE_PANEL；<br>- 当sessionType是voice_call或者vedio_call时，默认值为STYLE_MENU，且不可修改为STYLE_PANEL。|
