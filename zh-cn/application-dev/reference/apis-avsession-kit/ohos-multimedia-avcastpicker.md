...
| activeColor<sup>11+</sup> | Color \| number \| string | 否 | @Prop | 设备连接成功状态下投播组件的颜色。<br>未设置时，系统将优先根据normalColor的颜色匹配；如果normalColor也未设置，将采用colorMode下的颜色设置。 |
...
| onStateChange<sup>11+</sup> | (state: [AVCastPickerState](js-apis-avCastPickerParam.md#avcastpickerstate)) => void | 否 | - | 投播状态更改回调。 |
## 事件
