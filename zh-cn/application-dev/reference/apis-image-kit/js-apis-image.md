...
读取区域内的图像像素数据，并按照BGRA_8888格式写入缓冲区中。使用callback形式返回。
...
读取PixelMap的图像像素数据，并按照BGRA_8888格式写入指定区域内。使用Promise形式返回。
...
读取PixelMap的图像像素数据，并按照BGRA_8888格式写入指定区域内。使用callback形式返回。
...
以同步方式读取PixelMap的图像像素数据，并按照BGRA_8888格式写入指定区域内。
