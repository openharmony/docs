...
通过给定的资源描述符[RawFileDescriptor](../apis-localization-kit/_raw_file_descriptor.md#rawfiledescriptor)和[OhosImageSourceOps](capi-image-ohosimagesourceops.md)结构体，获取JavaScript native层API ImageSource对象。
