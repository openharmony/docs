...
通过给定的资源描述符[RawFileDescriptor](../apis-localization-kit/_raw_file_descriptor.md#rawfiledescriptor)和[OhosImageSourceOps](capi-ohosimagesourceops.md)结构体，获取JavaScript native层API ImageSource对象。
...
| -- | -- |
| napi_env env | 表明JNI环境的指针。 |
| [RawFileDescriptor](../apis-localization-kit/_raw_file_descriptor.md#rawfiledescriptor) rawFile | 表明图像源资源描述符。 |
| struct [OhosImageSourceOps](capi-ohosimagesourceops.md)* ops | 表明创建一个图像源的选项。 |
| napi_value *res | 表明JavaScript native层API ImageSource对象的指针。 |
