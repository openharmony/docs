...
| end | number | 否 | 源终止位置下标，如果`end < 0`，则会从`end + Uint8ClampedArray.length`位置终止。默认为ArkTS Uint8ClampedArray的长度。|
...
返回一个新的、基于相同ArkTS ArrayBuffer的ArkTS Uint8ClampedArray对象。
