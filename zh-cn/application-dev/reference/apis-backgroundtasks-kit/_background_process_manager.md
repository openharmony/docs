...
返回 ERR_BACKGROUND_PROCESS_MANAGER_SUCCESS，表示压制参数发送成功。
...
返回 ERR_BACKGROUND_PROCESS_MANAGER_SUCCESS，表示压制参数发送成功。 返回 ERR_BACKGROUND_PROCESS_MANAGER_INVALID_PARAM，表示参数检查失败。
