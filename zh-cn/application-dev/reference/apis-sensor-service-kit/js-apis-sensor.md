...
以下错误码的详细介绍请参见 [ohos.sensor(传感器)错误码](https://gitee.com/openharmony/docs/blob/ec262ecc34b2c14270ca17badaeca57eaf9781f3/zh-cn/application-dev/reference/apis-sensor-service-kit/errorcode-sensor.md)。
