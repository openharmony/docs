...
| direction | [PanDirection](#pandirection枚举说明) | 否 | 触发拖动的手势方向，此枚举值支持逻辑与(&amp;)和逻辑或（\|）运算。<br/>默认值：PanDirection.All |
...
| direction | [PanDirection](#pandirection枚举说明) | 否   | 设置滑动方向，此枚举值支持逻辑与(&amp;)和逻辑或（\|）运算。<br/>默认值：All |
