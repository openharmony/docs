...
| alignSelf  | [ItemAlign](ts-appendix-enums.md#itemalign) | 子组件在父容器交叉轴的对齐格式，会覆盖Flex布局容器中的alignItems设置。<br/>GridCol可以绑定alignsSelf属性来改变它自身再交叉轴的布局<br/>默认值：ItemAlign.Auto<br/>从API version 10开始，该接口支持在ArkTS卡片中使用。 |
