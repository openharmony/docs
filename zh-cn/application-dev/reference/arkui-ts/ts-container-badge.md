...
**方法1：** Badge(value: {count: number, position?: BadgePosition \| Position, maxCount?: number, style: BadgeStyle})
...
**方法2：** Badge(value: {value: string, position?: BadgePosition \| Position, style: BadgeStyle})
