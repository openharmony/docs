...
>
>  该组件从API Version 10开始支持继承父组件Text的属性，即如果子组件未设置属性时，若父组件设置属性，则使用父组件设置的属性。支持继承的属性包括：fontColor、fontSize、fontStyle、fontWeight、decoration、letterSpacing、textCase、lineHeight
