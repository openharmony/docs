...
| priorityGesture | gesture:&nbsp;[GestureType](#gesturetype),<br/>mask?:&nbsp;[GestureMask](#gesturemask枚举说明) | gesture:&nbsp;-，<br/>mask:&nbsp;GestureMask.Normal | 绑定优先识别手势。<br/>- gesture: 绑定的手势类型， <br/>- mask: 事件响应设置。<br/>默认手势duration是500毫秒。<br/>1、同等手势duration，设置priorityGesture的优先识别<br/>2、同等手势duration，多个设置priorityGesture的组件，父组件优先识别<br/>3、手势duration小的组件优先响应，会忽略priorityGesture |
