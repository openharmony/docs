...
> - Flex组件在设置flexShrink、flexGrow时存在二次布局过程，因此在对性能有严格要求的场景下建议使用[Column](reference/arkui-ts/ts-container-column.md)、[Row](reference/arkui-ts/ts-container-row.md)代替。
