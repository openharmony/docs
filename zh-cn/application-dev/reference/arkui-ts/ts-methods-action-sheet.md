...
| offset     | {<br/>dx:&nbsp;[Length](ts-types.md#length),<br/>dy:&nbsp;[Length](ts-types.md#length)<br/>} | 否      | 弹窗相对alignment所在位置的偏移量。{<br/>dx:&nbsp;0,<br/>dy:&nbsp;0<br/>} |
