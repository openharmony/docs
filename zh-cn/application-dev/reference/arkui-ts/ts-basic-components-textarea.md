...
| enterKeyType<sup>11+</sup>  | [EnterKeyType](#enterkeytype枚举说明) | 设置输入法回车键类型。<br/>默认值：EnterKeyType.NEW_LINE |
>  **说明：**
>
...
| onSubmit(callback:&nbsp;(enterKey:&nbsp;EnterKeyType)&nbsp;=&gt;&nbsp;void)<sup>11+</sup>  | 按下输入法回车键触发该回调。<br/>enterKey：输入法回车键类型，类型为EnterKeyType.NEW_LINE时不触发onSubmit。具体类型见[EnterKeyType枚举说明](#enterkeytype枚举说明)。|
