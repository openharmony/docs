...
| 参数名   | 类型   | 必填 | 说明                            |
| -------- | ------ | ---- | ------------------------------- |
| duration | number | 是   | 给定的时间，单位：ms，不小于0。 |
...
| ------ | ---------- | ---- | ----------------------------------------- |
| On     | [On](#on9) | 是   | 目标控件的属性要求。                      |
| time   | number     | 是   | 查找目标控件的持续时间。单位ms，不小于0。 |
...
| 参数名 | 类型   | 必填 | 说明                                            |
| ------ | ------ | ---- | ----------------------------------------------- |
| x      | number | 是   | 以number的形式传入目标点的横坐标信息。不小于0。 |
| y      | number | 是   | 以number的形式传入目标点的纵坐标信息。不小于0。 |
...
| 参数名 | 类型   | 必填 | 说明                                                         |
| ------ | ------ | ---- | ------------------------------------------------------------ |
| startx | number | 是   | 以number的形式传入起始点的横坐标信息。不小于0。              |
| starty | number | 是   | 以number的形式传入起始点的纵坐标信息。不小于0。              |
| endx   | number | 是   | 以number的形式传入目的点的横坐标信息。不小于0。              |
| endy   | number | 是   | 以number的形式传入目的点的纵坐标信息。不小于0。              |
| speed  | number | 否   | 滑动速率，范围：200-40000，不在范围内设为默认值为600，单位：像素点/秒。 |
...
| 参数名   | 类型   | 必填 | 说明                                                         |
| -------- | ------ | ---- | ------------------------------------------------------------ |
| idleTime | number | 是   | 空闲时间的阈值。在这个时间段控件不发生变化，视为该控件空闲，单位：毫秒。不小于0。 |
| timeout  | number | 是   | 等待空闲的最大时间，单位：毫秒。不小于0。                    |
