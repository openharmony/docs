...
打开或创建文件，使用Promise异步返回。使用URI作为入参时，仅支持打开文件。
...
打开或创建文件，可设置打开文件的选项。使用callback异步回调。使用URI作为入参时，仅支持打开文件。
...
打开或创建文件，使用callback异步回调。使用URI作为入参时，仅支持打开文件。
...
以同步方法打开或创建文件。使用URI作为入参时，仅支持打开文件。
