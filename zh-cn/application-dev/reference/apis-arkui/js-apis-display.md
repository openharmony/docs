...
| x<sup>16+</sup> | number | 是 | 是 | 屏幕左上角相对主屏的坐标,该参数为整数。<br>**原子化服务API：** 从API version 16开始，该接口支持在原子化服务中使用。                                                                                    |
| y<sup>16+</sup> | number | 是 | 是 | 屏幕左上角相对主屏的坐标,该参数为整数。<br>**原子化服务API：** 从API version 16开始，该接口支持在原子化服务中使用。                                                                                    |
