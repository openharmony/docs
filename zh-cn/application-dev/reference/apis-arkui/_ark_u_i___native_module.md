...
| [ArkUI_TextVerticalAlignment](#arkui_textverticalalignment) { ARKUI_TEXT_VERTICAL_ALIGNMENT_BASELINE = 0, ARKUI_TEXT_VERTICAL_ALIGNMENT_BOTTOM, ARKUI_TEXT_VERTICAL_ALIGNMENT_CENTER, ARKUI_TEXT_VERTICAL_ALIGNMENT_TOP } | 定义字体垂直对齐样式枚举值。  | 
