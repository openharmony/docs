...
| typedef struct [ArkUI_DrawableDescriptor](#arkui_drawabledescriptor)[ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) | 提供获取 PixelMap 的能力，包括前景、背景、蒙版和分层图标。  | 
...
| [ArkUI_ListItemAlign](#arkui_listitemalign) { ARKUI_LIST_ITEM_ALIGN_START = 0, ARKUI_LIST_ITEM_ALIGN_CENTER, ARKUI_LIST_ITEM_ALIGN_END } | 交叉轴方向的布局方式。  | 
...
| [ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \* [OH_ArkUI_DrawableDescriptor_Create](#oh_arkui_drawabledescriptor_create) () | 创建 DrawbleDescriptor 对象，提供获取 PixelMap 的能力，包括前景、背景、蒙版和分层图标。  | 
...
| void [OH_ArkUI_DrawableDescriptor_SetPixelMap](#oh_arkui_drawabledescriptor_setpixelmap) ([ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*drawableDescriptor, NativePixelMap \*map) | 设置 PixelMap 图片。  | 
| NativePixelMap \* [OH_ArkUI_DrawableDescriptor_GetPixelMap](#oh_arkui_drawabledescriptor_getpixelmap) ([ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*drawableDescriptor) | 获取 PixelMap 图片对象指针。  | 
| void [OH_ArkUI_DrawableDescriptor_SetAnimatedPixelMapArray](#oh_arkui_drawabledescriptor_setanimatedpixelmaparray) ([ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*drawableDescriptor, NativePixelMap \*\*array, int32_t size) | 设置用于播放动画的 PixelMap 图片数组数据。  | 
| NativePixelMap \*\* [OH_ArkUI_DrawableDescriptor_GetAnimatedPixelMapArray](#oh_arkui_drawabledescriptor_getanimatedpixelmaparray) ([ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*drawableDescriptor) | 获取用于播放动画的 PixelMap 图片数组数据。  | 
...
提供获取 PixelMap 的能力，包括前景、背景、蒙版和分层图标。
...
| 枚举值 | 描述 | 
| -------- | -------- |
| ARKUI_LIST_ITEM_ALIGN_START  | ListItem在List中，交叉轴方向首部对齐。&nbsp;&nbsp; | 
| ARKUI_LIST_ITEM_ALIGN_CENTER  | ListItem在List中，交叉轴方向居中对齐。&nbsp;&nbsp; | 
| ARKUI_LIST_ITEM_ALIGN_END  | ListItem在List中，交叉轴方向尾部对齐。&nbsp;&nbsp; | 
...
| NODE_ALIGN_RULES  | 相对容器中子组件的对齐规则属性，支持属性设置，属性重置，获取属性接口。<br/>属性设置方法参数[ArkUI_AttributeItem](_ark_u_i___attribute_item.md)格式：<br/>.value[0]?.i32 左对齐规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[1]?.i32 横向居中规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[2]?.i32 右对齐规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[3]?.i32 顶部对齐规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[4]?.i32 纵向居中规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[5]?.i32 底部对齐规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[6]?.f32 水平方向的bias值。<br/>.value[7]?.f32 垂直方向的bias值。<br/>.string 锚点组件id。多个用,分隔，格式为"leftAnchorId,horizontalAnchorId,rightAnchorId, topAnchorId,verticalAnchorId,bottomAnchorId"，不存在的id用空字符串代替。<br/>属性获取方法返回值[ArkUI_AttributeItem](_ark_u_i___attribute_item.md)格式：<br/>.value[0].i32 左对齐规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[1].i32 横向居中规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[2].i32 右对齐规则相对锚点组件的对齐方式，取[ArkUI_HorizontalAlignment](#arkui_horizontalalignment)枚举值。<br/>.value[3].i32 顶部对齐规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[4].i32 纵向居中规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[5].i32 底部对齐规则相对锚点组件的对齐方式，取[ArkUI_VerticalAlignment](#arkui_verticalalignment)枚举值。<br/>.value[6].f32 水平方向的bias值。<br/>.value[7].f32 垂直方向的bias值。<br/>.string 锚点组件id。多个用,分隔，格式为"leftAnchorId,horizontalAnchorId,rightAnchorId, topAnchorId,verticalAnchorId,bottomAnchorId"，不存在的id用空字符串代替。 | 
...
| NODE_LIST_ALIGN_LIST_ITEM  | 设置List交叉轴方向宽度大于ListItem交叉轴宽度 \* lanes时， ListItem在List交叉轴方向的布局方式，支持属性设置，属性重置和属性获取接口。<br/>属性设置方法参数[ArkUI_AttributeItem](_ark_u_i___attribute_item.md)格式：<br/>.value[0].i32：交叉轴方向的布局方式。参数类型[ArkUI_ListItemAlign](#arkui_listitemalign)<br/>属性获取方法返回值[ArkUI_AttributeItem](_ark_u_i___attribute_item.md)格式：<br/>.value[0].i32：交叉轴方向的布局方式。参数类型[ArkUI_ListItemAlign](#arkui_listitemalign) | 
...
### OH_ArkUI_DrawableDescriptor_Create()
...
创建 DrawbleDescriptor 对象，提供获取 PixelMap 的能力，包括前景、背景、蒙版和分层图标。
...
### OH_ArkUI_DrawableDescriptor_GetPixelMap()
...
### OH_ArkUI_DrawableDescriptor_SetAnimatedPixelMapArray()

```
void OH_ArkUI_DrawableDescriptor_SetAnimatedPixelMapArray (ArkUI_DrawableDescriptor * drawableDescriptor, NativePixelMap ** array, int32_t size )
```
**描述：**

设置用于播放动画的 PixelMap 图片数组数据。
...
### OH_ArkUI_DrawableDescriptor_SetPixelMap()
