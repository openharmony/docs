...
| int32_t [OH_ArkUI_GetDrawableDescriptorFromNapiValue](#oh_arkui_getdrawabledescriptorfromnapivalue) (napi_env env, napi_value value, [ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*\*drawableDescriptor) |  | 
| int32_t [OH_ArkUI_GetDrawableDescriptorFromResourceNapiValue](#oh_arkui_getdrawabledescriptorfromresourcenapivalue) (napi_env env, napi_value value, [ArkUI_DrawableDescriptor](#arkui_drawabledescriptor) \*\*drawableDescriptor) |  | 
...
| void [OH_ArkUI_AccessibilityState_SetCheckedType](#oh_arkui_accessibilitystate_setcheckedtype) ([ArkUI_AccessibilityState](#arkui_accessibilitystate) \*state, int32_t checkedType) | 设置无障碍状态复选框状态。  | 
| int32_t [OH_ArkUI_AccessibilityState_GetCheckedType](#oh_arkui_accessibilitystate_getcheckedtype) ([ArkUI_AccessibilityState](#arkui_accessibilitystate) \*state) | 获取无障碍状态复选框状态。  | 
...
```
enum ArkUI_AccessibilityCheckedType
```
**描述：**
...
| ARKUI_ANIMATION_STATUS_STOPED  | 动画处于停止状态。&nbsp;&nbsp; | 
...
### OH_ArkUI_AccessibilityState_GetCheckedType()
...
复选框状态，参数类型[ArkUI_AccessibilityCheckedType](#arkui_accessibilitycheckedtype), 默认值：ARKUI_ACCESSIBILITY_UNCHECKED; 若函数参数异常，返回默认值。
...
### OH_ArkUI_AccessibilityState_SetCheckedType()
...
| -------- | -------- |
| state | 无障碍状态对象指针。  | 
| checkedType | 复选框状态，参数类型[ArkUI_AccessibilityCheckedType](#arkui_accessibilitycheckedtype), 默认值：ARKUI_ACCESSIBILITY_UNCHECKED。  | 
