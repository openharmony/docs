...
| 参数项 | 描述 |
| -- | -- |
| [Input_KeyEvent](../apis-input-kit/input.md#input_keyevent)* keyEvent | 多模按键事件，具体可见[Input_KeyEvent](../apis-input-kit/input.md#input_keyevent)，事件定义在oh_input_manager中。 |
...
| 参数项 | 描述 |
| -- | -- |
| [Input_MouseEvent](../apis-input-kit/input.md#input_mouseevent)* mouseEvent | 多模鼠标事件，具体可见[Input_MouseEvent](../apis-input-kit/input.md#input_mouseevent)，事件定义在oh_input_manager中。 |
...
| 参数项 | 描述 |
| -- | -- |
| [Input_TouchEvent](../apis-input-kit/input.md#input_touchevent)* touchEvent | 多模触摸事件，具体可见[Input_TouchEvent](../apis-input-kit/input.md#input_touchevent)，事件定义在oh_input_manager中。 |
