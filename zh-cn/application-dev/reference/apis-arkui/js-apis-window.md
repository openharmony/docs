...
设置子窗或悬浮窗的圆角半径值，使用Promise异步回调，<!--RP6-->仅2in1设备可用<!--RP6End-->。
...
获取子窗或悬浮窗的圆角半径值，在未调用[setWindowCornerRadius()](#setwindowcornerradius16)接口设置窗口圆角半径值时，调用此接口可获取窗口默认圆角半径值，<!--RP6-->仅2in1设备可用<!--RP6End-->。
