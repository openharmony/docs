...
OpenHarmony的窗口模块将窗口界面分为系统窗口、UIExtension窗口和应用窗口三种基本类型。
...
| 名称                                  | 值 | 说明                                                                                     |
|-------------------------------------| ------ |----------------------------------------------------------------------------------------|
| TYPE_APP                            | 0      | 表示应用子窗口。<br>**模型约束：** 此接口仅可在FA模型下使用。<br>**基本类型：** 应用子窗口。                                                   |
| TYPE_SYSTEM_ALERT                   | 1      | 表示系统告警窗口。<br>- **说明：** 从API version 11开始废弃。<br>- 从 API version 7开始支持。<br>**基本类型：** 系统窗口。                              |
| TYPE_FLOAT<sup>9+</sup>             | 8      | 表示悬浮窗。<br>**模型约束：** 此接口仅可在Stage模型下使用。 <br/>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**基本类型：** 系统窗口。   |
| TYPE_DIALOG<sup>10+</sup>           | 16      | 表示模态窗口。<br>**模型约束：** 此接口仅可在Stage模型下使用。<br/>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**基本类型：** 系统窗口。   |
...
开启当前应用窗口系统规避区变化的监听。调用[setSystemAvoidAreaEnabled](#setsystemavoidareaenabled16)方法使能系统窗口获取避让区后，该方法亦对系统窗口生效。
