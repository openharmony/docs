...
设置主窗口或子窗口的布局是否为沉浸式布局，使用Promise异步回调。从API version 14开始，<!--RP5-->该接口在2in1设备上调用不生效。<!--RP5End-->
...
设置当前窗口是否开启沉浸式布局，该调用不会改变窗口模式和窗口大小。从API version 14开始，<!--RP5-->该接口在2in1设备上调用不生效。<!--RP5End-->
