...
设置当前系统窗口是否可以获取窗口内容的[避让区](#avoidarea7)，系统窗口主要包括：[WindowType](#windowtype7)表格中的3种系统窗口类别的窗口类型和[@ohos.window (窗口)(系统接口) WindowType](https://gitee.com/openharmony/docs/blob/b64947ea02239df97dc7bd6600640c975be1a77c/zh-cn/application-dev/reference/apis-arkui/js-apis-window-sys.md#windowtype7)表格中的所有窗口类型。
...
获取当前系统窗口是否可以获取窗口内容的[避让区](#avoidarea7)，系统窗口主要包括：[WindowType](#windowtype7)表格中的3种系统窗口类别的窗口类型和[@ohos.window (窗口)(系统接口) WindowType](https://gitee.com/openharmony/docs/blob/b64947ea02239df97dc7bd6600640c975be1a77c/zh-cn/application-dev/reference/apis-arkui/js-apis-window-sys.md#windowtype7)表格中的所有窗口类型。
