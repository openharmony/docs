...
设置主窗口的显示方向属性，使用callback异步回调。<!--RP8-->仅在支持跟随sensor旋转的设备上生效，2in1设备上调用不生效，子窗口调用后不生效。<!--RP8End-->
...
设置主窗口的显示方向属性，使用Promise异步回调。<!--RP8-->仅在支持跟随sensor旋转的设备上生效，2in1设备上调用不生效，子窗口调用后不生效。<!--RP8End-->
