...
| void [OH_ArkUI_ArkUI_AnimatorOption_Dispose](_ark_u_i___native_module.md#oh_arkui_arkui_animatoroption_dispose) ([ArkUI_AnimatorOption](_ark_u_i___native_module.md#arkui_animatoroption) \*option) | 销毁animator动画对象参数。  | 
...
| int32_t [OH_ArkUI_AnimatorOption_SetFill](_ark_u_i___native_module.md#oh_arkui_animatoroption_setfill) ([ArkUI_AnimatorOption](_ark_u_i___native_module.md#arkui_animatoroption) \*option, [ArkUI_AnimationFill](_ark_u_i___native_module.md#arkui_animationfill) value) | 设置animator动画执行后是否恢复到初始状态。  | 
...
| [ArkUI_AnimationFill](_ark_u_i___native_module.md#arkui_animationfill) [OH_ArkUI_AnimatorOption_GetFill](_ark_u_i___native_module.md#oh_arkui_animatoroption_getfill) ([ArkUI_AnimatorOption](_ark_u_i___native_module.md#arkui_animatoroption) \*option) | 获取animator动画执行后是否恢复到初始状态。  | 
...
| int32_t [OH_ArkUI_Animator_RegisterOnFrameCallback](_ark_u_i___native_module.md#oh_arkui_animator_registeronframecallback) ([ArkUI_AnimatorHandle](_ark_u_i___native_module.md#arkui_animatorhandle) animator, void \*userData, void(\*callback)(ArkUI_AnimatorOnFrameEvent \*event)) | 设置animator动画接收到帧时回调。  | 
| int32_t [OH_ArkUI_Animator_RegisterOnFinishCallback](_ark_u_i___native_module.md#oh_arkui_animator_registeronfinishcallback) ([ArkUI_AnimatorHandle](_ark_u_i___native_module.md#arkui_animatorhandle) animator, void \*userData, void(\*callback)(ArkUI_AnimatorEvent \*event)) | 设置animator动画完成时回调。  | 
| int32_t [OH_ArkUI_Animator_RegisterOnCancelCallback](_ark_u_i___native_module.md#oh_arkui_animator_registeroncancelcallback) ([ArkUI_AnimatorHandle](_ark_u_i___native_module.md#arkui_animatorhandle) animator, void \*userData, void(\*callback)(ArkUI_AnimatorEvent \*event)) | 设置animator动画被取消时回调。  | 
| int32_t [OH_ArkUI_Animator_RegisterOnRepeatCallback](_ark_u_i___native_module.md#oh_arkui_animator_registeronrepeatcallback) ([ArkUI_AnimatorHandle](_ark_u_i___native_module.md#arkui_animatorhandle) animator, void \*userData, void(\*callback)(ArkUI_AnimatorEvent \*event)) | 设置animator动画重复时回调。  | 
...
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_InitCurve](_ark_u_i___native_module.md#oh_arkui_curve_initcurve) ([ArkUI_AnimationCurve](_ark_u_i___native_module.md#arkui_animationcurve) curve) | 插值曲线的初始化函数，可以根据入参创建一个插值曲线对象。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_StepsCurve](_ark_u_i___native_module.md#oh_arkui_curve_stepscurve) (int32_t count, bool end) | 构造阶梯曲线对象。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_CubicBezierCurve](_ark_u_i___native_module.md#oh_arkui_curve_cubicbeziercurve) (float x1, float y1, float x2, float y2) | 构造三阶贝塞尔曲线对象。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_SpringCurve](_ark_u_i___native_module.md#oh_arkui_curve_springcurve) (float velocity, float mass, float stiffness, float damping) | 构造弹簧曲线对象，曲线形状由弹簧参数决定，动画时长受animation、animateTo中的duration参数控制。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_SpringMotion](_ark_u_i___native_module.md#oh_arkui_curve_springmotion) (float response, float dampingFraction, float overlapDuration) | 构造弹性动画曲线对象。如果对同一对象的同一属性进行多个弹性动画，每个动画会替换掉前一个动画，并继承之前的速度。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_ResponsiveSpringMotion](_ark_u_i___native_module.md#oh_arkui_curve_responsivespringmotion) (float response, float dampingFraction, float overlapDuration) | 构造弹性跟手动画曲线对象，是springMotion的一种特例，仅默认参数不同，可与springMotion混合使用。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_InterpolatingSpring](_ark_u_i___native_module.md#oh_arkui_curve_interpolatingspring) (float velocity, float mass, float stiffness, float damping) | 构造插值器弹簧曲线对象，生成一条从0到1的动画曲线，实际动画值根据曲线进行插值计算。  | 
| [ArkUI_CurveHandle](_ark_u_i___native_module.md#arkui_curvehandle) [OH_ArkUI_Curve_CustomCurve](_ark_u_i___native_module.md#oh_arkui_curve_customcurve) (void \*userData, float(\*interpolate)(float fraction, void \*userdata)) | 构造自定义曲线对象。  | 
