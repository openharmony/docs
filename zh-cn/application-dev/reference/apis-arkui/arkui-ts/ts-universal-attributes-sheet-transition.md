...
| detentSelection<sup>15+</sup>          | [SheetSize](#sheetsize枚举说明)&nbsp;\|&nbsp;[Length](ts-types.md#length) | 否    | 支持非手势切换挡位。<br/>**说明：**<br/>当设置SheetSize.FIT_CONTENT时，该接口无效。<br/>**原子化服务API：** 从API version 15开始，该接口支持在原子化服务中使用。 |
