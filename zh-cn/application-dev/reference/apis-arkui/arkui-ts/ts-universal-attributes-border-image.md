...
| repeat | [RepeatMode](#repeatmode枚举说明)                            | 否 | 设置被切割的图片在边框上的重复方式。<br/>默认值：RepeatMode.Stretch<br/>**元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fill   | boolean                                                      | 否 | 设置边框图片是否中心填充。<br/>默认值：false<br/>**元服务API：** 从API version 11开始，该接口支持在元服务中使用。                     |
