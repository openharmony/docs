...
| 名称        | 描述                              |
| --------- | ------------------------------- |
| Contain   | 保持宽高比进行缩小或者放大，使得图片完全显示在显示边界内。<br/>![ImageFit-Examples01](figures/image_fit_contain.png)   |
| Cover     | 保持宽高比进行缩小或者放大，使得图片两边都大于或等于显示边界。<br/>![ImageFit-Examples02](figures/image_fit_cover.png) |
| Auto      | 图像会根据其自身尺寸和组件的尺寸进行适当缩放，以在保持比例的同时填充视图。<br/>![ImageFit-Examples03](figures/image_fit_auto.png) |
| Fill      | 不保持宽高比进行放大缩小，使得图片充满显示边界。<br/>![ImageFit-Examples04](figures/image_fit_fill.png)        |
| ScaleDown | 保持宽高比显示，图片缩小或者保持不变。<br/>![ImageFit-Examples05](figures/image_fit_scaleDown.png)             |
| None      | 保持原有尺寸显示。<br/>![ImageFit-Examples06](figures/image_fit_none.png)                       |
| TOP_START<sup>12+</sup> | 图像显示在Image组件的顶部起始端，保持原有尺寸显示。<br/>![ImageFit-Examples07](figures/image_fit_top_start.png) |
| TOP<sup>12+</sup>       | 图像显示在Image组件的顶部横向居中，保持原有尺寸显示。<br/>![ImageFit-Examples08](figures/image_fit_top.png) |
| TOP_END<sup>12+</sup>   | 图像显示在Image组件的顶部尾端，保持原有尺寸显示。<br/>![ImageFit-Examples09](figures/image_fit_top_end.png) |
| START<sup>12+</sup>     | 图像显示在Image组件的起始端纵向居中，保持原有尺寸显示。<br/>![ImageFit-Examples10](figures/image_fit_start.png) |
| CENTER<sup>12+</sup>    | 图像显示在Image组件的横向和纵向居中，保持原有尺寸显示。<br/>![ImageFit-Examples11](figures/image_fit_center.png) |
| END<sup>12+</sup>       | 图像显示在Image组件的尾端纵向居中，保持原有尺寸显示。<br/>![ImageFit-Examples12](figures/image_fit_end.png) |
| BOTTOM_START<sup>12+</sup> | 图像显示在Image组件的底部起始端，保持原有尺寸显示。<br/>![ImageFit-Examples13](figures/image_fit_bottom_start.png) |
| BOTTOM<sup>12+</sup>    | 图像显示在Image组件的底部横向居中，保持原有尺寸显示。<br/>![ImageFit-Examples14](figures/image_fit_bottom.png) |
| BOTTOM_END<sup>12+</sup>| 图像显示在Image组件的底部尾端，保持原有尺寸显示。<br/>![ImageFit-Examples15](figures/image_fit_bottom_end.png) |
