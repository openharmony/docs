...
| onFinish   | ()&nbsp;=&gt;&nbsp;void      | 否 | 动画播放完成回调。<br/>**卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。<br/>从API version 13开始，ability退后台时会立即结束动画，触发播放完成回调。 |
