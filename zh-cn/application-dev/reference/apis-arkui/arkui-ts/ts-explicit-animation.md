...
| curve      | [Curve](ts-appendix-enums.md#curve)&nbsp;\|&nbsp;[ICurve<sup>9+</sup>](../../apis/js-apis-curve.md#icurve)&nbsp;\|&nbsp;string | 否 | 动画曲线。<br/>默认值：Curve.EaseInOut<br/>从API version 9开始，该接口支持在ArkTS卡片中使用。 |
...
| onFinish   | ()&nbsp;=&gt;&nbsp;void      | 否 | 动画播放完成回调。<br/>从API version 9开始，该接口支持在ArkTS卡片中使用。 |
