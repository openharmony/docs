...
> **说明：**
> 
> 在API version 11，本接口采用半像素对齐方式（即0\~0.25取0，0.25\~0.75取0.5，0.75\~1.0取1）。从API version 12开始，本接口采用四舍五入的取整方式，并开始支持组件级关闭像素取整的能力。

正常计算时，上下方向以及组件高度相对应，左右方向（镜像的起始方向称为左）以及宽度相对应。为方便描述将两组方向称为左上和右下。
