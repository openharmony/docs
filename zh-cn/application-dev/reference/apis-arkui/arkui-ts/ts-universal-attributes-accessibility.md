...
该示例主要演示accessibilityScrollTriggerable设置无障碍节点是否支持屏幕朗读滚动和accessibilityUseSamePage设置跨进程嵌入式显示的组件,如[EmbeddedComponent](ts-container-embedded-component.md)的accessibilityUseSamePage属性。
