...
| 参数名 | 类型    | 必填 | 说明                              |
| ------ | ------- | ---- | --------------------------------- |
| enable  | boolean | 是   | 使能文本识别。<br/>true表示进行文本特殊实体识别，false表示不进行文本特殊实体识别。<br/>默认值： false |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------- | ---- | ----------------------------------------------------------- |
| isEnabled  | boolean | 是   | 通过点击以外的方式获焦时，是否主动拉起软键盘。<br/>true表示能够主动拉起软键盘，false表示不能够主动拉起软键盘。<br/>默认值： true |
