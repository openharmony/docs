...
| selectedContent | [ResourceStr](ts-types.md#resourcestr)                         | 否 | @Trace | 设置下拉按钮本身的文本内容。默认值'' 。从API20起，增加了Resource类型支持。                             |
...
| selectedContent | [ResourceStr](ts-types.md#resourcestr)                                                           | 否 | 设置下拉按钮本身的文本内容。默认值''。从API20起，增加了Resource类型支持。                                                      |
