...
| onActionCancel(event:&nbsp;(Callback<[GestureEvent](ts-gesture-settings.md#gestureevent对象说明)>)&nbsp;=&gt;&nbsp;void)<sup>18+</sup> | LongPress手势识别成功，接收到触摸取消事件触发回调。返回手势事件信息。<br/>**原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。|
