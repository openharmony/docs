...
- 不适用场景：
  ...
  RichText组件不适用于对HTML字符串的显示效果进行较多自定义的应用场景。例如RichText组件不支持通过设置属性与事件，来修改**背景颜色、字体颜色、字体大小、动态改变内容**等。在这种情况下，推荐使用[Web组件](../../apis-arkweb/arkts-basic-components-web.md#web)。
...
> - **该组件不再更新和维护，推荐使用[RichEditor组件](../arkui-ts/ts-basic-components-richeditor.md#richeditor)或[Web组件](../../apis-arkweb/arkts-basic-components-web.md#web)。**
