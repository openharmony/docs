...
| 名称 | 描述 | 
| -------- | -------- |
| int32_t(\* [animateTo](#animateto) )(ArkUI_ContextHandle context, [ArkUI_AnimateOption](_ark_u_i___native_module.md#arkui_animateoption) \*option, ArkUI_ContextCallback \*update, [ArkUI_AnimateCompleteCallback](_ark_u_i___animate_complete_callback.md) \*complete) | 显式动画接口  | 
