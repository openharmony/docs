...
| -- | -- |
| int32_t windowId | 创建窗口时的窗口id。默认值为0。该参数为整数。 |
| [Input_TouchEvent](../apis-input-kit/input.md#input_touchevent)* touchEvent | 多模触摸事件，具体可见[Input_TouchEvent](../apis-input-kit/input.md#input_touchevent)，事件定义在oh_input_manager.h中。 |
