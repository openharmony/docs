...
| 名称   | 类型 | 可读 | 可写 | 必填 | 说明                                         |
| ------ | -------- | ---- | ---- | ---- |--------------------------------------------|
| x      | number   | 否   | 是   | 否   | X轴的缩放参数。该参数为浮点数，默认值为1.0。                   |
| y      | number   | 否   | 是   | 否   | Y轴的缩放参数。该参数为浮点数，默认值为1.0。                   |
| pivotX | number   | 否   | 是   | 否   | 缩放中心点X轴坐标。该参数为浮点数，默认值为0.5， 取值范围[0.0, 1.0]。 |
| pivotY | number   | 否   | 是   | 否   | 缩放中心点Y轴坐标。该参数为浮点数，默认值为0.5， 取值范围[0.0, 1.0]。 |
...
| 名称   | 类型 | 可读 | 可写 | 必填 | 说明                                          |
| ------ | -------- | ---- | ---- | ---- |---------------------------------------------|
| x      | number   | 否   | 是   | 否  | 绕X轴的旋转角度。该参数为浮点数，默认值为0.0。                   |
| y      | number   | 否   | 是   | 否  | 绕Y轴的旋转角度。该参数为浮点数，默认值为0.0。                   |
| z      | number   | 否   | 是   | 否  | 绕Z轴的旋转角度。该参数为浮点数，默认值为0.0。                   |
| pivotX | number   | 否   | 是   | 否  | 旋转中心点X轴坐标。该参数为浮点数，默认值为0.5， 取值范围为[0.0, 1.0]。 |
| pivotY | number   | 否   | 是   | 否  | 旋转中心点Y轴坐标。该参数为浮点数，默认值为0.5， 取值范围为[0.0, 1.0]。  |
...
| 名称 | 类型 | 可读 | 可写 | 必填 | 说明                         |
| ---- | -------- | ---- | ---- | ---- | ---------------------------- |
| x    | number   | 否   | 是   | 否  | X轴的平移参数。该参数为浮点数，默认值为0.0，单位为px。 |
| y    | number   | 否   | 是   | 否  | Y轴的平移参数。该参数为浮点数，默认值为0.0，单位为px。 |
| z    | number   | 否   | 是   | 否  | Z轴的平移参数。该参数为浮点数，默认值为0.0，单位为px。 |
