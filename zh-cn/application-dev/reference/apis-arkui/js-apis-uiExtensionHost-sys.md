...
> **说明：**
>
> 开启截图隐私内容保护后，使用窗口截图[window.snapshot](js-apis-window.md#snapshot9)或者组件截图[UIContext.getComponentSnapshot](js-apis-arkui-UIContext.md#getComponentSnapshot12)
