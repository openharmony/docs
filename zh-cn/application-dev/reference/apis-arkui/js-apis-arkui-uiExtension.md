...
| 名称                                      | 值              | 说明        |
| ----------------------------------------- | --------------- | ---------- |
| EVENT_NONE<sup>18+</sup>                  | 0x00000000      | 无事件      |
| EVENT_PAN_GESTURE_LEFT<sup>18+</sup>      | 0x00000001      | 左滑事件    |
| EVENT_PAN_GESTURE_RIGHT<sup>18+</sup>     | 0x00000002      | 右滑事件    |
| EVENT_PAN_GESTURE_UP<sup>18+</sup>        | 0x00000004      | 上滑事件    |
| EVENT_PAN_GESTURE_DOWN<sup>18+</sup>      | 0x00000008      | 下滑事件    |
| EVENT_CLICK<sup>18+</sup>                 | 0x00000100      | 点击事件    |
| EVENT_LONG_PRESS<sup>18+</sup>            | 0x00000200      | 长按事件    |
