...
| supportedShapes    | Array&lt;number&gt;      | 是    | 否     | 卡片支持的形状。具体可选形状参考[FormShape](#formshape)   |
...
| supportedShapes | Array<number> |否    | 选填，仅保留含supportedShapes提供值相符的卡片信息，<br>未填写时则不通过supportedShapes进行过滤。   |
