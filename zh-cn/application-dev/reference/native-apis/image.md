...
| 名称 | 描述 | 
| -------- | -------- |
| { OHOS::Media::OHOS_IMAGE_FORMAT_YCBCR_422_SP = 1000,<br/>OHOS::Media::OHOS_IMAGE_FORMAT_JPEG = 2000, } | 图像格式枚举值。 | 
| { OHOS::Media::OHOS_IMAGE_COMPONENT_FORMAT_YUV_Y = 1,<br/>OHOS::Media::OHOS_IMAGE_COMPONENT_FORMAT_YUV_U = 2,<br/>OHOS::Media::OHOS_IMAGE_COMPONENT_FORMAT_YUV_V = 3,<br/>OHOS::Media::OHOS_IMAGE_COMPONENT_FORMAT_JPEG = 4, } | 图像组成类型枚举值。 | 
