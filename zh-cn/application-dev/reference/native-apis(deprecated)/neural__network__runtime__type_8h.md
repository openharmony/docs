...
| 名称 | 描述 |
| -------- | -------- |
| [OH_NN_UInt32Array](_o_h___n_n___u_int32_array.md) | 该结构体用于存储32位无符号整型数组。 |
...
| 名称 | 描述 |
| -------- | -------- |
| [OH_NNModel](_neural_nework_runtime.md#oh_nnmodel) | 模型句柄。 |
| [OH_NNCompilation](_neural_nework_runtime.md#oh_nncompilation) | 编译器句柄。 |
| [OH_NNExecutor](_neural_nework_runtime.md#oh_nnexecutor) | 执行器句柄。 |
| [NN_QuantParam](_neural_nework_runtime.md#nn_quantparam) | 量化参数的句柄。 |
| [NN_TensorDesc](_neural_nework_runtime.md#nn_tensordesc) | Tensor描述的句柄。 |
| [NN_Tensor](_neural_nework_runtime.md#nn_tensor) | Tensor句柄。 |
| (\*[NN_OnRunDone](_neural_nework_runtime.md#nn_onrundone)) (void \*userData, [OH_NN_ReturnCode](_neural_nework_runtime.md#oh_nn_returncode) errCode, void \*outputTensor[], int32_t outputCount) | 异步推理结束后的回调处理函数句柄。 |
| (\*[NN_OnServiceDied](_neural_nework_runtime.md#nn_onservicedied)) (void \*userData) | 异步推理执行期间设备驱动服务异常终止时的回调处理函数句柄。 |
| [OH_NN_UInt32Array](_neural_nework_runtime.md#oh_nn_uint32array) | 该结构体用于存储32位无符号整型数组。 |
| [OH_NN_QuantParam](_neural_nework_runtime.md#oh_nn_quantparamdeprecated) | 量化信息。 |
| [OH_NN_Tensor](_neural_nework_runtime.md#oh_nn_tensordeprecated) | 张量结构体。 |
| [OH_NN_Memory](_neural_nework_runtime.md#oh_nn_memorydeprecated) | 内存结构体。 |
