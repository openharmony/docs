...
#### 描述
为某个任务设置指定的QoS等级。设置当前线程的QoS等级。开发者可以根据当前线程的重要程度，为其标记不同等级的QoS，从而获得不同的调度供给。参考[QoS实践指导]{@link https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-thread-priority-setting}。
...
#### 描述
取消某个任务设置的QoS等级。取消当前线程的QoS等级。参考[QoS实践指导]{@link https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-thread-priority-setting}。
...
#### 描述
获取某个任务之前最近一次设置的QoS等级；如果之前未设置任何QoS等级，则返回-1。查看当前线程的QoS等级。参考[QoS实践指导]{@link https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-thread-priority-setting}。
