...
同时 code cache 的生成和使用也会对编译产生影响，这部分可以参考 [use-jsvm-about-code-cache](use-jsvm-about-code-cache.md)
...
同样某生态应用小程序场景为例, 这个改动减少了大量冗余的接口调用，如下图所示
最终带来的端到端时间收益有 100+ms, 约 3%，
