...
采用IEE754作为浮点编码格式，针对long double的格式定义，将在[支持架构ABI](#支持架构abi)具体说明。
...
此ABI是以《[ARM架构应用二进制接口](https://developer.arm.com/Architectures/Application%20Binary%20Interface)》为基础制定，适用于32位armv7a架构的cpu，支持的核心列表可以参考《[list of ARM processors](https://en.wikipedia.org/wiki/List_of_ARM_processors)》，支持arm32，thumb-2，VFPv3-D16指令。
