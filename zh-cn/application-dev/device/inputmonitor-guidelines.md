...
输入监听常用接口如下表所示，接口详细介绍请参考[ohos.multimodalInput.inputMonitor文档](../reference/apis-input-kit/js-apis-inputmonitor.md)。
...
当应用需要根据鼠标按键按下状态变化样式时。调用[on](../reference/apis-input-kit/js-apis-inputmonitor.md#inputmonitoronmouse9)监听鼠标按键事件，调用[off](../reference/apis-input-kit/
