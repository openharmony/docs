...
- [媒体会话——提供方（ArkTS）（Full SDK）（API10）](https://gitee.com/openharmony/applications_app_samples/tree/monthly_20230815/code/BasicFeature/Media/AVSession/MediaProvider)