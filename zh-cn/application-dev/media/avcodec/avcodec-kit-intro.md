...
[AVFormat](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-avcodec-kit/native__avbuffer_8h.md/#avFormat)等。
...
- 媒体文件封装：将音频、视频、字幕等数据以及描述信息，按照某种格式要求，写入到同一个文件中如mp4。
...
- 音频编解码
  音频编解码请详见[音频解码](video-decoding.md)，[音频编码](video-encoding.md)。
