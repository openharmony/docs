...
| 视频硬解类型       | 视频软解类型   |
| --------------------- | ---------------- |
| AVC(H.264)、HEVC(H.265) | MPEG2、MPEG4、AVC(H.264)、HEVC(H.265) |

视频解码软/硬件解码存在差异，基于MimeType创建解码器时，软解当前仅支持 MPEG2 (OH_AVCODEC_MIMETYPE_VIDEO_MPEG2)、MPEG4 (OH_AVCODEC_MIMETYPE_VIDEO_MPEG4_PART2)、 H264 (OH_AVCODEC_MIMETYPE_VIDEO_AVC)，硬解则支持 H264 (OH_AVCODEC_MIMETYPE_VIDEO_AVC) 和 H265 (OH_AVCODEC_MIMETYPE_VIDEO_HEVC)。
