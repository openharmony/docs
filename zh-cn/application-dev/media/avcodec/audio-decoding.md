...
> **说明：**
>
> 通过音频编码流程生成的码流无法直接通过此音频解码流程进行解码。
...
5. 调用OH_AudioCodec_Configure()配置解码器。
   ...
   各音频解码类型参数范围说明：
   | 音频解码类型/采样率 | 8000 | 11025 | 12000 | 16000 | 22050 | 24000 | 32000 | 44100 | 48000 | 64000 | 88200 | 96000 | 176400 | 192000 |
   | ----------------- | :--: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :----: | :----: |
   |        AAC        |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |        |        |
   |        Flac       |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |        |    √   |
   |       Vorbis      |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √    |    √   |
