...
## 支持的能力
1. 重置帧率，码率。请详见[调用oh_videoencoder_registercallback()设置回调函数](#3-调用oh_videoencoder_registercallback设置回调函数)
...
5. 获取编码每帧平均量化参数，平方误差。[调用oh_videoencoder_registercallback()设置回调函数](#3-调用oh_videoencoder_registercallback设置回调函数)
