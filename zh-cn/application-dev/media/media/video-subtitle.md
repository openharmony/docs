...
## 完整示例
运行示例步骤：
1. 新建工程，下载[示例工程](https://gitee.com/openharmony/applications_app_samples/tree/master/code/DocsSample/Media/AVPlayer/AVPlayerArkTSSubtitle)，将示例工程的以下资源复制到对应目录：
```
AVPlayerArkTSVideo
ntry/src/main/resources/
├── base
│   ├── element
│   │   ├── color.json
│   │   ├── float.json
...
└── rawfile
    ...
    └── test1.srt （字幕资源）
```
2. 将以下示例代码替换新建工程的entry/src/main/ets/pages/Index.ets
```ts
