...
更多接口的示例代码可参考[用户认证API文档](../../../application-dev/reference/apis-user-authentication-kit/js-apis-useriam-userauth.md)和[人脸认证API文档](../../../application-dev/reference/apis-user-authentication-kit/js-apis-useriam-faceauth-sys.md)。
