...
## cl.arkui.2 Progress组件动态改变宽高时，内容区宽高变更
...
| 变更前                                                                                                                     | 变更后                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| 当容器的宽度或高度发生变化时，Progress组件的内容区域未能实时更新。需要更改其他属性后，其尺寸才会相应调整。<br>![progress_before](figures/progress_before.png)| 当容器的宽高发生变化时，Progress组件的内容区域宽高也会随之相应调整。 |
...
## cl.arkui.3 无障碍绿框绘制区域和聚焦区域修改为组件触摸热区
