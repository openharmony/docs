...
包含系统接口的全量SDK（Full SDK）需下载全量代码后编译构建出SDK文件，并在DevEco Studio中替换。通过源码编译Full SDK的指导请参见[Full-SDK编译指南](../application-dev/faq/full-sdk-compile-guide.md)。
...
API变更清单请参考：[API差异报告](api-diffs/v3.2-beta5/Readme.md)
