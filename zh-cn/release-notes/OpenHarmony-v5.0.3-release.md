...
| --------------------------------------- | ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| 全量代码（标准、轻量和小型系统）<br />2025.7.2更新        | 5.0.3 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/5.0.3-Release/code-v5.0.3-Release-20250702.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/5.0.3-Release/code-v5.0.3-Release-20250702.tar.gz.sha256) | 43.3 GB |
