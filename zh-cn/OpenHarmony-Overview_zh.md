...
| 轻量 | 汇顶GR5515-STARTER-KIT | GR5515 | 支持Bluetooth&nbsp;5.1的单模低功耗蓝牙SoC，多功能按键和LED指示灯。 | 智能硬件，如手表、手环、价格类标签。 | 代码仓：<br/>[device_soc_goodix](https://gitee.com/openharmony/device_soc_goodix)<br/>[device_board_goodix](https://gitee.com/openharmony/device_board_goodix)<br/> 社区每日构建版本获取地址：<br/>http://ci.openharmony.cn/dailys/dailybuilds |
