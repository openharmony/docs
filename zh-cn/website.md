  ...
  - API差异报告
    - OpenHarmony 3.2 Beta5
      - JS API差异报告
        ...
        - [应用](release-notes/api-change/v3.2-beta3/js-apidiff-application.md)
        ...
        - [基础通信](release-notes/api-change/v3.2-beta3/js-apidiff-communication.md)
        - [语言编译与运行时](release-notes/api-change/v3.2-beta3/js-apidiff-compiler-and-runtime.md)
        ...
        - [Misc软件](release-notes/api-change/v3.2-beta3/js-apidiff-misc.md)
        - [多媒体](release-notes/api-change/v3.2-beta3/js-apidiff-multimedia.md)
        - [事件通知](release-notes/api-change/v3.2-beta3/js-apidiff-notification.md)
        ...
        - [启动](release-notes/api-change/v3.2-beta3/js-apidiff-start-up.md)
        - [电话服务](release-notes/api-change/v3.2-beta3/js-apidiff-telephony.md)
        - [测试](release-notes/api-change/v3.2-beta3/js-apidiff-unitest.md)
        - [用户IAM](release-notes/api-change/v3.2-beta3/js-apidiff-user-iam.md)
        - [Web](release-notes/api-change/v3.2-beta3/js-apidiff-web.md)
        - [窗口](release-notes/api-change/v3.2-beta3/js-apidiff-window.md)
      - 变更说明
