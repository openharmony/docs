...
-   [组件说明](#section1312121216216)
    ...
    -   [剪切板](#section1961602912226)
    -   [首选项](#section1961602912227)
    -   [关系型数据库](#section1961602912228)
    -   [标准数据化通路](#section1961602912229)
...
- [KVManager](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#kvmanager)：分布式键值数据库管理实例，用于获取数据库的相关信息。
- [KVStoreResultSet](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#kvstoreresultset)：提供获取数据库结果集的相关方法，包括查询和移动数据读取位置等。
- [Query](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#query)：使用谓词表示数据库查询，提供创建Query实例、查询数据库中的数据和添加谓词的方法。
- [SingleKVStore](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#singlekvstore)：单版本分布式键值数据库，不对数据所属设备进行区分，提供查询数据和同步数据的方法。
- [DeviceKVStore](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#devicekvstore)：设备协同数据库，继承自[SingleKVStore](https://gitee.com/umanson/docs/blob/master/zh-cn/application-dev/reference/apis/js-apis-distributedKVStore.md#singlekvstore)，以设备维度对数据进行区分，提供查询数据和同步数据的方法。

### 剪切板<a name="section1961602912226"></a>

**剪切板（pasteboard）** 提供管理系统剪贴板的能力，为系统复制、粘贴功能提供支持。系统剪贴板支持对文本、HTML、URI、Want、PixelMap等内容的操作。

### 首选项<a name="section1961602912227"></a>
...
### 关系型数据库<a name="section1961602912228"></a>
...
### 标准化数据通路<a name="section1961602912229"></a>
...
[third\_party\_libxml2](https://gitee.com/openharmony/third_party_libxml2)

[third\_party\_openssl](https://gitee.com/openharmony/third_party_openssl)

[third\_party\_sqlite](https://gitee.com/openharmony/third_party_sqlite)

[third\_party\_zlib](https://gitee.com/openharmony/third_party_zlib)https://gitee.com/openharmony/third_party_flatbuffers)