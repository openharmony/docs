...
_必选。开篇先阐明what、why、when基础信息，让开发者对kit有初步认知。_
...
_可选。介绍Kit关键开放能力，支撑选型。_

_**【开发者关注点】**_

_该Kit提供了哪些关键开放能力？我要不要使用它？_
...
_可选。介绍Kit相对业界类似能力的亮点、优势，支撑选型。_

_**【开发者关注点】**_

_该Kit有哪些优势？我要不要选择它？_
...
_可选。有些Kit涉及联合使用或相互依赖，有些存在相似/相关场景等，在此处明确相互关系。_
...
- _当Kit**方案/特性/功能/模块**的任务场景、场景间关系不是显性呈现的信息，且这些信息不适合直接放入开篇“xxx Kit简介”时，需要提供本节，用于承载：任务场景概况（任务场景划分维度等）、场景间关系介绍（何时选择各场景）等。_

- _如果Kit开发场景相对简单，可以不提供本节，在本Kit简介中酌情简述即可。_
...
_用于承载任务场景n直接相关的概述内容，知识点构成及写作要点与开篇的“xxx Kit简介”相同，包括任务场景n简介、任务场景n直接相关的基本概念、任务场景n直接相关的实现原理、任务场景n直接相关的约束与限制、任务场景n直接相关的相关实例。如无，则删除。_
