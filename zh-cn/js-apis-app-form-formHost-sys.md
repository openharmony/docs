...
| 参数名 | 类型    | 必填 | 说明                             |
| ------ | ------ | ---- |--------------------------------|
| type | string | 是   | 填写'formOverflow'，表示互动卡片溢出动效请求。 |
| callback |Callback&lt;formInfo.OverflowRequest&gt; | 是 | 回调函数，返回溢出动效处理函数。               |
...
formHost.on('formOverflow', (request: formInfo.OverflowRequest): boolean => {
  ...
});
```
...
| ------ | ------ |----| ------- |
| type | string | 是  | 填写'formOverflow'，表示互动卡片溢出动效请求。 |
| callback |Callback&lt;formInfo.OverflowRequest&gt; | 否  | 回调函数，返回溢出动效处理函数。               |
...
formHost.off('formOverflow', (request: formInfo.OverflowRequest): boolean => {
  ...
});
```
...
| 参数名 | 类型    | 必填 | 说明                                             |
| ------ | ------ | ---- |------------------------------------------------|
| type | string | 是   | 填写'changeSceneAnimationState'，表示互动卡片长时间激活请求。 |
| callback |Callback&lt;formInfo.ChangeSceneAnimationStateRequest&gt; | 是 | 回调函数，返回互动卡片长时间激活处理函数。                               |
...
formHost.on('changeSceneAnimationState', (request: formInfo.ChangeSceneAnimationStateRequest): boolean => {
...
});
```
...
| 参数名 | 类型    | 必填 | 说明    |
| ------ | ------ |----| ------- |
| type | string | 是  | 填写'changeSceneAnimationState'，表示互动卡片溢出动效请求。 |
| callback |Callback&lt;formInfo.ChangeSceneAnimationStateRequest&gt; | 否  | 回调函数，返回溢出动效处理函数。               |
...
formHost.off('changeSceneAnimationState', (request: formInfo.ChangeSceneAnimationStateRequest): boolean => {
...
});
```