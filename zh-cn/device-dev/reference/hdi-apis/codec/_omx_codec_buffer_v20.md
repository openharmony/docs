...
| NativeBuffer  [bufferhandle](#bufferhandle) | 编码或者解码使用的bufferhandle，详见**[NativeBuffer](../../../../application-dev/reference/apis-image-kit/_image__native_module.md#oh_nativebuffer)**。  | 
