...
| [Collect](#collect) ([in] unsigned long scheduleId, [in] unsigned char[] extraInfo, [in] IExecutorCallback callbackObj) | 采集口令数据。 | 
...
```
IAllInOneExecutor::Collect ([in] unsigned long scheduleId, [in] unsigned char[] extraInfo, [in] IExecutorCallback callbackObj)
```
**描述**
采集口令数据。
