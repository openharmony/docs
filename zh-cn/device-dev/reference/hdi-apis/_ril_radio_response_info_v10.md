...
| enum [RilErrType](_ril_v10.md#rilerrtype)[error](#error) | 错误码  | 
| enum [RilResponseTypes](_ril_v10.md#rilresponsetypes)[type](#type) | 响应类型，具体查看[RilResponseTypes](_ril_v10.md#rilresponsetypes) | 
...
```
**描述**
响应类型，具体查看[RilResponseTypes](_ril_v10.md#rilresponsetypes)
