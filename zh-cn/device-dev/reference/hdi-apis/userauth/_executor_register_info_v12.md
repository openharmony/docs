...
| enum [ExecutorRole](_hdf_user_auth_v12.md#executorrole)[executorRole](#executorrole) | 执行器角色[ExecutorRole](_hdf_user_auth_v12.md#executorrole)。  | 
...
| enum [ExecutorSecureLevel](_hdf_user_auth_v12.md#executorsecurelevel)[esl](#esl) | 执行器安全等级[ExecutorSecureLevel](_hdf_user_auth_v12.md#executorsecurelevel)。  | 
...
执行器安全等级[ExecutorSecureLevel](_hdf_user_auth_v12.md#executorsecurelevel)。
...
执行器角色[ExecutorRole](_hdf_user_auth_v12.md#executorrole)。
