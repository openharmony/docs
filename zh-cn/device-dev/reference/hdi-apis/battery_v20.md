...
| 名称 | 描述 | 
| -------- | -------- |
| [IBatteryCallback.idl](_i_battery_callback_8idl_v20.md) | 提供电池信息的回调。 | 
| [IBatteryInterface.idl](_i_battery_interface_8idl_v20.md) | Provides 获取、订阅电池信息的接口。 | 
| [Types.idl](battery_types_8idl_v20.md) | 电池信息相关数据类型。 | 
...
| 名称 | 描述 | 
| -------- | -------- |
| interface&nbsp;&nbsp;[IBatteryCallback](interface_i_battery_callback_v20.md) | 表示电池信息的回调。 | 
...
| [ChargingLimitType](#charginglimittype) { TYPE_CURRENT = 0 , TYPE_VOLTAGE } | 定义电池充电限制类型。 | 
