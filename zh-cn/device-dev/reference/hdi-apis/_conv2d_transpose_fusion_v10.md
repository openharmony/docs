...
该算子对应的[NodeType](_n_n_rt_v10.md#nodetype)为NODE_TYPE_CONV2D_TRANSPOSE_FUSION。
...
| long [group](#group) | group，将输入x按inChannel分组。 group等于1，这是常规卷积； group大于1且小于或等于inChannel，这是分组卷积。  | 
