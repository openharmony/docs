...
该算子对应的[NodeType](_n_n_rt_v10.md#nodetype)为NODE_TYPE_MAX_POOL_FUSION。
...
| enum [Format](_n_n_rt_v10.md#format)[format](#format) | 运算时数据的排列，详情请参考：[Format](_n_n_rt_v10.md#format)。  | 
...
运算时数据的排列，详情请参考：[Format](_n_n_rt_v10.md#format)。
