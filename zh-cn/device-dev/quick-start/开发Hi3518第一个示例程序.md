...
>Hi3518EV300单板的U-boot文件获取路径：vendor\\hisi\\hi35xx\\hi3518ev300\\uboot\\out\\boot\\u-boot-hi3518ev300.bin
...
7.  打开工程文件，点击![](figures/2021-01-27_170334-5.png)图标，打开DevEco Device Tool界面，在“PROJECT TASKS”中，点击partition:hi3518ev300\_fastboot下的**Erase**按钮，擦除U-Boot。
...
3.  <a name="li6442853122312"></a>若启动时显示**"hisilicon \#**字样，请输入**“reset”**指令，等待系统自启动进入系统，系统启动后，显示**“OHOS”**字样，输入**”./bin/camera\_app”**并回车，显示成功结果如下图所示。

    **图 3**  启动成功并执行应用程序图<a name="fig11838403383"></a>  
