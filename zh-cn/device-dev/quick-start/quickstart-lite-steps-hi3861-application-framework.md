...
3. 编写用于将业务构建成静态库的BUILD.gn文件。
   ...
   如[ERROR:Invalid link:zh-cn_topic_0000001260944049.xml#xref7209204195912,link:#li5479332115116](#li5479332115116)所述，BUILD.gn文件由三部分内容（目标、源文件、头文件路径）构成，需由开发者完成填写。
