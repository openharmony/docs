...
-   [使用流程](#section47784125013)
-   [获取UART设备句柄](#section146445153110)
-   [UART设置波特率](#section1862705516339)
-   [UART获取波特率](#section1263651563414)
-   [UART设置设备属性](#section1770091483814)
-   [UART获取设备属性](#section117543316384)
-   [设置UART传输模式](#section187233112369)
-   [向UART设备写入指定长度的数据](#section82416423368)
-   [从UART设备中读取指定长度的数据](#section192177171373)
-   [销毁UART设备句柄](#section63131236354)
