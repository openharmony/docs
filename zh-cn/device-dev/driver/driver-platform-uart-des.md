# UART<a name="ZH-CN_TOPIC_0000001052215244"></a>
...
-   两个UART设备的连接示意图如下，UART与其他模块一般用2线（图1）或4线（图2）相连，它们分别是：
    ...
    -   CTS：允许发送信号，用于判断是否可以向对端发送数据，和对端RTS相连；
        ...
        **图 1**  2线UART设备连接示意图<a name="fig209936401896"></a>  
        ...
        ![](figure/zh-cn_image_0000001170262141.png)

        **图 2**  4线UART设备连接示意图<a name="fig1435614171015"></a>  
        

        ![](figure/zh-cn_image_0000001123582482.png)
...
### 接口说明<a name="section1680292311549"></a>
...
**图 3**  UART使用流程图<a name="fig1852173020185"></a>  


![](figure/zh-cn_image_0000001170227689.png)
