...
- 准备升级包制作工具
- 编译出版本镜像文件
- 将编译结果中的 out/rk3568/clang_x64/updater/updater/diff 放入工具此路径下： packaging_tools/lib/
- 将编译结果中的 out/rk3568/clang_x64/thirdparty/e2fsprogs 路径下的 libext2fs.so、e2fsdriod、libext2_com_err.so、libext2_misc.so 放入工具此路径下：packaging_tools/lib/： packaging_tools/lib/
...
### 生成公私钥对
1. 使用OpenSSL工具生成公私钥对，将公钥 signing_cert.crt 放入工具此路径：packaging_tools\sign_cert\
