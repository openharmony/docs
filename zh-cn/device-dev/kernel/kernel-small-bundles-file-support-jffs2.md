# JFFS2<a name="ZH-CN_TOPIC_0000001123521625"></a>

-   [基本概念](#section11411110155919)
-   [运行机制](#section23911025195913)
-   [开发指导](#section179711119014)

## 基本概念<a name="section11411110155919"></a>
...
## 运行机制<a name="section23911025195913"></a>
...
## 开发指导<a name="section179711119014"></a>
...
**表 1**  指令含义表（更详细的介绍可以通过mkfs.jffs2 --help来查看）
