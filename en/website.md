...
- Release Notes
  ...
  - API Differences
    ...
    - OpenHarmony 3.2 Release (Compared with OpenHarmony 3.2 Beta 5)
      - [Ability](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-ability.md)
      - [Account](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-account.md)
      - [Application](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-application.md)
      - [ArkUI](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-arkui.md)
      - [Power Management](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-battery.md)
      - [Bundle Management](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-bundle.md)
      - [Communication](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-communication.md)
      - [Compiler and Runtime](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-compiler-and-runtime.md)
      - [DFX](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-dfx.md)
      - [Distributed Data Management](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-distributed-data.md)
      - [File Management](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-file-management.md)
      - [Misc Software](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-misc.md)
      - [Multimedia](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-multimedia.md)
      - [Common Event and Notification](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-notification.md)
      - [Resource Scheduler](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-resource-scheduler.md)
      - [Security](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-security.md)
      - [Pan-sensor](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-sensor.md)
      - [Startup](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-start-up.md)
      - [Telephony](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-telephony.md)
      - [Test](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-unitest.md)
      - [Upgrade](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-update.md)
      - [USB](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-usb.md)
      - [User IAM](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-user-iam.md)
      - [Web](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-web.md)
      - [Window](release-notes/api-diff/v3.2-Release-vs-v3.2-beta5/js-apidiff-window.md)
    ...
    - OpenHarmony 3.1 Beta
      - [ArkTS API Differences](release-notes/api-diff/v3.1-beta/js-apidiff-v3.1-beta.md)
    - OpenHarmony 3.0 LTS  
      - [ArkTS API Differences](release-notes/api-diff/v3.0-LTS/js-apidiff-v3.0-lts.md)
    - OpenHarmony v2.2 Beta2
      - [ArkTS API Differences](release-notes/api-diff/v2.2-beta2/js-apidiff-v2.2-beta2.md)
  - API Behavior Changes
    - OpenHarmony 4.0 Release (Compared with OpenHarmony 4.0 Beta2)
      - [Account Changelog](release-notes/changelogs/v4.0-Release/changelogs-account_os_account.md)
      - [ArkCompiler Subsystem Changelog](release-notes/changelogs/v4.0-Release/changelogs-arkcompiler.md)
      - [ArkUI Changelog](release-notes/changelogs/v4.0-Release/changelogs-arkui.md)
      - [Bluetooth Changelog](release-notes/changelogs/v4.0-Release/changelogs-bluetooth.md)
      - [Bundle Manager Changelog](release-notes/changelogs/v4.0-Release/changelogs-bundlemanager.md)
      - [Security Changelog](release-notes/changelogs/v4.0-Release/changelogs-cert.md)
      - [USB Changelog](release-notes/changelogs/v4.0-Release/changelogs-deviceManager.md)
      - [DFX Changelog](release-notes/changelogs/v4.0-Release/changelogs-dfx.md)
      - [Distributed Data Management Changelog](release-notes/changelogs/v4.0-Release/changelogs-distributeddatamgr.md)
      - [File Management Changelog](release-notes/changelogs/v4.0-Release/changelogs-file-management.md)
      - [Image Changelogs](release-notes/changelogs/v4.0-Release/changelogs-image.md)
      - [Input Method Framework Changelog](release-notes/changelogs/v4.0-Release/changelogs-imf.md)
      - [MediaLibrary Changelog](release-notes/changelogs/v4.0-Release/changelogs-mediaLibrary.md)
      - [Multimedia Changelog](release-notes/changelogs/v4.0-Release/changelogs-multimedia.md)
      - [Network Management Changelog](release-notes/changelogs/v4.0-Release/changelogs-netstack.md)
      - [Application Access Control Changelog](release-notes/changelogs/v4.0-Release/changelogs-security_access_token.md)
      - [Telephone Service Changelog](release-notes/changelogs/v4.0-Release/changelogs-telephony.md)
      - [Time Changelog](release-notes/changelogs/v4.0-Release/changelogs-time.md)
      - [Wi-Fi Changelog](release-notes/changelogs/v4.0-Release/changelogs-wifiManager.md)
    - OpenHarmony 4.0 Beta2 (Compared with OpenHarmony 4.0 Beta1)
      - [ArkUI Subsystem Changelog](release-notes/changelogs/v4.0-beta2/changelogs-arkui.md)
      - [Bundle Manager Changelog](release-notes/changelogs/v4.0-beta2/changelogs-bundlemanager.md)
      - [Device Management Changelog](release-notes/changelogs/v4.0-beta2/changelogs-accessToken.md)
      ...
      - [Input Method Framework Service Changelog](release-notes/changelogs/v4.0-beta2/changelogs-imf.md)
      - [Multimedia Subsystem Changelog](release-notes/changelogs/v4.0-beta2/changelogs-multimedia.md)
      - [Theme Framework Subsystem - Screen Lock Management Service Changelog](release-notes/changelogs/v4.0-beta2/changelogs-screenlock.md)
      - [Device Management Changelog](release-notes/changelogs/v4.0-beta2/changelogs-device_manager.md)
      - [Pan-Sensor Subsystem Changelog](release-notes/changelogs/v4.0-beta2/changelogs-miscdevice.md)
      - [File Subsystem Changelog](release-notes/changelogs/v4.0-beta2/changelogs-medialibrary.md)
    - OpenHarmony 4.0 Beta1 (Compared with OpenHarmony 3.2 Release)
      - [Ability Framework Changelog](release-notes/changelogs/v4.0-beta1/changelogs-ability.md)
      - [Multi-language Runtime Subsystem Changelog](release-notes/changelogs/v4.0-beta1/changelogs-arkcompiler.md)
      - [ArkUI Subsystem Changelog](release-notes/changelogs/v4.0-beta1/changelogs-arkui.md)
      - [Bundle Manager Changelog](release-notes/changelogs/v4.0-beta1/changelogs-bundlemanager.md)
      - [Common Capability Changelog](release-notes/changelogs/v4.0-beta1/changelogs-common.md)
      - [Globalization Subsystem Changelog](release-notes/changelogs/v4.0-beta1/changelogs-global.md)
      - [HUKS Changelog](release-notes/changelogs/v4.0-beta1/changelogs-huks.md)
      - [Resource Scheduler Subsystem Changelog](release-notes/changelogs/v4.0-beta1/changelogs-resourceschedule.md)
      - [Web Subsystem Changelog](release-notes/changelogs/v4.0-beta1/changelogs-web.md)
    - OpenHarmony 3.2 Release (Compared with OpenHarmony 3.2 Beta5)
      ...
      - [Bundle Manager Subsystem](release-notes/changelogs/v3.2-Release/changelogs-bundlemanager.md)
      ...
      - [Theme Framework Subsystem - Lock Screen](release-notes/changelogs/v3.2-Release/changelogs-screenlock.md)
      ...
      - [Web Subsystem](release-notes/changelogs/v3.2-Release/changelogs-web.md)
    ...
    - OpenHarmony 3.2 Beta4 (Compared with OpenHarmony 3.2 Beta3)
      ...
      - [ArkUI subsystem](release-notes/changelogs/v3.2-beta4/changelogs-arkui.md)
      - [Multimedia subsystem - camera](release-notes/changelogs/v3.2-beta4/changelogs-camera.md)
      - [Device manager](release-notes/changelogs/v3.2-beta4/changelogs-device-manager.md)
      - [USB manager](release-notes/changelogs/v3.2-beta4/changelogs-device-usb.md)
      ...
      - [Common event and nNotification subsystem](release-notes/changelogs/v3.2-beta4/changelogs-notification.md)
