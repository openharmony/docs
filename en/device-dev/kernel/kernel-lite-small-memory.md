...
-   [API Description](#section114001032104317)
...
## API Description<a name="section114001032104317"></a>
...
-   **mmap**
    ...
    **Parameter description:**
    ...
    >For details about the implementation differences between  **mmap**  and Linux function, see  [Differences from the Linux Standard Library](kernel-lite-small-lib-differ.md).
