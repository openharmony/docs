...
static int32_t TestCaseGpioIrqHandler(uint16_t gpio, void *data)
{
    ...
    g_irqCnt++; /* If the IRQ function is triggered, the global interrupt counter is incremented by 1. */
...
static int32_t TestCaseGpioIrqEdge(void)
{
    ...
    /* Wait for the IRQ function to trigger for this pin. The timeout duration is 1000 ms. */
