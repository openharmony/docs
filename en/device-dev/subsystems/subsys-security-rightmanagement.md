...
> 
> Static permission is a permission granted by the system during application installation. The sensitivity level of this type of permission is **system_grant**. Dynamic permission is a permission granted by users during application running. The sensitivity level of this type of permission is **user_grant**.
...
The following table lists the APIs available for application permission management. These APIs can be called only by system applications and services.
