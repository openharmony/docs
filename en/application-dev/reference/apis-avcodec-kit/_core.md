...
Obtains the pointer of an **OH_NativeBuffer** instance. The caller must call [OH_NativeBuffer_Unreference](../native-apis/_o_h___native_buffer.md#oh_nativebuffer_unreference) to manually release the **OH_NativeBuffer** instance returned.
