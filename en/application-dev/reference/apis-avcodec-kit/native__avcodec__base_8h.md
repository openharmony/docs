...
| [OH_AVOutputFormat](_codec_base.md#oh_avoutputformat-1) {<br>AV_OUTPUT_FORMAT_DEFAULT = 0,<br>AV_OUTPUT_FORMAT_MPEG_4 = 2,<br>AV_OUTPUT_FORMAT_M4A = 6,<br>AV_OUTPUT_FORMAT_AMR = 8,<br>AV_OUTPUT_FORMAT_MP3 = 9<br>} | Enumerates the output file formats of a muxer.| 
...
| const char \* [OH_ED_KEY_EOS](_codec_base.md#oh_ed_key_eos) | Pointer to the key that describes the end of stream for the surface buffer. The value type is Boolean. <!--Del-->(This key is not supported yet.)<!--DelEnd-->|
