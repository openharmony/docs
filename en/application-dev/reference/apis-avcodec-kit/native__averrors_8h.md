...
The **native_averrors.h** file declares the error codes used by the media framework.
...
| Name| Description| 
| -------- | -------- |
| typedef enum [OH_AVErrCode](_core.md#oh_averrcode-1) [OH_AVErrCode](_core.md#oh_averrcode) | Defines an enum for the error codes used by the media framework.| 
