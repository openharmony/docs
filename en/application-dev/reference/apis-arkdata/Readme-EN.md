...
- ArkTS APIs 
  ...
  - [@ohos.data.dataSharePredicates (Data Share Predicates)](js-apis-data-dataSharePredicates.md)
  ...
  - [@ohos.application.DataShareExtensionAbility (Data Share ExtensionAbility) (System API)](js-apis-application-dataShareExtensionAbility-sys.md)
  - [@ohos.data.cloudData (Device-Cloud Synergy and Sharing) (System API)](js-apis-data-cloudData-sys.md)
  - [@ohos.data.cloudExtension (Device-Cloud Sharing Extension) (System API)](js-apis-data-cloudExtension-sys.md)
  - [@ohos.data.dataShare (Data Share) (System API)](js-apis-data-dataShare-sys.md)
  - [@ohos.data.dataSharePredicates (Data Share Predicates) (System API)](js-apis-data-dataSharePredicates-sys.md)
  - [@ohos.data.dataShareResultSet (Data Share Result Set) (System API)](js-apis-data-DataShareResultSet-sys.md)
...
- Error Codes
  ...
  - [Data Share Error Codes](errorcode-datashare.md)
