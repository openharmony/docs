...
For details about the error codes, see [Universal Error Codes](../errorcode-universal.md) and [RDB Store Error Codes](errorcode-data-rdb.md). For details about how to handle error code 14800011, see [Database Backup and Restore](../../database/data-backup-and-restore.md).
...
> **NOTE**
>
> To perform data sync operations, the RDB store security level must be lower than or equal to that of the peer device. For details, see the [Cross-Device Data Sync Mechanism](../../database/access-control-by-device-and-data-level.md#access-control-mechanism-in-cross-device-sync).
...
For details about the error codes, see [RDB Error Codes](errorcode-data-rdb.md). For details about how to handle error code 14800011, see [Database Backup and Restore](../../database/data-backup-and-restore.md).
