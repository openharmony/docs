...
| int [OH_UdmfProperty_GetExtrasIntParam](#oh_udmfproperty_getextrasintparam) ([OH_UdmfProperty](#oh_udmfproperty) \*pThis, const char \*key, int defaultValue) | Obtains the integer parameter from an [OH_UdmfProperty](#oh_udmfproperty) instance. |
| const char \* [OH_UdmfProperty_GetExtrasStringParam](#oh_udmfproperty_getextrasstringparam) ([OH_UdmfProperty](#oh_udmfproperty) \*pThis, const char \*key) | Obtains the string parameter from an [OH_UdmfProperty](#oh_udmfproperty) instance. |
...
Obtains the integer parameter from an [OH_UdmfProperty](#oh_udmfproperty) instance.
...
Obtains the string parameter from an [OH_UdmfProperty](#oh_udmfproperty) instance.
