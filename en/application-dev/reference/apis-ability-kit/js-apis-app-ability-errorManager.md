...
Registers an observer for the promise rejection of the main thread. After the registration, a rejected promise that is not captured in the main thread of the application can be captured.
