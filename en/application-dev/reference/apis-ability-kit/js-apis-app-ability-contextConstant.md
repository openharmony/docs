...
Enumerates the process modes. It takes effect only on 2-in-1 devices.
...
Enumerates the visibility statuses of an ability after it is started. It takes effect only on 2-in-1 devices.
