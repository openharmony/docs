...
| [AbilityRuntime_ErrorCode](_ability_runtime.md#abilityruntime_errorcode)  [OH_AbilityRuntime_ApplicationContextGetVersionCode](_ability_runtime.md#oh_abilityruntime_applicationcontextgetversioncode)(int64_t* versionCode) | Obtains the version code of the application. |