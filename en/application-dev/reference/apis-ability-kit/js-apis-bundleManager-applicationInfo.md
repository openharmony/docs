...
| releaseType<sup>12+</sup>    | string    | Yes  | No  | Release type of the SDK used for application packing.<br>**Atomic service API**: This API can be used in atomic services since API version 12. |
...
| Name     | Type          | Readable | Writable | Description                       |
| --------- | -------------- | ---- | ---- | --------------------------- |
| bundleName<sup>12+</sup> | string         | Yes  | No  | Bundle name of the application.                |
| moduleName<sup>12+</sup> | string         | Yes  | No  | Module name of the application. By default, the name of the entry module is returned. If the entry module does not exist, the name of the feature module is returned.           |
| iconId<sup>12+</sup> | number         | Yes  | No  | Icon ID of the application.           |
| labelId<sup>12+</sup> | number         | Yes  | No  | Label ID of the application.           |
