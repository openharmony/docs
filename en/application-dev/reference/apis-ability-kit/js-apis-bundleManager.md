...
| MODULAR_OBJECT | 39 | [modular_object_extension_ability](capi-modular-object-extension-ability-h.md): provides [modular object] extension capability, which can encapsulate an app's own functions into independent functional modules and open them to other apps.<br>**Model restriction:** This API can be used only in the stage model.<br>**Since:** 26.0.0|
