...
| { [OHOS_PIXEL_MAP_SCALE_MODE_FIT_TARGET_SIZE](image.md#pixelmap-scale-modes) = 0,<br>[OHOS_PIXEL_MAP_SCALE_MODE_CENTER_CROP](image.md#pixelmap-scale-modes) = 1 } | Enumerates the PixelMap scale modes.| 
