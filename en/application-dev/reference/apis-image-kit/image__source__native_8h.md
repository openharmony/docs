...
| [Image_ErrorCode](_image___native_module.md#image_errorcode) [OH_DecodingOptions_GetCropRegion](_image___native_module.md#oh_decodingoptions_getcropregion)([OH_DecodingOptions](_image___native_module.md#oh_decodingoptions) *options, [Image_Region](_image___region.md) \*cropRegion) | Obtains the cropping region in the decoding options. |
| [Image_ErrorCode](_image___native_module.md#image_errorcode) [OH_DecodingOptions_SetCropRegion](_image___native_module.md#oh_decodingoptions_setcropregion)([OH_DecodingOptions](_image___native_module.md#oh_decodingoptions) *options, [Image_Region](_image___region.md) \*cropRegion) | Sets the cropping region in the decoding options. |
