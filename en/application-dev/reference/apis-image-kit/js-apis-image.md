...
| ARGB_8888<sup>16+</sup> | 1 | ARGB_8888. Currently, this format supports only PixelMap APIs.|
...
| x<sup>7+</sup>    | number        | No  | No | X coordinate of the region.|
| y<sup>7+</sup>    | number        | No | No | Y coordinate of the region.|
