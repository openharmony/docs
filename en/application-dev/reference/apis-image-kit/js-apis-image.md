...
The Image module provides APIs for image decoding, encoding, editing, processing, and receiving. You can use the APIs to create a **PixelMap** object or read pixels of an image (or even in a region of an image).
...
| Name                | Type                | Mandatory| Description                                    |
| ---------------------- | -------------       | ---- | ---------------------------------------- |
| surfaceId              | string              | Yes  | Surface ID obtained through the [XComponent](../apis-arkui/arkui-ts/ts-basic-components-xcomponent.md).|
...
| Name  | Type                | Mandatory| Description              |
| -------- | -------------------- | ---- | ------------------ |
| targetPixelFormat | [PixelMapFormat](#pixelmapformat7) | Yes  | Target pixel format. Currently, only conversion between NV12/NV21 and RGB888/RGBA8888/RGB565/BGRA8888/RGBAF16 and conversion between YCRCB_P010/YCBCR_P010 and RGBA1010102.|
