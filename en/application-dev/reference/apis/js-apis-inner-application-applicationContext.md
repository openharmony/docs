...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 10. You are advised to use [on(type: 'abilityLifecycleEvent', callback: AbilityLifecycleCallback): **number**](#applicationcontextontype-abilitylifecycleevent-callback-abilitylifecyclecallback10).
...
| Name                  | Type    | Mandatory| Description                          |
| ------------------------ | -------- | ---- | ------------------------------ |
| type | 'abilityLifecycleEvent' | Yes  | Event type.|
| callback | [AbilityLifecycleCallback](js-apis-app-ability-abilityLifecycleCallback.md) | Yes  | Callback used to return the ID of the registered listener.|
...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 10. You are advised to use [off(type: 'abilityLifecycleEvent', callbackId: number): **void**](#applicationcontextofftype-abilitylifecycleevent-callbackid-number10).
...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 10. You are advised to use [on(type: 'environmentEvent', callbackId: number): **number**](#applicationcontextontype-environmentevent-callback-environmentcallback10).
...
| Name                  | Type    | Mandatory| Description                          |
| ------------------------ | -------- | ---- | ------------------------------ |
| type | 'environmentEvent' | Yes  | Event type.|
| callback | [EnvironmentCallback](js-apis-app-ability-environmentCallback.md) | Yes  | Callback used to return the ID of the registered listener.|
...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 10. You are advised to use [off(type: 'environmentEvent', callbackId: number): **void**;](#applicationcontextofftype-environmentevent-callbackid-number10).
