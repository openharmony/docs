...
| --------------------------- | ---- | ----------- |
| TYPE_LOCAL      | 0    | Local device, which can be the built-in speaker or audio jack of the device, or an A2DP device.|
| TYPE_CAST_PLUS_MIRROR      | 1    | Cast+ mirror mode.|
| TYPE_CAST_PLUS_STREAM      | 2    | Cast+ stream mode, indicating that the media asset is being displayed on another device.|
