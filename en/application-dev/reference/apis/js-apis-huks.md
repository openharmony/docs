...
| Name                                        | Value     | Description                                        |
| -------------------------------------------- | ------- | -------------------------------------------- |
| HUKS_TAG_TYPE_INVALID<sup>(deprecated)</sup> | 0 << 28 | Invalid tag type. It is deprecated since API version 9.|
...
| keyAlias | string                 | Yes  | Alias of the key to check.|
| options  | [HuksOptions](#huksoptions) | Yes  | Empty object (leave this parameter empty).|
| callback | AsyncCallback\<boolean> | Yes  | Callback invoked to return the result. The value **TRUE** means the key exists; **FALSE** means the opposite.|
...
| Type             | Description                                   |
| ----------------- | --------------------------------------- |
| Promise\<boolean> | Promise used to return the result. The value **TRUE** means the key exists; **FALSE** means the opposite.|
