...
> **NOTE**<br>
> This enum is supported since API version 8 and deprecated since API version 9. For details, see [Account Management Error Codes](../errorcodes/errorcode-account.md).
...
**Example**
  ...
  export default {
    onConnect(want: Want): rpc.RemoteObject { // The serviceAbility lifecycle function must be placed in serviceAbility.
