...
- Bundle Management 
  ...
  - [@ohos.bundle.distributedBundle (distributedBundle)](js-apis-distributedBundle.md)
...
- Data Management
  ...
  - [@ohos.data.relationalStore (RDB Store)](js-apis-data-rdb.md)
  - [@ohos.data.ValuesBucket (Value Bucket)](js-apis-data-valuesBucket.md)
  - data/rdb
    - [resultSet (Result Set)](js-apis-data-resultset.md)
- File Management
  - [@ohos.environment (Directory Environment Capability)](js-apis-environment.md)
  - [@ohos.data.fileAccess (User File Access and Management)](js-apis-fileAccess.md)
  - [@ohos.fileExtensionInfo (User File Extension Information)](js-apis-fileExtensionInfo.md)
  ...
  - [@ohos.statfs (File System Space Statistics)](js-apis-statfs.md)
