...
| options  | TextDecoderOptions ([DecodeWithStreamOptions<sup>11+</sup>](#decodewithstreamoptions11))| No  | Decoding-related options, which include **fatal** and **ignoreBOM**.|
...
| options | DecodeWithStreamOptions ([TextDecoderOptions<sup>11+</sup>](#textdecoderoptions11))| No| Decoding-related options.|
...
| --------- | -------- | ------------------ |
| read     | number  | Number of characters that have been read.|
| written | number   | Number of bytes that have been written. |
...
| Type      | Description              |
| ---------- | ------------------ |
| EncodeIntoUint8Array objectInfo ([EncodeIntoUint8ArrayInfo<sup>11+</sup>](#encodeintouint8arrayinfo11))| Object obtained. **read** indicates the number of encoded characters, and **write** indicates the number of bytes in the encoded characters.|
