...
Persists the permissions granted to multiple files or folders. This API uses a promise to return the result. 
...
Revokes permissions from multiple files or folders. This API uses a promise to return the result. 
...
Activates the permissions that have been persisted on multiple files or folders. This API uses a promise to return the result. 
