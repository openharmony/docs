...
Starts an ability as the caller. This API uses an asynchronous callback to return the result.
...
Starts an ability as the caller. This API uses a promise to return the result.
