...
| end           | \<time>                                  | 0             | No        | Duration after which the animation ends. <br/>The value can be ms (ms), s (second), or m (minute). The default value is s (second). Other formats are not supported. |
...
| from          | string                                   | -             | No        | Start value of the attribute to which the animation is applied.If the **values** attribute has been set, the **from** attribute is invalid. |
| to            | string                                   | -             | No        | End value of the attribute to which the animation is applied.If the **values** attribute has been set, the **to** attribute is invalid. |
