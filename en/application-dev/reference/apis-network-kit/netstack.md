...
**0** if the operation is successful. For details about the error codes, see [WebSocket Error Codes](errorcode-net-webSocket.md).
...
Pointer to the WebSocket client if the operation is successful; returns NULL otherwise.
