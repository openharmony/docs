...
- must-revalidate: indicates that the response can be cached and can only be reused 
...
| Name  | Type                                   | Mandatory| Description      |
| -------- | --------------------------------------- | ---- | ---------- |
| callback | AsyncCallback\<void\> | Yes  | Callback used to return the result. Return the deletion result.|
