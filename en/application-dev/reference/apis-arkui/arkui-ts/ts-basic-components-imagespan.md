...
As a child of the [Text](ts-basic-components-text.md) and [Component3D](ts-basic-components-containerspan.md) components, the **ImageSpan** component is used to display inline images.
