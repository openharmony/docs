...
Creates a toolbar bound to the component in the window's title bar section. The toolbar position corresponds to the component's position in the layout. The [CustomBuilder](ts-types.md#custombuilder8) must consist of **ToolBarItem** components to take effect.
...
>
>  5. The title bar height dynamically adjusts based on the **ToolBarItem** components in the toolbar:
>     * There is a default 4 vp margin between the **ToolBarItem** components and the title bar.
>     * If the tallest **ToolBarItem** component is less than or equal to 48 vp, the title bar height will adjust to 56 vp. This setting is suitable for universal components such as title bars, toolbars, and search bars.
>     * If the tallest **ToolBarItem** component is between 48 vp and 56 vp, the title bar height will adjust to 64 vp. This setting is suitable for toolbars that display both icons and text.
>     * If the tallest **ToolBarItem** component exceeds 56 vp, the title bar height will adjust to 72 vp. If it exceeds 64 vp, the title bar height will remain at 72 vp, and any excess area will be clipped.
