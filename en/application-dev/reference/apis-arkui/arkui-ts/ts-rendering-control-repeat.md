...
It must be used in a container component. This document provides API parameter descriptions. For details about the development, see [Repeat: Reusing Child Components](../../../ui/state-management/arkts-new-rendering-control-repeat.md).
