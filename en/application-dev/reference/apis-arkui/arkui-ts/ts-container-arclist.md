...
>
> - Child components of **ArcList** whose [visibility](ts-universal-attributes-visibility.md) attribute is set to **Hidden** or **None** are still included in the index calculation. 
