...
Stroke opacity. The value range is [0.0, 1.0]. If the value passed in is less than **0.0**, the opacity is set to **0.0**. If the value passed in is greater than **1.0**, the opacity is set to **1.0**. Any other value is regarded as **1.0**.
...
Stroke width. If of the string type, this parameter cannot be set in percentage. A percentage is processed as 1px.
