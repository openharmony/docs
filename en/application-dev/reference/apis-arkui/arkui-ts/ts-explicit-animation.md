...
| curve      | [Curve](ts-appendix-enums.md#curve) \| [ICurve<sup>9+</sup>](../apis/js-apis-curve.md#icurve) \| string | No| Animation curve.<br>Default value: **Curve.EaseInOut**<br>Since API version 9, this API is supported in ArkTS widgets.|
