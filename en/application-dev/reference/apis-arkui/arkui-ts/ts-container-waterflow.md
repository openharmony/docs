...
Sets the number of items to be cached. This attribute is effective only in [LazyForEach](../../../ui/rendering-control/arkts-rendering-control-lazyforeach.md). After this attribute is set, items that exceed the display and cache range are released.
...
In [LazyForEach](../../../ui/rendering-control/arkts-rendering-control-lazyforeach.md) and [Repeat](../../../ui/rendering-control/arkts-new-rendering-control-repeat.md) with the **virtualScroll** option enabled, water flow items that are outside the display and cache range will be released.
