...
You can set one or more custom keyboard shortcuts for a component. Components can respond to custom keyboard shortcuts even when they are not focused.
...
| TAB<sup>12+</sup>  | Tab key on the keyboard. |
| OPAD_UP<sup>12+</sup>   | Up arrow key on the keyboard. |
| OPAD_DOWN<sup>12+</sup> | Down arrow key on the keyboard. |
| OPAD_LEFT<sup>12+</sup> | Left arrow key on the keyboard. |
| OPAD_RIGHT<sup>12+</sup> | Right arrow key on the keyboard. |
