...
| UP<sup>12+</sup>   | Up arrow key on the keyboard. |
| DOWN<sup>12+</sup> | Down arrow key on the keyboard.|
| LEFT<sup>12+</sup> | Left arrow key on the keyboard.|
| RIGHT<sup>12+</sup> | Right arrow key on the keyboard.|
