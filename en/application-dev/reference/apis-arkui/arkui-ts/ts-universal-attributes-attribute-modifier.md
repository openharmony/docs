...
When unsupported or unimplemented attributes are used, exceptions such as "Method not implemented." or "is not callable" are thrown. The specific scope of supported attributes is the same as the base class attribute API. For details, see [Supported Scope of Attributes](#supported-scope-of-attributes).
...
| bindMenu                 | Not supported  | Method not implemented.   | Attributes that accept a CustomBuilder are not supported.              |
...
| onKeyEventDispatch       | Not supported  | is not callable           | -                                         |
...
| safeAreaPadding          | Not supported   | is not callable          | -                                         |
