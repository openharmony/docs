...
| NODE_LIST_ON_EDIT_MODE_CHANGE = 1003004 | Edit mode status change event of the [List](arkui-ts/ts-container-list.md) component. This event is triggered in the following scenarios:<br>1. NODE_LIST_ENABLE_EDIT_MODE is set to change the edit mode status.<br>2. NODE_LIST_EDIT_MODE_OPTIONS is set to enable two-finger swipe for multi-selection.<br>Registering the event callback is the prerequisite for entering the multi-selection state through two-finger swipe. If the event callback is not registered, two-finger swipe will not enter the multi-selection state.<br>When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br>[ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) contains the following parameter:<br>**ArkUI_NodeComponentEvent.data[0].i32**: edit mode status. The value **0** indicates not to enter the edit mode, and **1** indicates to enter edit mode.<br>**Since**: 26.0.0|
...
| NODE_GRID_ON_EDIT_MODE_CHANGE = 1013009 | Edit mode status change event of the [Grid](arkui-ts/ts-container-grid.md) component. This event is triggered in the following scenarios:<br>1. NODE_GRID_ENABLE_EDIT_MODE is set to change the edit mode status.<br>2. NODE_GRID_EDIT_MODE_OPTIONS is set to enable two-finger swipe for multi-selection.<br>Registering the event callback is the prerequisite for entering the multi-selection state through two-finger swipe. If the event callback is not registered, two-finger swipe will not enter the multi-selection state.<br>When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br>[ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) contains the following parameter:<br>**ArkUI_NodeComponentEvent.data[0].i32**: edit mode status. The value **0** indicates not to enter the edit mode, and **1** indicates to enter edit mode.<br>**Since**: 26.0.0|
