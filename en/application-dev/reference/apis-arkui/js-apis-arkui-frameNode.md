...
Represents a FrameNode of the Button type.
...
Represents a FrameNode of the ListItemGroup type.
...
Represents a FrameNode of the WaterFlow type.
...
Represents a FrameNode of the FlowItem type.
...
| Name | Type                                                  | Mandatory | Description            |
| ------- | ------------------------------------------------------ | ---- | ---------------- |
| from | number | Yes  | Index at which the movement starts. |
| to | number | Yes  | Index at which the movement ends. |
