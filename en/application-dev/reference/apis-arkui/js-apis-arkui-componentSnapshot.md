...
> **NOTE**
> 
> Directly using **componentSnapshot** can lead to the issue of [ambiguous UI context](../../ui/arkts-global-interface.md#ambiguous-ui-context). To avoid this, obtain a [UIContext](js-apis-arkui-UIContext.md#uicontext) instance using the **getUIContext()** API, and then obtain the **componentSnapshot** object bound to that instance through the [getComponentSnapshot](js-apis-arkui-UIContext.md#getcomponentsnapshot12) API.
