...
| OH_NATIVEXCOMPONENT_MOUSE_CANCEL    | Mouse button canceling.|
...
Starts AI image analysis for this XComponent instance created using the [ArkUI NDK API](../../ui/ndk-access-the-arkts-page.md). Before calling this API, make sure the AI image analyzer is enabled.
...
Stops AI image analysis for this XComponent instance created using the [ArkUI NDK API](../../ui/ndk-access-the-arkts-page.md).
