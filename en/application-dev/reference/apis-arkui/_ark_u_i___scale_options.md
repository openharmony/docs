...
| Name| Description| 
| -------- | -------- |
| float [x](#x) | Scale ratio along the x-axis. | 
| float [y](#y) | Scale ratio along the y-axis. | 
| float [z](#z) | Scale factor along the z-axis (not effective for the current 2D graphics). | 
