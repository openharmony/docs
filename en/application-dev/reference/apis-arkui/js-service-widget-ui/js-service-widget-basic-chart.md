...
| gradient    | boolean                                  | false    | No   | Whether to display the gradient color. This parameter is only available for line charts.<br>The default value is **false**, indicating not to display the gradient color.|

  **Table 3** ChartAxis

| Name      | Type           | Default Value     | Mandatory  | Description                                      |
| -------- | ------------- | -------- | ---- | ---------------------------------------- |
| min      | number        | 0        | No   | Minimum value of the axis. Negative numbers are not supported. This parameter is only available for line charts.                     |
| max      | number        | 100      | No   | Maximum value of the axis. Negative numbers are not supported. This parameter is only available for line charts.                     |
...
| textLocation | string        | -        | No   | Available values are as follows:<br>- **"top"**: The description is above the point.<br>-**"bottom"**: The description is below the point.<br>- **"none"**: The description is not displayed.|
