...
Creates an **AnimatorResult** object for animations. Compared with [create](#create9), this API accepts parameters of the [SimpleAnimatorOptions](#simpleanimatoroptions18) type.
