...
If the inference times out, the inference is terminated immediately, the error code **OH_NN_TIMEOUT** is returned through the [NN_OnRunDone](#nn_onrundone) callback.
