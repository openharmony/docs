...
| [oh_value_object.h](oh__value__object_8h.md) | Defines type conversion methods.<br>File to include: <database/rdb/oh_value_object.h><br>Library: libnative_rdb_ndk.z.so<br>|
...
| Name| Description|
| -------- | -------- |
| [OH_ColumnType](#oh_columntype-1) {<br>TYPE_NULL = 0, TYPE_INT64, TYPE_REAL, TYPE_TEXT,<br>TYPE_BLOB<br>} | Enumerates the field types in an RDB store.|
