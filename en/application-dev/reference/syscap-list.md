...
> **NOTE**
>
> The **default** device type represents an OpenHarmony device with comprehensive functionalities and most common capabilities. If you are not sure about the capability set of the target device, you can use the **default** type for development.
