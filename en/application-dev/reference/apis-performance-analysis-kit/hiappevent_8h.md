...
| struct  [HiAppEvent_AppEventGroup](_hi_app_event___app_event_group.md) | Defines event array with the same event name. |
...
| Name| Description|
| -------- | -------- |
| [EventType](_hi_app_event.md#eventtype) { FAULT = 1, STATISTIC = 2, SECURITY = 3, BEHAVIOR = 4 } | Enumerates the event types. |
