...
| Value| Description| 
| -------- | -------- |
| HITRACE_CM_DEFAULT | Unspecified.<br>SysCap:<br>SystemCapability.HiviewDFX.HiTrace<br/>Since<br/>12 | 
| HITRACE_CM_THREAD | Inter-Thread Communication.<br>SysCap:<br>SystemCapability.HiviewDFX.HiTrace<br/>Since<br/>12 | 
| HITRACE_CM_PROCESS | Inter-process communication (IPC).<br>SysCap:<br>SystemCapability.HiviewDFX.HiTrace<br/>Since<br/>12 | 
| HITRACE_CM_DEVICE | Inter-device communication.<br>SysCap:<br>SystemCapability.HiviewDFX.HiTrace<br/>Since<br/>12 | 
