...
>
> For details about how to use HiAppEvent to subscribe to the **APP_FREEZE** event, see [Migrating Application Freeze Events from the Faultlogger API](../../dfx/hiappevent-watcher-freeze-events-arkts.md#migrating-app-freeze-events-from-the-faultlogger-api).
