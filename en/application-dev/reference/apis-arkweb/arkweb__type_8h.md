...
The **arkweb_type.h** file defines the common types of ArkWeb on the native side.
...
| struct&nbsp;&nbsp;[ArkWeb_ControllerAPI](_ark_web___controller_a_p_i.md) | Defines a controller API. |
