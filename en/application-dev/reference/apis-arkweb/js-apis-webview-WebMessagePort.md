...
**WebMessagePort** can be used to send and receive [WebMessageType](./js-apis-webview-e.md#webmessagetype10) or [WebMessage](./js-apis-webview-t.md#webmessage) messages to the HTML5 side.
...
| ------------ | ------ | ---- | ---- | ------------------------------------------------|
| isExtentionType<sup>10+</sup> | boolean | No  | Yes| Whether to use the extended APIs [postMessageEventExt](#postmessageeventext10) and [onMessageEventExt](#onmessageeventext10) when creating a **WebMessagePort**.<br>The value **true** indicates that the extended APIs are used, and the value **false** indicates the opposite.<br>The default value is **false**.  |

## postMessageEvent

postMessageEvent(message: WebMessage): void

Sends a message of the [WebMessage](./js-apis-webview-t.md#webmessage) type to the HTML5 side. The [onMessageEvent](#onmessageevent) API must be invoked first. Otherwise, the message fails to be sent. For details about the sample code, see [postMessage](./js-apis-webview-WebviewController.md#postmessage).
...
| ------- | ------ | ---- | :------------- |
| message | [WebMessage](./js-apis-webview-t.md#webmessage) | Yes  | Message to send.|
...
Registers a callback on the application message port to receive messages of the [WebMessage](./js-apis-webview-t.md#webmessage) type from the HTML5 side. For details about the sample code, see [postMessage](./js-apis-webview-WebviewController.md#postmessage).
...
| Name  | Type    | Mandatory| Description                |
| -------- | -------- | ---- | :------------------- |
| callback | (result: [WebMessage](./js-apis-webview-t.md#webmessage)) => void | Yes  | Message received.|
...
Sends a message of the [WebMessageType](./js-apis-webview-e.md#webmessagetype10) type to the HTML5 side. You must call [onMessageEventExt](#onmessageeventext10) first. Otherwise, the message fails to be sent. For the complete sample code, see [onMessageEventExt](#onmessageeventext10).
...
Registers a callback on the application message port to receive messages of the [WebMessageType](./js-apis-webview-e.md#webmessagetype10) type from the HTML5 side.
...
Closes this message port when messages do not need to be sent. Before calling this method, call [createWebMessagePorts](./js-apis-webview-WebviewController.md#createwebmessageports) to create a message port.
