...
Enumerates the cursor node types for the [getLastHitTest](./js-apis-webview-WebviewController.md#getlasthittest18) API.
...
Enumerates memory pressure levels. When an application clears the cache occupied by the **Web** component, the **Web** kernel releases the cache based on the memory pressure level.
...
Enumerates the data types supported by the [webMessagePort](./js-apis-webview-WebMessagePort.md) API.
...
Enumerates the data types of the results returned after the [runJavaScriptExt](./js-apis-webview-WebviewController.md#runjavascriptext10) API is executed.
...
Enumerates the offline resource types corresponding to the [OfflineResourceMap](./js-apis-webview-i.md#offlineresourcemap12) object.
...
Enumerates the scroll types for [setScrollable](./js-apis-webview-WebviewController.md#setscrollable12).
...
Enumerates the playback statuses of the player, which is an input parameter of the [handleStatusChanged](./js-apis-webview.md#handlestatuschanged12) API.
...
Enumerates the types of media data to be preloaded by the player.
