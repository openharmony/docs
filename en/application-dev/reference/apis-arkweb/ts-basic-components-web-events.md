...
Called to instruct the main application to start downloading a file.
...
| Name               | Type  | Mandatory  | Description                               |
| ------------------ | ------ | ---- | ----------------------------------- |
| callback           | Callback\<[OnDownloadStartEvent](./ts-basic-components-web-i.md#ondownloadstartevent12)\> | Yes   | Callback used when the download starts. |
...
Called when an error occurs during web page loading. The error may occur on the main resource or sub-resource. You can use [isMainFrame](./ts-basic-components-web.md#ismainframe) to determine whether the error occurs on the main resource. For performance reasons, simplify the implementation logic in the callback. This API is called when there is no network connection.
...
| Name    | Type                                    | Mandatory  | Description           |
| ------- | ---------------------------------------- | ---- | --------------- |
| callback | Callback\<[OnErrorReceiveEvent](./ts-basic-components-web-i.md#onerrorreceiveevent12)\> | Yes   | Callback used when an error occurs during web page loading.     |
...
Called when the web page starts to be loaded. This callback is called only for the main frame content, and not for the iframe or frameset content.
...
| Name | Type  | Mandatory  | Description     |
| ---- | ------ | ---- | --------- |
| callback  | Callback\<[OnPageBeginEvent](./ts-basic-components-web-i.md#onpagebeginevent12)\> | Yes   | Callback used when the web page starts to be loaded.|
...
| Name | Type  | Mandatory  | Description     |
| ---- | ------ | ---- | --------- |
| callback  | Callback\<[OnPageEndEvent](./ts-basic-components-web-i.md#onpageendevent12)\> | Yes   | Callback used when the web page loading is complete.|
...
| Name        | Type  | Mandatory  | Description                 |
| ----------- | ------ | ---- | --------------------- |
| callback | Callback\<[OnProgressChangeEvent](./ts-basic-components-web-i.md#onprogresschangeevent12)\> | Yes   | Callback triggered when the page loading progress changes.|
...
| Name        | Type   | Mandatory  | Description                                    |
| ----------- | ------- | ---- | ---------------------------------------- |
| callback         | Callback\<[OnRefreshAccessedHistoryEvent](./ts-basic-components-web-i.md#onrefreshaccessedhistoryevent12)\>  | Yes   | Callback triggered when the access history of the web page is refreshed.               |
...
You can call the bound **webviewController** APIs to restore the web page when this callback is triggered. For example, [refresh](./js-apis-webview-WebviewController.md#refresh) and [loadUrl](./js-apis-webview-WebviewController.md#loadurl).
...
| Name             | Type                                    | Mandatory  | Description            |
| ---------------- | ---------------------------------------- | ---- | ---------------- |
| callback | Callback\<[OnRenderExitedEvent](./ts-basic-components-web-i.md#onrenderexitedevent12)\> | Yes   | Callback triggered when the rendering process exits abnormally.|
...
You can terminate the associated rendering process through [terminateRenderProcess](./js-apis-webview-WebviewController.md#terminaterenderprocess12), which may affect other **Web** components in the same rendering process.
...
| Name  | Type                                                        | Mandatory  | Description                                  |
| -------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| callback | [OnRenderProcessNotRespondingCallback](./ts-basic-components-web-t.md#onrenderprocessnotrespondingcallback12) | Yes   | Callback triggered when the rendering process does not respond.|
...
| Name  | Type                                                        | Mandatory  | Description                                  |
| -------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| callback | [OnRenderProcessRespondingCallback](./ts-basic-components-web-t.md#onrenderprocessrespondingcallback12) | Yes   | Callback triggered when the rendering process transitions back to a normal operating state from an unresponsive state.|
...
| Name         | Type                                    | Mandatory  | Description             |
| ------------ | ---------------------------------------- | ---- | ----------------- |
| callback       | Callback\<[OnShowFileSelectorEvent](./ts-basic-components-web-i.md#onshowfileselectorevent12), boolean\> | Yes   | Callback triggered to notify the **Web** component of the file selection result.<br>Return value: boolean<br> The value **true** means that you can invoke the system-provided popup capability. The value **false** means that the custom pop-up window drawn in the function is ineffective.|
...
Called to notify the **Web** component of the URL of the resource file to load.
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | Callback\<[OnResourceLoadEvent](./ts-basic-components-web-i.md#onresourceloadevent12)\> | Yes| Callback trigger when a URL is loaded.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnInterceptRequestEvent](./ts-basic-components-web-i.md#oninterceptrequestevent12), [WebResourceResponse](./ts-basic-components-web.md#webresourceresponse)\> | Yes| Callback invoked when the **Web** component is about to load a URL.<br>The return value is [WebResourceResponse](./ts-basic-components-web.md#webresourceresponse). If response data is returned, the data is loaded based on the response data. If no response data is returned, null is returned, indicating that the data is loaded in the original mode.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnHttpAuthRequestEvent](./ts-basic-components-web-i.md#onhttpauthrequestevent12), boolean\> | Yes| Callback invoked when the browser requires user credentials.<br>Return value: boolean<br> The value **true** means that the HTTP authentication is successful, and **false** means the opposite.  |
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnSslErrorEventReceiveEvent](./ts-basic-components-web-i.md#onsslerroreventreceiveevent12)\> | Yes| Callback invoked when the web page receives an SSL error.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [OnSslErrorEventCallback](./ts-basic-components-web-t.md#onsslerroreventcallback12) | Yes| Callback invoked when an SSL error occurs during resource loading.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | Callback\<[OnClientAuthenticationEvent](./ts-basic-components-web-i.md#onclientauthenticationevent12)\> | Yes| Callback invoked when an SSL client certificate is required from the user. |
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnPermissionRequestEvent](./ts-basic-components-web-i.md#onpermissionrequestevent12)\> | Yes| Callback invoked when a permission request is received.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | [OnContextMenuHideCallback](./ts-basic-components-web-t.md#oncontextmenuhidecallback11) | Yes| Callback related to menus.    |
...
Called to notify the global scrolling position of the web page.
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback      | Callback\<[OnGeolocationShowEvent](./ts-basic-components-web-i.md#ongeolocationshowevent12)\>  | Yes| Callback invoked when a request to obtain the geolocation information is received.    |
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [OnFullScreenEnterCallback](./ts-basic-components-web-t.md#onfullscreenentercallback12) | Yes| Callback invoked when the **Web** component enters full screen mode.|
...
If the [setWebController](./ts-basic-components-web.md#setwebcontroller9) API is not called, the render process will be blocked.
If no new window is created, set this parameter to **null** when invoking the [setWebController](./ts-basic-components-web.md#setwebcontroller9) API to notify the **Web** component that no new window is created.
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | Callback\<[OnWindowNewEvent](./ts-basic-components-web-i.md#onwindownewevent12)\>           | Yes| Callback invoked when the web page requests the user to create a window.   |
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnSearchResultReceiveEvent](./ts-basic-components-web-i.md#onsearchresultreceiveevent12)\>  | Yes| Callback invoked to notify the caller of the search result on the web page.        |
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnDataResubmittedEvent](./ts-basic-components-web-i.md#ondataresubmittedevent12)\> | Yes| Callback invoked when the web form data can be resubmitted.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | Callback\<[OnPageVisibleEvent](./ts-basic-components-web-i.md#onpagevisibleevent12)\> | Yes| Callback invoked when the old page is not displayed and the new page is about to be visible.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | (event:[KeyEvent](../apis-arkui/arkui-ts/ts-universal-events-key.md#keyevent)) => boolean| Yes| Callback triggered by key events.<br>The return value is of the Boolean type. The value **true** means to pass the **KeyEvent** to the web kernel, and **false** means the opposite.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | Callback\<[OnTouchIconUrlReceivedEvent](./ts-basic-components-web-i.md#ontouchiconurlreceivedevent12)\>  | Yes| Callback invoked when an apple-touch-icon URL is received.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnFaviconReceivedEvent](./ts-basic-components-web-i.md#onfaviconreceivedevent12)\> | Yes| Callback invoked when the current web page receives a new favicon.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnAudioStateChangedEvent](./ts-basic-components-web-i.md#onaudiostatechangedevent12)\> | Yes| Callback invoked when the audio playback status on the web page changes.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback    | Callback\<[OnFirstContentfulPaintEvent](./ts-basic-components-web-i.md#onfirstcontentfulpaintevent12)\> | Yes| Callback invoked when the first content paint occurs on the web page.         |
...
onFirstMeaningfulPaint(callback: [OnFirstMeaningfulPaintCallback](./ts-basic-components-web-t.md#onfirstmeaningfulpaintcallback12))
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [OnFirstMeaningfulPaintCallback](./ts-basic-components-web-t.md#onfirstmeaningfulpaintcallback12) | Yes| Callback invoked when the First Meaningful Paint occurs on the web page.|
...
onLargestContentfulPaint(callback: [OnLargestContentfulPaintCallback](./ts-basic-components-web-t.md#onlargestcontentfulpaintcallback12))
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [OnLargestContentfulPaintCallback](./ts-basic-components-web-t.md#onlargestcontentfulpaintcallback12) | Yes| Callback invoked when the largest content paint occurs on the web page.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnScreenCaptureRequestEvent](./ts-basic-components-web-i.md#onscreencapturerequestevent12)\> | Yes| Callback invoked when a screen capture request is received.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | Callback\<[OnOverScrollEvent](./ts-basic-components-web-i.md#onoverscrollevent12)\> | Yes| Callback invoked when the web page is overscrolled.|
...
The web page has not been loaded when the callback is called. Therefore, APIs related to web page operations, such as [zoomIn](./js-apis-webview-WebviewController.md#zoomin) and [zoomOut](./js-apis-webview-WebviewController.md#zoomout), cannot be used in the callback. You can use APIs irrelevant to web page operations, such as [loadUrl](./js-apis-webview-WebviewController.md#loadurl) and [getWebId](./js-apis-webview-WebviewController.md#getwebid).
...
onNavigationEntryCommitted(callback: [OnNavigationEntryCommittedCallback](./ts-basic-components-web-t.md#onnavigationentrycommittedcallback11))
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | [OnNavigationEntryCommittedCallback](./ts-basic-components-web-t.md#onnavigationentrycommittedcallback11) | Yes| Callback invoked when a web page redirection request is submitted.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback  | [OnSafeBrowsingCheckResultCallback](./ts-basic-components-web-t.md#onsafebrowsingcheckresultcallback11) | Yes| Callback invoked when the safe browsing check result is received.|
...
Called when the lifecycle of the same-layer tag changes.
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | (event: [NativeEmbedDataInfo](./ts-basic-components-web-i.md#nativeembeddatainfo11)) => void | Yes| Callback invoked when the lifecycle of the same-layer tag changes.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | (event: [NativeEmbedTouchInfo](./ts-basic-components-web-i.md#nativeembedtouchinfo11)) => void | Yes| Callback invoked when a finger touches a same-layer tag.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback    | [OnIntelligentTrackingPreventionCallback](./ts-basic-components-web-t.md#onintelligenttrackingpreventioncallback12) | Yes| Callback invoked when the intelligent tracking prevention feature is enabled and the tracker cookie is blocked.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [OnViewportFitChangedCallback](./ts-basic-components-web-t.md#onviewportfitchangedcallback12) | Yes| Callback invoked when the **viewport-fit** configuration in the web page's **meta** tag changes.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback | [WebKeyboardCallback](./ts-basic-components-web-t.md#webkeyboardcallback12) | Yes| Callback invoked for intercepting the soft keyboard invoking in the web page.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | [OnNativeEmbedVisibilityChangeCallback](./ts-basic-components-web-t.md#onnativeembedvisibilitychangecallback12) | Yes| Callback invoked when the visibility of a same-layer tag changes.|
