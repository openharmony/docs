...
> Only one object can be registered through this API. To register multiple objects, use [registerJavaScriptProxy<sup>9+</sup>](./js-apis-webview-WebviewController.md#registerjavascriptproxy).
...
| Name       | Type                                    | Mandatory  | Description                                    |
| ---------- | ---------------------------------------- | ---- |---------------------------------------- |
| javaScriptProxy     | [JavaScriptProxy](./ts-basic-components-web-i.md#javascriptproxy12)                                   | Yes   |  Object to be registered. Methods can be declared, but attributes cannot.                  |
...
| Name | Type                                   | Mandatory  | Description              |
| ---- | --------------------------------------- | ---- | ------------------ |
| mode | [OverScrollMode](./ts-basic-components-web-e.md#overscrollmode11) | Yes   | Whether to enable overscroll mode.<br>The default value is **OverScrollMode.NEVER**, meaning to disable overscroll mode.|
...
| Name      | Type                       | Mandatory  | Description     |
| --------- | --------------------------- | ---- | --------- |
| mixedMode | [MixedMode](./ts-basic-components-web-e.md#mixedmode) | Yes   | Mixed content to load.<br>The default value is **MixedMode.None**, indicating that the secure origin cannot load resources from an insecure origin.|
...
Enabling the multi-window permission requires implementation of the **onWindowNew** event. For the sample code, see [onWindowNew](./ts-basic-components-web-events.md#onwindownew9).
...
> **NOTE**
>
> - If an @State decorated variable is used to control the horizontal scrollbar visibility, [controller.refresh()](./js-apis-webview-WebviewController.md#refresh) must be called for the settings to take effect.
...
| Name      | Type                       | Mandatory  | Description     |
| --------- | --------------------------- | ---- | --------- |
| cacheMode | [CacheMode](./ts-basic-components-web-e.md#cachemode) | Yes   | Cache mode to set.<br>Default value: **CacheMode.Default**|
...
| Name | Type  | Mandatory  | Description                                    |
| ---- | ------ | ---- | ---------------------------------------- |
| size | number | Yes   | Default fixed font size to set, in px.<br>The value ranges from -2^31 to 2^31-1. In actual rendering, values greater than 72 are handled as 72, and values less than 1 are handled as 1.<br>Default value: **13**|
...
| Name | Type  | Mandatory  | Description                                    |
| ---- | ------ | ---- | ---------------------------------------- |
| size | number | Yes   | Default font size to set, in px.<br>The value ranges from -2^31 to 2^31-1. In actual rendering, values greater than 72 are handled as 72, and values less than 1 are handled as 1.<br>Default value: **16**|
...
| Name | Type  | Mandatory  | Description                                    |
| ---- | ------ | ---- | ---------------------------------------- |
| size | number | Yes   | Minimum font size to set, in px.<br>The value ranges from -2^31 to 2^31-1. In actual rendering, values greater than 72 are handled as 72, and values less than 1 are handled as 1.<br>Default value: **8**|
...
| Name | Type  | Mandatory  | Description                                    |
| ---- | ------ | ---- | ---------------------------------------- |
| size | number | Yes   | Minimum logical font size to set, in px.<br>The value ranges from -2^31 to 2^31-1. In actual rendering, values greater than 72 are handled as 72, and values less than 1 are handled as 1.<br>Default value: **8**|
...
| Name   | Type  | Mandatory  | Description                    |
| ------ | ------ | ---- | ------------------------ |
| family | string | Yes   | Sets the cursive font family for the web page.<br>Default value: **cursive**|
...
Sets the web dark mode. When it is enabled, the **Web** component enables the dark mode defined in the media query **prefers-color-scheme** of the web page. If it is not defined, the web page remains unchanged. To enable the forcible dark mode, use this API with [forceDarkAccess](#forcedarkaccess9). For details about how to use the dark mode, see [Setting the Dark Mode](../../web/web-set-dark-mode.md).
...
| Name | Type                            | Mandatory  | Description                    |
| ---- | -------------------------------- | ---- | ------------------------ |
| mode | [WebDarkMode](./ts-basic-components-web-e.md#webdarkmode9) | Yes   | Web dark mode to set.<br>Default value: **WebDarkMode.Off**|
...
Sets whether to enable forcible dark mode for the web page. This API is applicable only when dark mode is enabled in [darkMode](#darkmode9).
...
| Name | Type   | Mandatory   | Description                     |
| ---- | ------- | ---- | ------------------------- |
| flag | boolean | Yes   | <br>Whether to allow a new window to automatically open through JavaScript. The value **true** means to allow a new window to automatically open through JavaScript, and **false** means to allow a new window to automatically open through JavaScript using user behaviors, but not non-user behaviors.<br>The user behavior here refers to that a user requests to open a new window (**window.open**) within 5 seconds after operating the **Web** component.<br>The default value of **flag** is subject to the settings of the **persist.web.allowWindowOpenMethod.enabled** system attribute. If this attribute is set to true, the default value of **flag** is **true**. If this attribute is not set, the default value of **flag** is **false**.|
...
> - You are advised to set [audioExclusive](./ts-basic-components-web-i.md#webmediaoptions10) to the same value for all **Web** components.
...
| Name    | Type                                 | Mandatory  | Description                                    |
| ------- | ------------------------------------- | ---- | ---------------------------------------- |
| options | [WebMediaOptions](./ts-basic-components-web-i.md#webmediaoptions10) | Yes   | Web-based media playback policy.<br>After the parameter settings are updated, the playback must be started again for the settings to take effect.<br>Default value: **{resumeInterval: 0, audioExclusive: true}**|
...
| Name    | Type                               | Mandatory  | Description              |
| ------- | ----------------------------------- | ---- | ------------------ |
| scripts | Array\<[ScriptItem](./ts-basic-components-web-i.md#scriptitem11)> | Yes   | Script item array to be injected.|
...
| Name | Type                                 | Mandatory  | Description                 |
| ---- | ------------------------------------- | ---- | --------------------- |
| mode | [WebLayoutMode](./ts-basic-components-web-e.md#weblayoutmode11) | Yes   | Web layout mode.<br>Default value: **WebLayoutMode.NONE**|
...
**Example**
  ...
  <head>
      ...
      <style>
          ...
          line-height: 200px;       /* Vertically centered (the value is equal to the container height) */
          }
      </style>
  </head>
  <body>
...
> - The **viewport** property of the **meta** tag on the frontend HTML page is enabled or disabled based on whether **User-Agent** contains the **Mobile** field. If a **User-Agent** does not contain the **Mobile** field, the **viewport** property in the **meta** tag is disabled by default. In this case, you can explicitly set the **metaViewport** property to **true** to overwrite the disabled state.
...
| Name| Type| Mandatory| Description                        |
| ------ | -------- | ---- | -------------------------------- |
| enabled | boolean  | Yes  | Whether the **viewport** property of the **meta** tag is enabled.<br>The value **true** indicates that the **viewport** property of the **meta** tag is enabled, the viewport property is parsed, and the layout is performed based on the **viewport** property.<br>The value **false** indicates the **viewport** property of the **meta** tag is disabled, the **viewport** property is not parsed, and the default layout is used.<br>The default value is **true**.|
...
| Name | Type  | Mandatory  | Description                                    |
| ---- | ------ | ---- | ---------------------------------------- |
| textAutosizing | boolean | Yes   | Whether to enable automatic text resizing.<br>The value **true** means to enable automatic text resizing, and **false** means the opposite.<br>The default value is **true**.|
...
| Name   | Type  | Mandatory  | Description                 |
| ------ | ------ | ---- | --------------------- |
| callback       | [OnAdsBlockedCallback](./ts-basic-components-web-t.md#onadsblockedcallback12) | Yes| Callback for **onAdsBlocked**.|
...
Sets whether to enable haptic feedback for long-pressing text in the **Web** component. The **ohos.permission.VIBRATE** permission must be declared.
...
| Name      | Type                            | Mandatory| Description                               |
| ------------ | ------------------------------- | ---- | ----------------------------------- |
| elementType     | [WebElementType](./ts-basic-components-web-e.md#webelementtype13)             | Yes  | Menu type.  |
| content      | [CustomBuilder](../apis-arkui/arkui-ts/ts-types.md#custombuilder8)     | Yes  | Menu content.  |
| responseType | [WebResponseType](./ts-basic-components-web-e.md#webresponsetype13)           | Yes  | Response type of the menu.|
| options      | [SelectionMenuOptionsExt](./ts-basic-components-web-i.md#selectionmenuoptionsext13)   | No  | Menu options.|
...
Sets whether to enable the blur mode of the **Web** component when the soft keyboard is hidden.
...
| Name | Type                                   | Mandatory  | Description              |
| ---- | --------------------------------------- | ---- | ------------------ |
| mode | [BlurOnKeyboardHideMode](./ts-basic-components-web-e.md#bluronkeyboardhidemode14) | Yes   | Whether to enable the blur mode of the **Web** component when the soft keyboard is hidden. The default value is **BlurOnKeyboardHideMode.SILENT**.|
...
| Name | Type| Mandatory| Description          |
| ------- | -------- | ---- | ------------------ |
| enabled | boolean  | Yes  | Whether to support an application to connect to media controller.<br>The value **true** means to support an application to connect to media controller, and **false** means the opposite.<br>The default value is **true**.|
...
| Name      | Type                            | Mandatory| Description                               |
| ------------ | ------------------------------- | ---- | ----------------------------------- |
| options | [EmbedOptions](./ts-basic-components-web-i.md#embedoptions16) | No   | Same-layer rendering configuration. The default value is **{supportDefaultIntrinsicSize: false}**.|
...
> **NOTE**
>
> This API is supported since API version 8 and deprecated since API version 10. You are advised to use [setCustomUserAgent](./js-apis-webview-WebviewController.md#setcustomuseragent10)<sup>10+</sup> instead.
