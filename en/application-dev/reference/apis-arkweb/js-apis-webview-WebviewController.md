...
The **WebviewController** object controls various behaviors of **Web** components, including page navigation, declaration period status, and JavaScript interaction. A **WebviewController** object can control only one **Web** component, and the APIs (except static APIs) in the **WebviewController** can be invoked only after it has been bound to the target **Web** component.
...
>
> After the **Web** component is destroyed, **WebViewController** is unbound, and exception 17100001 will be thrown when the non-static method of **WebViewController** is called. You need to pay attention to the calling time and capture exceptions to prevent abnormal process exit.
...
| Name             | Type   | Mandatory  |  Description|
| ------------------ | ------- | ---- | ------------- |
| secureDnsMode         |   [SecureDnsMode](./js-apis-webview-e.md#securednsmode10)   | Yes  | Mode in which HTTPDNS is used.|
...
| Name             | Type   | Mandatory  |  Description|
| ------------------ | ------- | ---- | ------------- |
| webDebuggingAccess | boolean | Yes  | Whether to enable web debugging.<br>The value **true** indicates that web debugging is enabled. The value **false** indicates the opposite .<br>The default value is **false**.|
...
2. Use the resource protocol, which can be used by WebView to load links with a hash (#).
```ts
// xxx.ets
import { webview } from '@kit.ArkWeb';
import { BusinessError } from '@kit.BasicServicesKit';
...
| callback | AsyncCallback\<[JsMessageExt](./js-apis-webview.md#jsmessageext10)\> | Yes  | Callback used to return the result.|
...
| Type           | Description                                               |
| --------------- | --------------------------------------------------- |
| Promise\<[JsMessageExt](./js-apis-webview.md#jsmessageext10)> | Promise used to return the script execution result.|
...
Zooms in or out of this web page. This API is effective only when [zoomAccess](ts-basic-components-web-attributes.md#zoomaccess) is **true**.
...
Searches the web page for content that matches the keyword specified by **'searchString'** and highlights the matches on the page. This API returns the result asynchronously through [onSearchResultReceive](./ts-basic-components-web-events.md#onsearchresultreceive9).
...
| Name| Type                  | Mandatory| Description                            |
| ------ | ---------------------- | ---- | :------------------------------|
| isExtentionType<sup>10+</sup>   | boolean     | No | Whether to use the extended interface.<br>The value **true** indicates that the extended interface is used, and the value **false** indicates the opposite.<br>The default value is **false**.|

**Return value**

| Type                  | Description             |
| ---------------------- | ----------------- |
| Array\<[WebMessagePort](./js-apis-webview-WebMessagePort.md)> | List of web message ports.|
...
For details about the sample code, see [onMessageEventExt](./js-apis-webview-WebMessagePort.md#onmessageeventext10).
...
| ports  | Array\<[WebMessagePort](./js-apis-webview-WebMessagePort.md)> | Yes  | Message ports for sending the message.           |
...
| Type   | Description                                    |
| ------- | --------------------------------------- |
| boolean | Whether the current web page can be scrolled. The value **true** indicates that the current web page can be scrolled, and the value **false** indicates the opposite.<br>The default value is **false**.|
...
| Name| Type   | Mandatory| Description                             |
| ------ | ------- | ---- | --------------------------------- |
| enable | boolean | Yes  | Whether the **window.navigator.onLine** attribute is enabled.<br>The value **true** indicates that the **window.navigator.onLine** attribute is enabled, and the value **false** indicates the opposite.<br>The default value is **true**.|
...
> **NOTE**
>
> [onLoadIntercept](./ts-basic-components-web-events.md#onloadintercept10) is triggered when the loading starts. At this time, no historical node is generated. Therefore, the historical stack obtained by calling **getBackForwardEntries** in **onLoadIntercept** does not include the page that is being loaded.
...
| Type                               | Description                       |
| ----------------------------------- | --------------------------- |
| [BackForwardList](./js-apis-webview-BackForwardList.md) | Provides the historical information list of the current webview.|
...
Grants the cross-domain request and fetch request permissions for the specified URL schemes (also known as protocols) to the web kernel. A cross-domain fetch request for any of the specified URL schemes can be intercepted by the [onInterceptRequest](./ts-basic-components-web-events.md#oninterceptrequest9) API, so that you can further process the request. It is recommended that this API be called before any **Web** component is initialized.
...
| Name  | Type   | Mandatory| Description                     |
| -------- | ------- | ---- | -------------------------------------- |
| schemes | Array\<[WebCustomScheme](./js-apis-webview-i.md#webcustomscheme)\> | Yes  | Array of up to 10 custom schemes.|
...
| Name            | Type                            |  Mandatory | Description                                                             |
| ------------------| ------------------------------- | ---- | ------------------------------------------------------------------ |
| request           | [RequestInfo](./js-apis-webview-i.md#requestinfo12)   | Yes  | Information about the prefetched request.                                                     |
| additionalHeaders | Array\<[WebHeader](./js-apis-webview-i.md#webheader)> | No  | Additional HTTP request header of the prefetched request.                                            |
...
| Name         | Type   |  Mandatory | Description                                           |
| ---------------| ------- | ---- | ------------- |
| delegate      | [WebDownloadDelegate](./js-apis-webview.md#webdownloaddelegate11)  | Yes  | Delegate used to receive the download progress.|
...
| Name  | Type   |  Mandatory | Description                      |
| --------| ------- | ---- | ---------------------------|
|  enable | boolean | Yes  | Whether to enable the safe browsing feature.<br>The value **true** means to enable the safe browsing feature, and **false** means the opposite.<br>The default value is **false**.|
...
| Type   | Description                                    |
| ------- | --------------------------------------- |
| boolean | Whether the safe browsing feature is enabled for this web page.<br>The value **true** indicates that the safe browsing feature is enabled, and **false** indicates the opposite.<br>The default value is **false**.|
...
| Name  | Type   |  Mandatory | Description                      |
| --------| ------- | ---- | ---------------------------|
|  enable | boolean | Yes  | Whether to enable intelligent tracking prevention.<br>The value **true** means to enable intelligent tracking prevention, and **false** means the opposite.<br>The default value is **false**.|
...
| Type   | Description                                    |
| ------- | --------------------------------------- |
| boolean | Whether intelligent tracking prevention is enabled on this web page.<br>The value **true** indicates that intelligent tracking prevention is enabled, and **false** indicates the opposite.<br>The default value is **false**.|
...
| Name  | Type   |  Mandatory | Description                      |
| --------| ------- | ---- | ---------------------------|
|  enable | boolean | Yes  | Whether to enable ad blocking.<br>The value **true** means to enable ad blocking, and **false** means the opposite.<br>The default value is **false**.|
...
| Type                                                        | Description                  |
| ------------------------------------------------------------ | ---------------------- |
| boolean | Returns **true** if ad blocking is enabled; returns **false** otherwise.<br>The default value is **false**.|
...
After ads blocking is enabled for the **Web** component, this feature is enabled for all web pages by default. You can call [addAdsBlockDisallowedList](./js-apis-webview.md#addadsblockdisallowedlist12) to disable the feature for specific domains.
...
Checks whether incognito mode is enabled for WebView.
...
| Type                | Description                     |
| -------------------- | ------------------------- |
| boolean              | Whether incognito mode is enabled for WebView.<br>The value **true** indicates that incognito mode is enabled for WebView, and **false** indicates the opposite.<br>The default value is **false**.|
...
| Type                               | Description                       |
| ----------------------------------- | --------------------------- |
| [SecurityLevel](./js-apis-webview-e.md#securitylevel11) | Security level of the web page. The value can be **NONE**, **SECURE**, **WARNING**, or **DANGEROUS**.|
...
Obtains the URL of the last frame from which the JavaScript proxy object was called. You can inject a JavaScript object into the window object using APIs like [registerJavaScriptProxy](#registerjavascriptproxy) or [javaScriptProxy](./ts-basic-components-web-attributes.md#javascriptproxy). This API can be used to obtain the URL of the frame of the object that is injected last time.
...
| Type                                       | Description                                                     |
| ------------------------------------------- | --------------------------------------------------------- |
| [MediaPlaybackState](./js-apis-webview-e.md#mediaplaybackstate12) | Playback control status of the current web page. The options are **NONE**, **PLAYING**, **PAUSED**, and **STOPPED**.|
...
Sets the [WebSchemeHandler](./js-apis-webview.md#webschemehandler12) class for the current **Web** component. This class is used to intercept requests of a specified scheme.
...
| handler    | [WebSchemeHandler](./js-apis-webview.md#webschemehandler12) | Yes  | Interceptor that intercepts this protocol.|
...
| cacheOptions | [CacheOptions](./js-apis-webview-i.md#cacheoptions12) | Yes  | Whether to update the bytecode cache.     |
...
Called when the [application takes over media playback on the web page](./ts-basic-components-web-attributes.md#enablenativemediaplayer12) and media is played on the web page.
...
| Name| Type| Mandatory| Description|
|--------|------|------|------|
| callback | [CreateNativeMediaPlayerCallback](./js-apis-webview.md#createnativemediaplayercallback12) | Yes| Callback when the application takes over media playback on the web page.|
...
| Name | Type   | Mandatory| Description                 |
| ------- | ------ | ---- | :-------------------- |
| resourceMaps | Array\<[OfflineResourceMap](./js-apis-webview-i.md#offlineresourcemap12)\> | Yes  | Configuration object for local offline resources. A maximum of 30 resources can be injected in a single call, with a maximum size of 10 MB per individual resource.     |
...
If a path in the list is not of the preceding paths, error code 401 is reported and the path list fails to be set. When the path list is set to empty, the accessible files for the file protocol are subject to the behavior of the [fileAccess](./ts-basic-components-web-attributes.md#fileaccess).
...
| Name         | Type   |  Mandatory | Description                                           |
| ---------------| ------- | ---- | ------------- |
| features     |  [BackForwardCacheSupportedFeatures](./js-apis-webview.md#backforwardcachesupportedfeatures12) | Yes  | Features of the pages, which allow them to be added to the back-forward cache.|
...
| Name         | Type   |  Mandatory | Description                                           |
| ---------------| ------- | ---- | ------------- |
| options     |  [BackForwardCacheOptions](./js-apis-webview.md#backforwardcacheoptions12) | Yes  | Options to control the back-forward cache of the **Web** component.|
...
| Name | Type   | Mandatory| Description                 |
| ------- | ------ | ---- | :-------------------- |
| level | [PressureLevel](./js-apis-webview-e.md#pressurelevel14) | Yes| Pressure level of the memory to be cleared.|
...
| Name       | Type                                   | Mandatory| Description                   |
| ------------- | --------------------------------------- | ---- | ----------------------- |
| configuration | [PdfConfiguration](./js-apis-webview-i.md#pdfconfiguration14) | Yes  | Parameters required for creating a PDF file.      |
| callback      | AsyncCallback<[PdfData](./js-apis-webview.md#pdfdata14)>    | Yes  | Callback used to return the data stream of an online PDF file.|
...
| Type                          | Description                         |
| ------------------------------ | ----------------------------- |
| Promise<[PdfData](./js-apis-webview.md#pdfdata14)> | Promise used to return the data stream of a web page.|
...
| Type        | Description                |
| ------------ | -------------------- |
| [HitTestValue](./js-apis-webview-i.md#hittestvalue) | Element information of the area being clicked.|
...
| Type                                                        | Description                  |
| ------------------------------------------------------------ | ---------------------- |
| [WebHitTestType](./js-apis-webview-e.md#webhittesttype)| Element type of the area being clicked.|
