...
Enumerates the states of the profile connection between the local and peer Bluetooth devices.
...
| Name                 | Value | Description            |
| ------------------- | ---- | -------------- |
| STATE_DISCONNECTED  | 0    | The profile connection is disconnected. |
| STATE_CONNECTING    | 1    | The profile connection is being established.|
| STATE_CONNECTED     | 2    | The profile connection is established. |
| STATE_DISCONNECTING | 3    | The profile connection is being disconnected.|
...
| Name                 | Value   | Description        |
| ------------------- | ------ | ---------- |
| MAJOR_MISC          | 0x0000 | Miscellaneous device, which that does not belong to any standard category.   |
| MAJOR_COMPUTER      | 0x0100 | Computer.  |
| MAJOR_PHONE         | 0x0200 | Mobile phone.   |
| MAJOR_NETWORKING    | 0x0300 | LAN or network access point.   |
...
| WEARABLE_JACKET                          | 0x070C | Wearable jacket.     |
...
| Name                                  | Value   | Description             |
| ------------------------------------| ------ | --------------- |
| PROFILE_UUID_HFP_AG      | '0000111F-0000-1000-8000-00805F9B34FB' | Hands-free audio gateway profile.|
| PROFILE_UUID_HFP_HF      | '0000111E-0000-1000-8000-00805F9B34FB' | Hands-free profile. |
| PROFILE_UUID_HSP_AG      | '00001112-0000-1000-8000-00805F9B34FB' | Headset audio gateway profile. |
| PROFILE_UUID_HSP_HS      | '00001108-0000-1000-8000-00805F9B34FB' | Headset profile. |
| PROFILE_UUID_A2DP_SRC    | '0000110A-0000-1000-8000-00805F9B34FB' | A2DP source profile. |
| PROFILE_UUID_A2DP_SINK   | '0000110B-0000-1000-8000-00805F9B34FB' | A2DP sink profile. |
| PROFILE_UUID_AVRCP_CT    | '0000110E-0000-1000-8000-00805F9B34FB' | AVRCP controller profile. |
| PROFILE_UUID_AVRCP_TG    | '0000110C-0000-1000-8000-00805F9B34FB' | AVRCP target profile. |
| PROFILE_UUID_HID         | '00001124-0000-1000-8000-00805F9B34FB' | HID profile. |
| PROFILE_UUID_HOGP        | '00001812-0000-1000-8000-00805F9B34FB' | HID over GATT profile. |