...
> - This topic describes only the system APIs provided by the module. For details about its public APIs, see [@ohos.bluetooth.map (Bluetooth MA Module)](js-apis-bluetooth-map.md).
