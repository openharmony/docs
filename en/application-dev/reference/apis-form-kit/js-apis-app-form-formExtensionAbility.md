...
This lifecycle callback is triggered only when the configuration is updated while the formExtensionAbility is alive. Note that the formExtensionAbility is cleared after 10 seconds of inactivity.
