...
| Name| Description|
| -------- | -------- |
| [OH_NNModel](_neural_network_runtime.md#oh_nnmodel) | Model handle.|
| [OH_NNCompilation](_neural_network_runtime.md#oh_nncompilation) | Compiler handle.|
| [OH_NNExecutor](_neural_network_runtime.md#oh_nnexecutor) | Executor handle.|
| [NN_QuantParam](_neural_network_runtime.md#nn_quantparam) | Quantization parameter handle.|
| [NN_TensorDesc](_neural_network_runtime.md#nn_tensordesc) | Tensor description handle.|
| [NN_Tensor](_neural_network_runtime.md#nn_tensor) | Tensor handle.|
| (\*[NN_OnRunDone](_neural_network_runtime.md#nn_onrundone)) (void \*userData, [OH_NN_ReturnCode](_neural_network_runtime.md#oh_nn_returncode) errCode, void \*outputTensor[], int32_t outputCount) | Handle of the callback processing function invoked when the asynchronous inference ends.|
| (\*[NN_OnServiceDied](_neural_network_runtime.md#nn_onservicedied)) (void \*userData) | Handle of the callback processing function invoked when the device driver service terminates unexpectedly during asynchronous inference.|
| [OH_NN_UInt32Array](_neural_network_runtime.md#oh_nn_uint32array) | Used to store a 32-bit unsigned integer array.|
| [OH_NN_QuantParam](_neural_network_runtime.md#oh_nn_quantparamdeprecated) | Used to define the quantization information.|
| [OH_NN_Tensor](_neural_network_runtime.md#oh_nn_tensordeprecated) | Used to define the tensor structure.|
| [OH_NN_Memory](_neural_network_runtime.md#oh_nn_memorydeprecated) | Used to define the memory structure.|
