...
| SET_SWAP_INTERVAL | Setting the swap interval for the local window buffer.<br>Variable argument in the function: [Input] int32_t interval.<br>This API is deprecated since API version 14. No substitute API is provided.|
| GET_SWAP_INTERVAL | Obtaining the swap interval of the local window buffer.<br>Variable argument in the function: [Output] int32_t \*interval.<br>This API is deprecated since API version 14. No substitute API is provided. |
