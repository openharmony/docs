...
| typedef struct [OH_Drawing_Filter](_drawing.md#oh_drawing_filter)  [OH_Drawing_Filter](_drawing.md#oh_drawing_filter) | Defines a struct for a filter, which consists of a color filter and mask filter.|
...
| [OH_Drawing_AlphaFormat](_drawing.md#oh_drawing_alphaformat) { ALPHA_FORMAT_UNKNOWN, ALPHA_FORMAT_OPAQUE, [ALPHA_FORMAT_PREMUL](_drawing.md), ALPHA_FORMAT_UNPREMUL } | Enumerates the alpha formats of bitmap pixels.|
