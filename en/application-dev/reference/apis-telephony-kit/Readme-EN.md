...
- ArkTS API<!--telephony-arkts-->
  ...
  - [@ohos.telephony.observer (Telephony Status Observer)](js-apis-observer.md)
  ...
  - [@ohos.telephony.observer (Telephony Status Observer) (System API)](js-apis-observer-sys.md)
