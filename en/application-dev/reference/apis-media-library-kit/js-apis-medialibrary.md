...
media.on('imageChange', () => {
  // The image file is changed. Do something.
});
```
...
> - Since the SDK of API version 10, **relativePath** is no longer associated with an album. After a file is created, the last-level directory of **relativePath** is not displayed.
...
> - This API is deprecated since API version 9. Use [save](../apis-core-file-kit/js-apis-file-picker.md#save-1) instead.
...
>
> - This API is supported since API version 6 and can be used only in the FA model.
> - This API is deprecated since API version 9. Use [save](../apis-core-file-kit/js-apis-file-picker.md#save) instead.
...
>
> - This API is supported since API version 6 and can be used only in the FA model.
> - This API is deprecated since API version 9. Use the [\<Image>](../apis-arkui/arkui-ts/ts-basic-components-image.md) component instead.<br>The **\<Image>** component can be used to render and display local and online images.
...
>
> - This API is supported since API version 6 and can be used only in the FA model.
> - This API is deprecated since API version 9. Use [select](../apis-core-file-kit/js-apis-file-picker.md#select-1) instead.
...
>
> - This API is supported since API version 6 and can be used only in the FA model.
> - This API is deprecated since API version 9. Use [select](../apis-core-file-kit/js-apis-file-picker.md#select) instead.
...
> - If a file is opened in 'w' mode, the returned file descriptor (FD) cannot be used to read the file. However, due to the implementation differences of file systems, some user-mode files opened in 'w' mode can be read by using FD. To perform the read or write operation on a file by using FD, you are advised to open the file in 'rw' mode. The write operations are mutually exclusive. After a write operation is complete, you must use **close** to close the file.
...
> - If a file is opened in 'w' mode, the returned FD cannot be used to read the file. However, due to the implementation differences of file systems, some user-mode files opened in 'w' mode can be read by using FD. To perform the read or write operation on a file by using FD, you are advised to open the file in 'rw' mode. The write operations are mutually exclusive. After a write operation is complete, you must use **close** to close the file.
...
> **NOTE**
>
> This API is deprecated since API version 9. Use [image.Size](../apis-image-kit/js-apis-image.md#size) instead.
