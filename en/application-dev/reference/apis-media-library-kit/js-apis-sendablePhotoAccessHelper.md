...
| Name | Type                                                     | Mandatory| Description                |
| ------- | --------------------------------------------------------- | ---- | -------------------- |
| options | [photoAccessHelper.FetchOptions](js-apis-photoAccessHelper.md#fetchoptions) | Yes  | Retrieval options.|
...
| options | [photoAccessHelper.FetchOptions](js-apis-photoAccessHelper.md#fetchoptions) | No  | Retrieval options. If this parameter is not specified, the albums are obtained based on the album type by default.|
...
| Type                        | Description                                                        |
| ---------------------------- | ------------------------------------------------------------ |
| photoAccessHelper.PhotoAsset | [PhotoAsset](js-apis-photoAccessHelper.md#photoasset) of the non-Sendable type.|
...
| Name | Type                                                     | Mandatory| Description      |
| ------- | --------------------------------------------------------- | ---- | ---------- |
| options | [FetchOptions](js-apis-photoAccessHelper.md#fetchoptions) | Yes  | Retrieval options.|
