...
| level                | [SlotLevel](../apis-notification-kit/js-apis-notification.md#slotlevel)                | No | Notification level. If this parameter is not set, the default value that corresponds to the notification slot type is used.|
