...
| -- | -- |
| const [Asset_Attr](capi-asset-attr.md) *attributes | Attributes of the asset to add.|
...
| Parameter| Description|
| -- | -- |
| const [Asset_Attr](capi-asset-attr.md) *query | Attributes of the asset to remove.|
...
| Parameter| Description|
| -- | -- |
| const [Asset_Attr](capi-asset-attr.md) *query | Attributes of the asset to update.|
| uint32_t queryCnt | Number of attributes to update.|
| const [Asset_Attr](capi-asset-attr.md) *attributesToUpdate | New attributes of the asset.|
...
| uint32_t queryCnt | Number of attributes.|
| [Asset_Blob](capi-asset-blob.md) *challenge | Challenge value, which is used when **OH_Asset_Query** is called.|
