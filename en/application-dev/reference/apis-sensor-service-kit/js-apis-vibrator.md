...
| Name | Type                               | Mandatory| Description                                                        |
| ------- | ----------------------------------- | ---- | ------------------------------------------------------------ |
| time    | number                              | Yes  | Start time of the long vibration. The value range is (0,1800000).|
...
Enumerates the preset vibration effect IDs. You can pass this parameter to [vibrator.startVibration9+](#vibratorstartvibration9) or [vibrator.stopVibration9+](#vibratorstopvibration9-1) to deliver the vibration effect specified by [VibratePreset](#vibratepreset9). This parameter supports a variety of values, such as **haptic.effect.soft**.
...
| index     | number                                                   | No  | Channel number. This parameter is optional. The value range is [0,2].       |
