...
| group   | string | No| Group name of the check box.<br>**NOTE**<br>For the settings to take effect, this parameter must be used with the [\<CheckboxGroup>](ts-basic-components-checkboxgroup.md) component.|
