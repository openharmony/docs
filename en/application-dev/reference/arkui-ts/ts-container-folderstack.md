...
| autoHalfFold    | boolean                                     | Whether to enable auto-rotate. This attribute is effective only when the system auto-rotate feature is disabled.<br>Default value: **true**                                                                                                           |
>  **NOTE**
>
...
| Name                                                               | Description                                          |
|-------------------------------------------------------------------|------------------------------------------------|
| onFolderStateChange (callback: (foldStatus: [FoldStatus](ts-appendix-enums.md#foldstatus11) => void) | Called when the folding status changes. This API works only in landscape orientation.<br>- **foldStatus**: folding status of the device.|
