...
| -------- | -------- | -------- |
| transition | TransitionOptions<sup>(deprecated)</sup> \| TransitionEffect<sup>10+</sup>  | Transition effects when the component is inserted, displayed, deleted, or hidden.<br>Since API version 10, this API is supported in ArkTS widgets.<br>**NOTE**<br>For details, see the descriptions of **TransitionOptions** and **TransitionEffect**.|
...
| combine | TransitionEffect | No| Combination of transition effects.<br>Since API version 10, this API is supported in ArkTS widgets.|
