...
| textShadow<sup>10+</sup> | [ShadowOptions](ts-universal-attributes-image-effect.md#shadowoptions) \| Array&lt;[ShadowOptions](ts-universal-attributes-image-effect.md#shadowoptions)&gt;<sup>11+</sup>  | Text shadow.<br>**NOTE**<br/>This API does not work with the **fill** attribute or coloring strategy.<br>Since API version 11, this API supports input parameters in an array to implement multiple text shadows. |
...
>
>  The **\<Text>** component does not support the universal attribute [clip](ts-universal-attributes-sharp-clipping.md#clip).
