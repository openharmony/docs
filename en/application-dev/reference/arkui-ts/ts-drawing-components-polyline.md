...
| -------- | -------- | -------- | -------- |
| points | Array&lt;[Point](ts-drawing-components-polyline.md#point)&gt; | [] | List of coordinates that the polyline passes through.<br>Since API version 9, this API is supported in ArkTS widgets.<br>**NOTE**<br>An invalid value is handled as the default value.|
