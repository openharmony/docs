...
| selectAll<sup>11+</sup>               | boolean                                  | Whether to select all text in the initial state.<br>Default value: **false**<br>The inline mode is not supported.|
...
>  **NOTE**
>
>  The default value of the universal attribute [padding](ts-universal-attributes-size.md#padding) is as follows:
>
>  {<br> top: 8 vp,<br> right: 16 vp,<br> bottom: 8 vp,<br> left: 16 vp<br> }
>
