...
| borderRadius | [Length](ts-types.md#length) \| [BorderRadiuses](#borderradiuses9)<sup>9+</sup> | Border radius. The radius is restricted by the component size. The maximum value is half of the component width or height. The percentage format is not supported.<br>Since API version 9, this API is supported in ArkTS widgets.|
