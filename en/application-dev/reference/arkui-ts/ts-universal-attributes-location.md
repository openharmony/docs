...
| direction | [Direction](ts-appendix-enums.md#direction) | How elements are laid out along the main axis of the component.<br>Default value: **Direction.Auto**<br>Since API version 9, this API is supported in ArkTS widgets.|
