...
| strokeLineJoin | [LineJoinStyle](ts-appendix-enums.md#linejoinstyle) | LineJoinStyle.Miter | Join style of the stroke.<br>**NOTE**<br>This attribute does not work for the **\<ellipse>** component, which does not have corners. |
