...
| -------- | -------- | -------- | -------- | -------- |
| width | string \| number | No| 0 | Width.<br>**NOTE**<br>If the value is invalid or the default value is used, the width required for the content is used.|
| height | string \| number | No| 0 | Height.<br>**NOTE**<br>If the value is invalid or the default value is used, the height required for the content is used.|
