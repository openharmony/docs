...
| edgeEffect<sup>10+</sup> | [EdgeEffect](ts-appendix-enums.md#edgeeffect), [EdgeEffectOptions<sup>11+</sup>](ts-container-scroll.md#edgeeffectoptions11)?: | Scroll effect. The spring effect and shadow effect are supported.<br>Default value: **EdgeEffect.None**<br> **edgeEffectOptions** sets whether to enable the scroll effect when the component content is smaller than the component itself.<br>Default value: **false**|
