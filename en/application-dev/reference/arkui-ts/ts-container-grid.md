...
| Name        | Type        |   Description        |
| ---------- | ---------- | ---------- |
| totalOffset | number |  Total offset of the grid content relative to the display area, in vp.   |
| totalLength   | number |  Total length of the grid content, in vp.   |
