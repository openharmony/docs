...
```ts
    ...
    // Output: the value of the deviceInfo serial is: ABC123456789
    ...
    // Output: the value of the deviceInfo buildUser is: release:nolog
    ...
    // Output: the value of the deviceInfo udid is: 1234567890
