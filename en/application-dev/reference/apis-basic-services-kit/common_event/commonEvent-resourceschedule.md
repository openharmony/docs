...
<!--Del-->
APIs related to this event: **power**. For details, see [@ohos.power (Power Management)](../../apis-backgroundtasks-kit/Readme-EN.md).<!--DelEnd-->
...
<!--Del-->
APIs related to this event: **deviceStandby**. For details, see [@ohos.resourceschedule.deviceStandby (Device Standby)](../../apis-backgroundtasks-kit/Readme-EN.md).<!--DelEnd-->
