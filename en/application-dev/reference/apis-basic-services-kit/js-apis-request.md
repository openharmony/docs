...
| url | string | Yes| Resource URL. From API version 6 to 14, the value contains a maximum of 2048 characters; since API version 15, the value contains a maximum of 8192 characters. Intercepting HTTP is supported.<br>**Atomic service API**: This API can be used in atomic services since API version 11.|
