...
>This API is no longer maintained since API version 7. It is recommended that you use [window.setWindowKeepScreenOn()](../apis-arkui/js-apis-window.md#setwindowkeepscreenon9).
