...
Defines the OpenHarmony Universal KeyStore (HUKS) capabilities, including key management and cryptography operations, provided for applications.
...
| callback | AsyncCallback\<void>        | Yes  | Callback function. If no error is captured, the key is successfully generated. In this case, the API does not return the key content because the key is always protected in a TEE. If an error is captured, an exception occurs in the generation process.|
...
| callback | AsyncCallback\<void>        | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned.|
...
| -------- | --------------------------- | ---- | --------------------------------------------- |
| keyAlias | string                      | Yes  | Key alias. The value can contain up to 128 bytes and should not include sensitive data such as personal information.                                   |
| options  | [HuksOptions](#huksoptions) | Yes  | Options for importing the key. The algorithm, key purpose, and key length are mandatory.|
| callback | AsyncCallback\<void>        | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned.|
...
| options  | [HuksOptions](#huksoptions)                          | Yes  | Parameters and data for obtaining the certificate.           |
| callback | AsyncCallback<[HuksReturnResult](#huksreturnresult9)> | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned.|
...
| Type                                          | Description                                         |
| ---------------------------------------------- | --------------------------------------------- |
| Promise<[HuksReturnResult](#huksreturnresult9)> | Promise If the operation is successful, **certChains** in **HuksReturnResult** is the certificate chain obtained.|
...
| options          | [HuksOptions](#huksoptions) | Yes  | Options for importing the wrapped key. The algorithm, key purpose, and key length are mandatory.|
| callback         | AsyncCallback\<void>        | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned.|
...
| callback | AsyncCallback<[HuksReturnResult](#huksreturnresult9)> | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned. **outData** contains the public key exported.|
...
| Type                                          | Description                                                        |
| ---------------------------------------------- | ------------------------------------------------------------ |
| Promise<[HuksReturnResult](#huksreturnresult9)> | Promise If the operation is successful, **outData** in **HuksReturnResult** is the public key exported.|
...
| keyAlias | string                                               | Yes  | Key alias, which must be the same as the alias used when the key was generated.                |
| options  | [HuksOptions](#huksoptions)                          | Yes  | Empty object (leave this parameter empty).                                    |
| callback | AsyncCallback<[HuksReturnResult](#huksreturnresult9)> | Yes  | Callback function. If the operation is successful, no **err** value is returned; otherwise, an error code is returned. **properties** returns the parameters required for generating the key.|
...
| Type                                           | Description                                                        |
| ----------------------------------------------- | ------------------------------------------------------------ |
| Promise\<[HuksReturnResult](#huksreturnresult9)> | Promise If the operation is successful, **properties** in **HuksReturnResult** holds the parameters required for generating the key.|
...
| callback | AsyncCallback\<boolean>     | Yes  | Callback function. If the key exists, **data** is **true**. If the key does not exist, **error** is the error code.|
...
| Type             | Description                                   |
| ----------------- | --------------------------------------- |
| Promise\<boolean> | Promise If the key exists, then() performs subsequent operations. If the key does not exist, error() performs the related service operations.|
...
| keyAlias | string                      | Yes  | Alias of the key to check.                                           |
| options  | [HuksOptions](#huksoptions) | Yes  | Attribute tag of the key to be checked. If [HuksAuthStorageLevel](#huksauthstoragelevel11) is used to specify the security level of the key to be checked,<br>this parameter can be left empty. If the API version is 12 or later, the default value **CE** is passed in. If the API version is earlier than 12, the default value **DE** is passed in.    |
| callback | AsyncCallback\<boolean>     | Yes  | Callback function. If the key exists, **data** is **true**. Otherwise, **data** is **false**.|
...
| callback | AsyncCallback\<[HuksSessionHandle](#hukssessionhandle9)> | Yes  | Callback function. return a session handle for subsequent operations.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<[HuksSessionHandle](#hukssessionhandle9)> | Promise return a session handle for subsequent operations.|
...
| callback | AsyncCallback<[HuksReturnResult](#huksreturnresult9)> | Yes  | Callback function. return the **updateSession** operation result.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise<[HuksReturnResult](#huksreturnresult9)> | Promise return the **updateSession** operation result.|
...
| callback | AsyncCallback<[HuksReturnResult](#huksreturnresult9)> | Yes  | Callback function. return the **finishSession** operation result.|
...
| callback | AsyncCallback\<void>        | Yes  | Callback function. return the **abortSession** operation result.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<void>             | Promise return the **abortSession** operation result.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise<[HuksListAliasesReturnResult](#hukslistaliasesreturnresult12)> | Promise return the key aliases obtained.|
...
| HUKS_ERR_CODE_ILLEGAL_ARGUMENT                 | 401      | Invalid parameters are detected. Possible causes: 1. Mandatory parameters are left unspecified.2. The parameter type is incorrect.3. Parameter verification failed.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core         |
| HUKS_ERR_CODE_NOT_SUPPORTED_API                | 801      | Unsupported API<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core              |
| HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED            | 12000001 | Unsupported feature<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core        |
...
| HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT      | 12000003 | Invalid key algorithm parameters<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core         |
| HUKS_ERR_CODE_FILE_OPERATION_FAIL              | 12000004 | File operation failure.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core             |
| HUKS_ERR_CODE_COMMUNICATION_FAIL               | 12000005 | Communication failed.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core                 |
| HUKS_ERR_CODE_CRYPTO_FAIL                      | 12000006 | Crypto operation failed.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core           |
...
| HUKS_ERR_CODE_ITEM_NOT_EXIST                   | 12000011 | Target object<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core           |
| HUKS_ERR_CODE_EXTERNAL_ERROR                   | 12000012 | External error.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core                 |
| HUKS_ERR_CODE_CREDENTIAL_NOT_EXIST             | 12000013 | Credential<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core             |
...
| HUKS_ALG_DES<sup>12+</sup> | 160  | DES (supported on mini-system devices since API version 12 and on standard devices since API version 18).<br>**Atomic service API**: This API can be used in atomic services since API version 12.<br> **System capability**: SystemCapability.Security.Huks.Core|
| HUKS_ALG_3DES<sup>12+</sup> | 161  | 3DES (supported on mini-system devices since API version 12 and on standard devices since API version 18).<br>**Atomic service API**: This API can be used in atomic services since API version 12.<br> **System capability**: SystemCapability.Security.Huks.Core|
| HUKS_ALG_CMAC<sup>12+</sup> | 162  | CMAC (supported on mini-system devices since API version 12 and on standard devices since API version 18).<br>**Atomic service API**: This API can be used in atomic services since API version 12.<br> **System capability**: SystemCapability.Security.Huks.Core|
...
| HUKS_KEY_GENERATE_TYPE_AGREE   | 2    | Key generated by key agreement.|
...
| Name                      | Value  | Description                                |
| -------------------------- | ---- | ------------------------------------ |
| HUKS_KEY_FLAG_IMPORT_KEY   | 1    | Import a public key using a function.    |
| HUKS_KEY_FLAG_GENERATE_KEY | 2    | Generate a key by using a function.    |
| HUKS_KEY_FLAG_AGREE_KEY    | 3    | Generate a key by using a key agreement function.|
| HUKS_KEY_FLAG_DERIVE_KEY   | 4    | Derive a key by using a function.|
...
| HUKS_AUTH_ACCESS_INVALID_NEW_BIO_ENROLL | 1 << 1 | The key becomes invalid after a new biometric feature is enrolled.|
...
| HUKS_TAG_CHALLENGE_POS<sup>9+</sup>                         | HuksTagType.HUKS_TAG_TYPE_UINT \| 310    | 8-byte valid value in a custom challenge. For details, see [HuksChallengePosition](#hukschallengeposition9).<br>**Atomic service API**: This API can be used in atomic services since API version 12.<br> **System capability**: SystemCapability.Security.Huks.Extension|
...
| HUKS_TAG_AE_TAG                                             | HuksTagType.HUKS_TAG_TYPE_BYTES \| 10009 | AEAD in GCM mode.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br> **System capability**: SystemCapability.Security.Huks.Core|
...
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes  | Callback function. If the operation is successful, **HUKS_SUCCESS** is returned. If the operation fails, an error code defined in **HuksResult** is returned.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<[HuksResult](#huksresultdeprecated)> | Promise If the operation is successful, **HUKS_SUCCESS** is returned. If the operation fails, an error code is returned.|
...
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes  | Callback function. If the operation is successful, **HUKS_SUCCESS** is returned. If the operation fails, an error code is returned.              |
...
| keyAlias | string                                    | Yes  | Key alias, which must be the same as the alias used when the key was generated.                |
| options  | [HuksOptions](#huksoptions)               | Yes  | Empty object (leave this parameter empty).                                    |
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes  | Callback function. If the operation is successful, **HUKS_SUCCESS** is returned. If the operation fails, an error code is returned. **outData** contains the public key exported.|
...
| Type                               | Description                                                        |
| ----------------------------------- | ------------------------------------------------------------ |
| Promise\<[HuksResult](#huksresultdeprecated)> | Promise If the operation is successful, **HUKS_SUCCESS** is returned. If the operation fails, an error code is returned. **outData** contains the public key exported.|
...
| keyAlias | string                                    | Yes  | Key alias, which must be the same as the alias used when the key was generated.                |
| options  | [HuksOptions](#huksoptions)               | Yes  | Empty object (leave this parameter empty).                                    |
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes  | Callback function. If the operation is successful, **errorCode** is **HUKS_SUCCESS**; otherwise, an error code is returned.|
...
| Type              | Description                                                        |
| ------------------ | ------------------------------------------------------------ |
| Promise\<[HuksResult](#huksoptions)> | Promise If the operation is successful, **errorCode** is **HUKS_SUCCESS** and **properties** returns the parameters required for generating the key.|
...
| callback | AsyncCallback\<boolean> | Yes  | Callback function. The value **true** means the key exists; the value **false** means the opposite.|
...
| Type             | Description                                   |
| ----------------- | --------------------------------------- |
| Promise\<boolean> | Promise The value **true** means the key exists; the value **false** means the opposite.|
...
| callback | AsyncCallback\<[HuksHandle](#hukshandledeprecated)> | Yes  | Callback function. return a session handle for subsequent operations.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<[HuksHandle](#hukshandledeprecated)> | Promise return a session handle for subsequent operations.|
...
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes  | Callback function. return the **update** operation result.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<[HuksResult](#huksresultdeprecated)> | Promise return the **update** operation result.|
...
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes| Callback function. return the **finish** operation result.|
...
| callback | AsyncCallback\<[HuksResult](#huksresultdeprecated)> | Yes| Callback function. return the **abort** operation result.|
...
| Type                               | Description                                              |
| ----------------------------------- | -------------------------------------------------- |
| Promise\<[HuksResult](#huksresultdeprecated)> | Promise return the **abort** operation result.|
