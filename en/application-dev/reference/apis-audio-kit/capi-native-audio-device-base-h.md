...
| -- | -- | -- |
| [OH_AudioDeviceDescriptorArray](capi-oh-audiodevicedescriptorarray.md) | OH_AudioDeviceDescriptorArray | Describes an array of audio device descriptors.|
| [OH_AudioDeviceDescriptor](capi-oh-audiodevicedescriptor.md) | OH_AudioDeviceDescriptor | Describes an audio device descriptor, which provides attributes of an audio device.|
