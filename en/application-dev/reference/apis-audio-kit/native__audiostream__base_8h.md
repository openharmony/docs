...
| [OH_AudioStream_SampleFormat](_o_h_audio.md#oh_audiostream_sampleformat) {<br>AUDIOSTREAM_SAMPLE_U8 = 0,<br>AUDIOSTREAM_SAMPLE_S16LE = 1,<br>AUDIOSTREAM_SAMPLE_S24LE = 2,<br>AUDIOSTREAM_SAMPLE_S32LE = 3,<br>AUDIOSTREAM_SAMPLE_F32LE = 4<br>} | Enumerates the sampling formats of audio streams.| 
...
| [OH_AudioStream_VolumeMode](_o_h_audio.md#oh_audiostream_volumemode) {<br>AUDIOSTREAM_VOLUMEMODE_SYSTEM_GLOBAL = 0,<br>AUDIOSTREAM_VOLUMEMODE_APP_INDIVIDUAL = 1 } | Enumerates the volume modes of audio streams.| 
