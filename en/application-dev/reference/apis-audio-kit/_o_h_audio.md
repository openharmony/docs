...
| [native_audio_device_base.h](native__audio__device__base_8h.md) | Declares the types of audio device parameters and the functions for obtaining these parameters.<br> | 
...
| AUDIOSTREAM_USAGE_COMMUNICATION  | VoIP voice call.  | 
...
Sets the playback speed for an audio renderer.
