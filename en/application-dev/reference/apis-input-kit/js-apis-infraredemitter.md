...
| pattern | Array&lt;number&gt; | Yes   | IR level signal in 탎, which ranges from 0 to 1024.<br>For example, in the IR level signal array [100,200,300,400], 100 탎 is a high-level signal, 200 탎 is a low-level signal, 300 탎 is a high-level signal, and 400 탎 is a low-level signal.|
