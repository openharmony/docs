...
```js
import inputMonitor from '@kit.InputKit.d.ts';
```
...
```js
import { MouseEvent } from '@kit.InputKit.d.ts';
import promptAction from '@kit.ArkUI.d.ts'
import display from '@kit.ArkUI.d.ts'
...
```js
import type { Pinch } from '@kit.InputKit.d.ts';
try {
...
```js
// Disable listening for a single callback.
import { Pinch } from '@kit.InputKit.d.ts';
...
```js
// Disable listening for a single callback.
import { ThreeFingersSwipe } from '@kit.InputKit.d.ts';
...
```js
// Disable listening for a single callback.
import { FourFingersSwipe } from '@kit.InputKit.d.ts';
...
```js
import type { Rotate } from '@kit.InputKit.d.ts';
try {
...
```js
// Disable listening for a single callback.
import { Rotate } from '@kit.InputKit.d.ts';
...
```js
import type { FingerprintEvent } from '@kit.InputKit.d.ts';
import inputMonitor from '@kit.InputKit.d.ts';
...
```js
// Disable listening for a single callback.
import { ThreeFingersTap } from '@kit.InputKit.d.ts';
