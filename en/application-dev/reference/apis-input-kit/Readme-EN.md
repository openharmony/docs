...
- ArkTS API<!--input-arkts-->
  ...
  - [@ohos.multimodalInput.shortKey (Preset Global Hotkeys) (System API)](js-apis-shortKey-sys.md)
  - [@ohos.multimodalInput.shortKey (Global Hotkeys) (System API)](js-apis-inputconsumer-sys.md)
...
- Error Codes<!--input-arkts-errcode-->
  ...
  <!--DelEnd-->
  - [Global Hotkey Error Codes](errorcode-inputconsumer.md)
