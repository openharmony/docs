...
| -- | -- |
| [OH_VideoProcessing](capi-oh-videoprocessing.md)* videoProcessor | Pointer to the video processing instance.|
| const [OHNativeWindow](../apis-arkgraphics2d/_native_window.md#ohnativewindow)* window | Pointer to the output surface.|
...
| -- | -- |
| [OH_VideoProcessing](capi-oh-videoprocessing.md)* videoProcessor | Pointer to the video processing instance.|
| [OHNativeWindow](../apis-arkgraphics2d/_native_window.md#nativewindow)** window | Double pointer to the input surface. For example, the input surface pointer can point to an output surface of the video decoder.|
