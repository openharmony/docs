...
>
> The APIs of this module are available only to [MDM applications](../../mdm/mdm-kit-term.md#mdm-app), and can be called only after the device administrator application is activated via [adminManager.enableAdmin](js-apis-enterprise-adminManager-sys.md#adminmanagerenableadmin-2).
> 
