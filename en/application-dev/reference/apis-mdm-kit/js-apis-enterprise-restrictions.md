...
Enables or disables a feature of a specified user. Currently, only 2-in-1 devices are supported.
...
Obtains the status of a feature of a specified user. Currently, only 2-in-1 devices are supported.
...
Adds a list of applications that are not allowed to use a feature for a specified user. Currently, only 2-in-1 devices are supported.
...
Removes a list of applications that are not allowed to use a feature for a specified user. Currently, only 2-in-1 devices are supported.
...
Obtains the list of applications that are not allowed to use a feature for a specified user. Currently, only 2-in-1 devices are supported.
