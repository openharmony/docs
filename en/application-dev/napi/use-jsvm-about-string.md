...
<!--Tester: @test_lzz-->
<!--Adviser: @k1ngqaquuu-->
<!-- md-trans-meta sourceCommit=21434ce8d323ecbd7d67463989a2ef075be92cec translatedAt=2026-08-12T06:34:06.788Z pushedAt=2026-08-12T11:00:39.061Z -->
...
`string` is a commonly used data type in programming. It is used to store and manipulate text data. It can be used to build UI elements such as labels, buttons, and text boxes, process user input, and validate and format data. Different encoding schemes support different character sets and languages. The following are some major encoding schemes and their differences:
...
// Sample method for OH_JSVM_GetValueStringUtf8
...
// Alias of the GetValueStringUtf8 method, for JS calls.
...
// Sample method for OH_JSVM_CreateStringUtf8
...
static JSVM_CallbackStruct *method = param;
// Alias of the CreateStringUtf8 method, for JS calls.
static JSVM_PropertyDescriptor descriptor[] = {
...
// Sample method for OH_JSVM_GetValueStringUtf16
// Define the maximum length of the string buffer.
...
static JSVM_CallbackStruct *method = param;
// Alias of the GetValueStringUtf16 method, for JS calls.
static JSVM_PropertyDescriptor descriptor[] = {
...
// Sample method for OH_JSVM_CreateStringUtf16
...
static JSVM_CallbackStruct *method = param;
// Alias of the CreateStringUtf16 method, for JS calls.
static JSVM_PropertyDescriptor descriptor[] = {
...
// Sample method for OH_JSVM_GetValueStringLatin1
// Define the maximum length of the string buffer.
static const int MAX_BUFFER_SIZE = 128;
...
static JSVM_CallbackStruct *method = param;
// Alias of the GetValueStringLatin1 method, for JS calls.
static JSVM_PropertyDescriptor descriptor[] = {
...
// Define the maximum length of the string buffer.
static const int MAX_BUFFER_SIZE = 128;
// Sample method for OH_JSVM_CreateStringLatin1
...
static JSVM_CallbackStruct *method = param;
// Alias of the CreateStringLatin1 method, for JS calls.
static JSVM_PropertyDescriptor descriptor[] = {
