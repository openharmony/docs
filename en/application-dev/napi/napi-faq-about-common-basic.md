...
1. **napi_env** is bound to the ArkTS thread, so that it cannot be used across threads. Otherwise, stability issues may occur. References:
...
4. If specific error message is reported, identify the fault based on the error message.
