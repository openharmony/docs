...
<!--Tester: @test_lzz-->
<!--Adviser: @k1ngqaquuu-->
<!-- md-trans-meta sourceCommit=fa3fc214ef4b265f033bc3f0d0a2df54f511a497 translatedAt=2026-08-12T06:36:34.969Z pushedAt=2026-08-12T11:03:01.988Z -->
...
| OH_JSVM_CreateFunction     | Creates a JavaScript function for calling functions in C/C++ code from the JavaScript environment. It must be set to a JavaScript object before it can be called. |
...
JSVM_Value NativeCreateFunctionTest(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    JSVM_Value thisArg;
    // Obtain callback parameter information.
...
static int32_t TEST_FUNC()
{
    ...
    if (!isVMInit) {
        isVMInit = true;
        // A single process only needs to be initialized once.
    ...
    // Create and verify the function.
    ...
    // Set the function to the global object.
    JSVM_Value global;
    ...
    // Call the function through the call interface.
    JSVM_Value argv[1] = {nullptr};
    ...
    // Call the function through a script.
    JSVM_Script script;
    JSVM_Value jsSrc;
