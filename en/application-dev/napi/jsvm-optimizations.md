...
<!--Tester: @test_lzz-->
<!--Adviser: @k1ngqaquuu-->
<!-- md-trans-meta sourceCommit=21434ce8d323ecbd7d67463989a2ef075be92cec translatedAt=2026-08-12T06:26:39.912Z pushedAt=2026-08-12T09:07:57.874Z -->

## JSVM Call Invocation

The process in which a mini-program uses JSVM to execute JS code can be divided into three layers: Native, JSVM-API, and JSVM.

- Native: logic layer for the mini-program to run JS code. In this layer, the APIs provided by the JSVM are used to compile and run JS code and create a code cache.
...
**Cold Startup: Using Lazy Compile Instead of Eager Compile**
...
To determine the object type, the following method is inefficient:
...
The following optimization decreases the code execution time by 150 ms, accounting for about 5% of the performance benefits of a mini-program.
