...
If the application startup is slowed down due to unnecessary overheads generated by using the JSVM, you can analyze the cause and make optimization in the three layers.
