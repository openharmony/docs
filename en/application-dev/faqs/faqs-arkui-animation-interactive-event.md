...
You can use [property animation](../reference/arkui-ts/ts-animatorproperty.md) to that effect.
...
1. [Hit Test Control](../reference/arkui-ts/ts-universal-attributes-hit-test-behavior.md)

2. [Custom Event Dispatch](../reference/arkui-ts/ts-universal-attributes-on-child-touch-test.md)

3.[Custom Gesture Judgment](../reference/arkui-ts/ts-gesture-customize-judge.md)
