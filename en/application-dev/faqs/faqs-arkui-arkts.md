...
[Media Query](../reference/apis/js-apis-mediaquery.md)
...
[Resource Categories and Access](../quick-start/resource-categories-and-access.md) and [@ohos.resourceManager (Resource Management)](../reference/apis/js-apis-resource-manager.md)
...
[@ohos.worker (Starting the Worker)](../reference/apis/js-apis-worker.md)
