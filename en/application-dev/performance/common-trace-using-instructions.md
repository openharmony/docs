...
[Sample link](https://gitee.com/openharmony/applications_app_samples/blob/OpenHarmony-4.1-Beta1/code/Performance/PerformanceLibrary/feature/trace/src/main/ets/view/IconView.ets)
```ts
// IconView.ets
@Component
