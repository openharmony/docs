# Converting a Compressed or Uncompressed ECC Public Key
...
In this example, an uncompressed public key is passed in.
...
3. Use [AsyKeyGenerator.convertKey](../../reference/apis-crypto-architecture-kit/js-apis-cryptoFramework.md#convertkey-3) with the encapsulated **DataBlob** object to generate an asymmetric key (**KeyPair**) object.
