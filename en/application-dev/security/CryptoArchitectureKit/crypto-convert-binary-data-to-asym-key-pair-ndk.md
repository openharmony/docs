...
1. Obtain the binary data of the RSA public key or private key and encapsulate the data into a [Crypto_DataBlob](../../reference/apis-crypto-architecture-kit/capi-crypto-datablob.md) object.
...
1. Obtain the binary data of the ECC public key or private key and encapsulate the data into a [Crypto_DataBlob](../../reference/apis-crypto-architecture-kit/capi-crypto-datablob.md) object.
...
1. Obtain the binary data of the SM2 public key or private key and encapsulate the data into a [Crypto_DataBlob](../../reference/apis-crypto-architecture-kit/capi-crypto-datablob.md) object.
