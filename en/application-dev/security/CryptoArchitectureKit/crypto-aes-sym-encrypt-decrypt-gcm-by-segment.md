...
4. Set the data length to be passed in each time to 20 bytes, and call [Cipher.update](../../reference/apis/js-apis-cryptoFramework.md#update-1) multiple times to pass in the data to be encrypted (plaintext).
...
2. Set the data length to be passed in each time to 20 bytes, and call [Cipher.update](../../reference/apis/js-apis-cryptoFramework.md#update-1) multiple times to pass in the data to be decrypted (ciphertext).
