...
3. Use [OH_Huks_AttestKeyItem](../../reference/native-apis/_huks_key_api.md#oh_huks_attestkeyitem) with the key alias and parameter set to perform key attestation.
