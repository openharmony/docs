...
| ASSET_TAG_REQUIRE_PASSWORD_SET  | Type: boolean                                                  | No    | Whether the asset is accessible only when a lock screen password is set.                |
...
| ASSET_TAG_IS_PERSISTENT         | Type: boolean                                                  | No    | Whether to retain the asset when the application is uninstalled.                            |
