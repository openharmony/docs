...
11. Clear the sandbox application configuration.
...
13. Start the DLP manager application in borderless mode. This API can be called only in the UIAbility context and supports only the stage model.
