...
13. When the DLP permission manager application is ready, it starts the sandbox application and transfers the link file descriptor. The sandbox application starts, and the application process opens the link file.
