...
Allows an application to query information about other applications. This permission applies only to third-party applications.
...
Allows an application to query information about other applications. This permission applies only to privilege applications and applications with the same signature.
