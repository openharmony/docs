...
| [FenceExtension](../reference/apis-location-kit/js-apis-app-ability-FenceExtensionAbility.md) | ExtensionAbility component of the FENCE type, which provides the geofence capability.| Yes| No| No| In non-strict mode, sendable data can be read and written.|
