...
> **NOTE**
>
> Before using this tool, you must obtain the <!--RP1-->[hdc tool](../../device-dev/subsystems/subsys-toolchain-hdc-guide.md)<!--RP1End--> and run the hdc shell command.
...
**Method**
  ...
  aa start [-d <deviceId>] [-a <abilityName> -b <bundleName>] [-m <moduleName>] [-D] [-S] [--pi <key> <integer-value>] [--pb <key> <bool-value: true/false/t/f, case insensitive] [--ps <key> <value>] [--psn <key>]
