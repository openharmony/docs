...
| watch   | Runs the specified PROG at a given interval (specified by **-n**, in seconds) and displays the execution result. You can press **Q** to exit the command execution.<br>usage: watch [-teb] [-n SEC] PROG ARGS |
