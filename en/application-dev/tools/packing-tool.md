...
| Attributes of module.json         | Description         | [module.json5](../quick-start/module-configuration-file.md)        | [app.json5](../quick-start/app-configuration-file.md)           | [Project-level build-profile.json5](https://developer.huawei.com/consumer/en/doc/harmonyos-guides/ide-hvigor-build-profile-app) Configuration Item |
| ------------------------ | ------------------------ | ------------------------ | -------------------------- | --------------------------       |
| bundleName               | Bundle name of the application.       | -                        | bundleName                 | -                                |
| bundleType               | Bundle type of an app.       | -                        | bundleType                 | -                                |
| versionCode              | Application version number.           | -                        | versionCode                | -                                |
| debug                    | Whether an app can be debugged.         | -                        | debug                      | -                                |
| module/name              | Name of the current module.       | module/name              | -                          | -                                |
...
| Fields to Be Verified in module.json of the HAP/HSP | Verification Rules                          |
| --------------------------------- | --------------------------------- |
...
| --atomic-service-entry-size-limit      | No        | NA            | Maximum size of the entry package (including the size of the dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If the entry package is in release mode (the type field in the module.json5 file is set to entry and the debug field in the app.json5 file is set to false), this limit applies to the size of the entry package (including the size of its dependent packages) after the app is compressed during app packaging.                      |
| --atomic-service-non-entry-size-limit  | No        | NA            | Maximum size of a non-entry package (including the size of its dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If the non-entry package is in release mode (the type field in the module.json5 file is not set to entry and the debug field in the app.json5 file is set to false), this limit applies to the size of the non-entry package (including the size of its dependent packages) after the app is compressed during app packaging.                    |
...
| --atomic-service-entry-size-limit      | No        | NA            | Maximum size of the entry package (including the size of the dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If the entry package is in release mode (the value of the type field in the module.json5 file is entry and the value of the debug field in the app.json5 file is false), this limit applies to the size of the compressed entry package (including the size of the dependency package) during app packaging.                      |
| --atomic-service-non-entry-size-limit  | No        | NA            | Maximum size of a non-entry package (including the size of its dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If a non-entry package is in release mode (the value of the type field in the module.json5 file is not entry and the value of the debug field in the app.json5 file is false), this limit applies to the size of the compressed non-entry package (including the size of the dependency package) during app packaging.                    |
...
| --encrypt-path     | No    | NA         | The file name must be **encrypt.json**.          |
| --pac-json-path     | No    | NA          | Path of the pac.json file. The file name must be pac.json.<br>This parameter is supported since API version 20.|
| --atomic-service-entry-size-limit      | No        | NA            | Maximum size of the entry package (including the size of the dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If the entry package is in release mode (the type field in the module.json5 file is set to entry and the debug field in the app.json5 file is set to false), this limit applies to the size of the entry package (including the size of its dependent packages) after the entry package is compressed during app packaging.                     |
| --atomic-service-non-entry-size-limit  | No        | NA            | Maximum size of a non-entry package (including the size of its dependency package) of an FA. This parameter is valid only when the stage model is used and bundleType is set to atomicService. The value is an integer of [0,4194304]. The value 0 indicates that the size is not limited. The unit is KB. If this parameter is not set, the default value 2048 KB is used. If the non-entry package is in release mode (the value of the type field in the module.json5 file is not entry, and the value of the debug field in the app.json5 file is false), this limit applies to the size of the non-entry package (including the size of its dependent packages) after compression during app packaging.                    |
...
The size of the atomic service package exceeds the upper limit during app packaging.

**Possible Causes**

The size of the atomic service package and the dependent shared library or resource file exceeds the upper limit. For details about the restrictions, see the description of the --atomic-service-entry-size-limit and --atomic-service-non-entry-size-limit parameters in #App packaging command parameters.
...
The size of a single package exceeds the upper limit during the building of an atomic service app.
...
When an atomic service app is built, the size of a single package and its dependent shared libraries exceeds the upper limit.
