...
| bundleType| Bundle type, which is used to distinguish applications and atomic services. The options are as follows:<br>- **app**: The bundle is a common application.<br>- **atomicService**: The bundle is an atomic service.<br>- **shared**: The bundle is a shared library application. This option is reserved.| String| Yes (initial value: **app**)|
