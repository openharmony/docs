...
| bundleType| Bundle type. The options are as follows:<br>- **app**: The bundle is an application.<br>- **atomicService**: The bundle is an atomic service.<br>- **shared**: The bundle is a shared library. This option is reserved.<br>- **appService**: The bundle is a system-level shared library and can be used only by system applications.<br>- **appPlugin**: The bundle is the plugin package of an application. This field is supported since API version 19.| String| Yes (initial value: **app**)|
