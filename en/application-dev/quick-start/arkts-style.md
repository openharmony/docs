...
- Currently, \@Styles supports only [general attributes](../reference/apis-arkui/arkui-ts/ts-universal-attributes-size.md) and [general events](../reference/apis-arkui/arkui-ts/ts-universal-events-click.md).
