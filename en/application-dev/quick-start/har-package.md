...
- As a second-party library for internal applications, by being released to an [OHPM private repository](https://developer.huawei.com/consumer/en/doc/harmonyos-guides-V5/ide-ohpm-repo-V5).
...
- An HAR does not support the declaration of the [UIAbility](../application-models/uiability-overview.md) component and [ExtensionAbility](../application-models/extensionability-overview.md) component in the configuration file.
...
## Creating an HAR
Create an HAR module in DevEco Studio. For details, see <!--RP1-->[Creating a HAR Module](https://developer.huawei.com/consumer/en/doc/harmonyos-guides-V5/ide-har-V5#section643521083015)<!--RP1End-->.
