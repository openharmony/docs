...
User preference setting is implemented by using [setUsingLocalDigit](../reference/apis-localization-kit/js-apis-i18n.md#setusinglocaldigit9) and [set24HourClock](../reference/apis-localization-kit/js-apis-i18n.md#set24hourclock9). The development procedure is as follows:
