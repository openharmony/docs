...
The domain account plugin prototype is [DomainPlugin](../reference/apis/js-apis-osAccount.md#domainplugin9). The domain account plugin must inherit and implement the **DomainPlugin** APIs. You can use [registerPlugin](../reference/apis/js-apis-osAccount.md#registerplugin9) to register a plugin.
...
2. Use [registerPlugin](../reference/apis/js-apis-osAccount.md#registerplugin9) to register the plug-in.
...
Use [unregisterPlugin](../reference/apis/js-apis-osAccount.md#unregisterplugin9) to unregister a domain account plugin that is not required.
