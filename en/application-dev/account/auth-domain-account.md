...
The domain account can be authenticated by password. You can use [auth](../reference/apis/js-apis-osAccount.md#auth10) to implement this operation. To call this API, the app must have the ohos.permission.ACCESS_USER_AUTH_INTERNAL permission.
...
4. Use [auth](../reference/apis/js-apis-osAccount.md#auth10) to authenticate the domain account by password.
...
If the domain account password is unavailable, display a dialog box to authentication the domain account. You can use [authWithPopup](../reference/apis/js-apis-osAccount.md#authwithpopup10) to implement this operation.
...
2. Use [authWithPopup](../reference/apis/js-apis-osAccount.md#authwithpopup10) to authenticate the domain account in a dialog box displayed.
