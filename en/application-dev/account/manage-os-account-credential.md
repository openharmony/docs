...
2. Use [getAuthInfo](../reference/apis/js-apis-osAccount.md#getauthinfo8) to obtain the credential of the specified type. In the following example, the fingerprint enrolled is obtained.
