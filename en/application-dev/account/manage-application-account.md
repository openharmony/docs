...
You can use the [application account SDK](../reference/apis/js-apis-appAccount.md) to manage app accounts.
...
2. Use [createAccount](../reference/apis/js-apis-appAccount.md#createaccount9) to create an app account based on the specified parameters.
...
2. Use [getAllAccounts](../reference/apis/js-apis-appAccount.md#getallaccounts9) to obtain the app account list.
...
2. Use [getCredential](../reference/apis/js-apis-appAccount.md#getcredential9) to obtain the account credential.
...
3. Use [setCredential](../reference/apis/js-apis-appAccount.md#setcredential9) to set the account credential.
...
2. Use [setCustomData](../reference/apis/js-apis-appAccount.md#setcustomdata9) to customize account data.
...
3. Use [getCustomData](../reference/apis/js-apis-appAccount.md#getcustomdata9) to obtain the custom account data.
...
2. Use [setAuthToken](../reference/apis/js-apis-appAccount.md#setauthtoken9) to set an authorization token for the specified authentication type.
...
3. Use [getAuthToken](../reference/apis/js-apis-appAccount.md#getauthtoken9) to obtain the authentication token of the specified authentication type.
...
1. Use [removeAccount](../reference/apis/js-apis-appAccount.md#removeaccount9) to delete the app account.
