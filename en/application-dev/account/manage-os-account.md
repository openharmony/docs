...
For details about the complete system account information, see [OsAccountInfo](../reference/apis/js-apis-osAccount.md#osaccountinfo).
...
Use [createOsAccount](../reference/apis/js-apis-osAccount.md#createosaccount) to create a system account with the specified name and type.
...
Use [queryAllCreatedOsAccounts](../reference/apis/js-apis-osAccount.md#queryallcreatedosaccounts) to obtain informatory about all system accounts. 
...
Use [queryOsAccountById](../reference/apis/js-apis-osAccount.md#queryosaccountbyid) to obtain detailed information about a system account.
...
1. Use [setOsAccountProfilePhoto](../reference/apis/js-apis-osAccount.md#setosaccountprofilephoto) to change the profile picture of a system account.
...
2. Use [setOsAccountName](../reference/apis/js-apis-osAccount.md#setosaccountname) to change the system account name.
...
System accounts are not activated by default. A system account can be used only after being activated. You can use [activateOsAccount](../reference/apis/js-apis-osAccount.md#activateosaccount) to activate a system account.

**Procedure**

Use [activateOsAccount](../reference/apis/js-apis-osAccount.md#activateosaccount) to activate a system account.
...
Use [removeOsAccount](../reference/apis/js-apis-osAccount.md#removeosaccount) to delete a system account.
