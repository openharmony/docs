  ...
  - Crypto Architecture Kit<!--crypto-architecture-kit-->
    ...
    - Encryption and Decryption<!--crypto-encryption-decryption-->
      ...
      - Encryption and Decryption Development<!--crypto-encrypt-decrypt-dev-->
        ...
        - [Encryption and Decryption with an SM4 Symmetric Key (CBC Mode)](security/CryptoArchitectureKit/crypto-sm4-sym-encrypt-decrypt-cbc.md)
    ...
    - Code Development<!--coding-->
      ...
      - Node-API Development<!--node-api-->
        ...
        - Typical Scenarios of Node-API<!--napi-scenarios-->
          ...
          - [Running or Stopping an Event Loop in an Asynchronous Thread Using Extended Node-API](napi/use-napi-event-loop.md)
...
- API References
  ...
  - ArkUI<!--arkui-api-->
    ...
    - ArkTS Components<!--arkui-comp-->
      - ArkTS-based Declarative Development Paradigm
        ...
        - Advanced Components
          - [@ohos.arkui.advanced.Chip (Chip)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Chip.md)
          - [@ohos.arkui.advanced.ChipGroup (ChipGroup)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ChipGroup.md)
          - [@ohos.arkui.advanced.ComposeListItem (List)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ComposeListItem.md)
          - [@ohos.arkui.advanced.ComposeTitleBar (One- or Two-Row Title Bar with Profile Picture)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ComposeTitleBar.md)
          - [@ohos.arkui.advanced.Counter (Counter)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Counter.md)
          - [@ohos.arkui.advanced.Dialog (Dialog Box)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Dialog.md)
          - [@ohos.arkui.advanced.EditableTitleBar (Editable Title Bar)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-EditableTitleBar.md)
          - [@ohos.arkui.advanced.ExceptionPrompt (Exception Prompt)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ExceptionPrompt.md)
          - [@ohos.arkui.advanced.Filter (Advanced Filter)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Filter.md)
          - [@ohos.arkui.advanced.FormMenu (Add to Home Menu)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-formmenu.md)
          - [@ohos.arkui.advanced.FullScreenLaunchComponent (Full Screen Launch Component)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-FullScreenLaunchComponent.md)
          - [@ohos.arkui.advanced.GridObjectSortComponent (Grid Object Organizer)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-GridObjectSortComponent.md)
          - [@ohos.arkui.advanced.ProgressButton (Download Button with Progress Indicator)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ProgressButton.md)
          ...
          - [@ohos.arkui.advanced.SelectionMenu (Context Menu on Selection)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-SelectionMenu.md)
          - [@ohos.arkui.advanced.SelectTitleBar (Drop-down Title Bar)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-SelectTitleBar.md)
          - [@ohos.arkui.advanced.SplitLayout (Split Layout)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-SplitLayout.md)
          - [@ohos.arkui.advanced.SubHeader (Subheader)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-SubHeader.md)
          - [@ohos.arkui.advanced.SwipeRefresher (Swipe Refresher)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-SwipeRefresher.md)
          - [@ohos.arkui.advanced.TabTitleBar (Editable Title Bar)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-TabTitleBar.md)
          - [@ohos.arkui.advanced.ToolBar (Toolbar)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-ToolBar.md)
          - [@ohos.arkui.advanced.TreeView (Tree View)](reference/apis-arkui/arkui-ts/ohos-arkui-advanced-TreeView.md)
        - Security Component
        ...
        - Types
          ...
          - [Common Text Component APIs](reference/apis-arkui/arkui-ts/ts-text-common.md)
  ...
  - ArkWeb<!--arkweb-api-->
    ...
    - C APIs<!--arkweb-c-->
      ...
      - Header Files and Structs<!--arkweb-headerfile-struct-->
    ...
    - ArkTS APIs<!--basic-services-arkts-->
      ...
      - Process and Thread Communication
        ...
        - Common Events
          ...
          - [Account Kit Common Events](reference/apis-basic-services-kit/common_event/commonEvent-accountkit.md)
          <!--Del-->
  ...
  - Data Loss Prevention Kit<!--data-loss-prevention-api-->
    - ArkTS APIs<!--data-loss-prevention-arkts-->
      ...
      <!--DelEnd-->
    - Error Codes<!--data-loss-prevention-arkts-errcode-->
  ...
  - Media Library Kit<!--media-library-api-->
    - ArkTS APIs<!--media-library-arkts-->
      ...
      <!--DelEnd-->
      - APIs No Longer Maintained<!--media-arkts-dep-->
  ...
  - MindSpore Lite Kit<!--mindspore-lite-api-->
    ...
    <!--Del-->
    - Error Codes<!--mindspore-lite-errcode-->
