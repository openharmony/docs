...
- Development
  ...
  - Media
    ...
    - Audio and Video
      ...
      - [Screen Capture(C/C++)](media/avscreen-capture.md)
    ...
    - Camera
      ...
      - Camera Development (ArkTS)
        - [Device Input Management (ArkTS)](media/camera-device-input.md)
        - [Session Management (ArkTS)](media/camera-session-management.md)
        - [Camera Preview (ArkTS)](media/camera-preview.md)
        - [Camera Photographing (ArkTS)](media/camera-shooting.md)
        - [Camera Recording (ArkTS)](media/camera-recording.md)
        - [Camera Metadata (ArkTS)](media/camera-metadata.md)
      - Best Practices (ArkTS)
        - [Camera Photographing Sample (ArkTS)](media/camera-shooting-case.md)
        - [Camera Recording Sample (ArkTS)](media/camera-recording-case.md)
        - [Taking Photos in Portrait Mode (ArkTS)](media/camera-mode.md)
        - [Dual-Channel Preview (ArkTS)](media/camera-dual-channel-preview.md)
        - [Using Performance Improvement Features (for System Applications Only) (ArkTS)](media/camera-performance-improvement.md)
      - Image
        - [Device Input Management (C/C++)](media/native-camera-device-input.md)
        - [Camera Session Management (C/C++)](media/native-camera-session-management.md)
        - [Camera Preview (C/C++)](media/native-camera-preview.md)
        - [Secondary Processing of Preview Streams (C/C++)](media/native-camera-preview-imageReceiver.md)
        - [Camera Photographing (C/C++)](media/native-camera-shooting.md)
        - [Camera Recording (C/C++)](media/native-camera-recording.md)
        - [Secondary Processing of Video Streams (C/C++)](media/native-camera-recording-imageReceiver.md)
        - [Camera Metadata (C/C++)](media/native-camera-metadata.md)
      - Camera Best Practices (C/C++)
        - [Camera Photographing Sample (C/C++)](media/native-camera-shooting-case.md)
        - [Camera Recording Sample (C/C++)](media/native-camera-recording-case.md)
        - [Sample of Secondary Processing of Recording Streams (C/C++)](media/native-camera-recording-case-imageReceiver.md)
    - Image
      ...
      - Image Processing
        ...
        - [Pixel Map Operation (ArkTS)](media/image-pixelmap-operation.md)
  ...
  - Security
    - Access Control
      ...
      - [DLP Overview](security/DataLossPreventionKit/dlp-overview.md)
      - [DLP Development](security/DataLossPreventionKit/dlp-guidelines.md)
    - User Authentication
      - [User Authentication Overview](security/UserAuthenticationKit/user-authentication-overview.md)
    ...
    - HUKS
      - [HUKS Overview](security/UniversalKeystoreKit/huks-overview.md)
...
- Encryption and Decryption
  ...
  - File Management
    - [File Management Overview](file-management/core-file-kit-intro.md)
    - Application Files
...
- API References
  ...
  - ArkTS API Reference
    ...
    - Ability Framework
      - Stage Model (Recommended)
        ...
        - [@ohos.app.ability.InsightIntentContext @ohos.app.ability.InsightIntentContext (InsightIntent Call Execution Context)](reference/apis/js-apis-app-ability-insightIntentContext.md)
        - [@ohos.app.ability.insightIntentDriver @ohos.app.ability.insightIntentDriver (Executing InsightIntent Calls)](reference/apis/js-apis-app-ability-insightIntentDriver.md)
        - [@ohos.app.ability.InsightIntentExecutor (Base Class for InsightIntent Call Execution)](reference/apis/js-apis-app-ability-insightIntentExecutor.md)
    ...
    - Common Event and Notification
      ...
      - Common Events
        ...
        - [Common Events of the Window Management Subsystem](reference/apis/common_event/commonEvent-window.md)
        - [Common Events of the Network Management Subsystem](reference/apis/common_event/commonEvent-netmanager.md)
        - [Common Events of the SMS Application](reference/apis/common_event/commonEvent-mms.md)
        - [Common Events of the Telephony Subsystem](reference/apis/common_event/commonEvent-telephony.md)
        - [Common Events of the Power Management Subsystem](reference/apis/common_event/commonEvent-powermgr.md)
        - [Common Events of the NFC Subsystem](reference/apis/common_event/commonEvent-nfc.md)
        - [Common Events of the Wi-Fi Subsystem](reference/apis/common_event/commonEvent-wifi.md)
        - [Common Events of the USB Subsystem](reference/apis/common_event/commonEvent-usb.md)
        - [Common Events of the File Management Subsystem](reference/apis/common_event/commonEvent-filemanagement.md)
        - [Common Events of the Theme Framework - Lock Screen](reference/apis/common_event/commonEvent-screenlock.md)
        - [Common Events of the Time and Time Zone Subsystem](reference/apis/common_event/commonEvent-time.md)
        - [Common Events of the Account Subsystem](reference/apis/common_event/commonEvent-account.md)
    - Bundle Management
      ...
      - [@ohos.bundle.bundleResourceManager (bundleResourceManager)](reference/apis/js-apis-bundleResourceManager.md)
    ...
    - UI Page
      ...
      - [@ohos.arkui.observer (Observer)](reference/apis/js-apis-arkui-observer.md)
    ...
    - Graphics
      ...
      - [@ohos.graphics.displaySync (Variable Frame Rate)](reference/apis/js-apis-graphics-displaySync.md)
      - [@ohos.graphics.hdrCapability (HDR Capability)](reference/apis/js-apis-hdrCapability.md)
      - [@ohos.PiPWindow (PiP Window)](reference/apis/js-apis-pipWindow.md)
    ...
    - Multimedia
      ...
      - [@ohos.multimedia.audioHaptic (Audio-Haptic)](reference/apis/js-apis-audioHaptic.md)
      ...
      - multimedia
        ...
        - [systemTonePlayer (System Alert Tone Player)](reference/apis/js-apis-inner-multimedia-systemTonePlayer.md)
    - Resource Management
    ...
    - Security
      ...
      - [@ohos.security.certManager @ohos.security.certManager (Certificate Management)](reference/apis/js-apis-certManager.md)
    ...
    - Data Management
      ...
      - [@ohos.data.cloudExtension (Device-Cloud Sharing Extension)](reference/apis/js-apis-data-cloudExtension.md)
      - [@ohos.data.commonType (Common Data Types)](reference/apis/js-apis-data-commonType.md)
    ...
    - Connectivity
      ...
      - [@ohos.secureElement (SE Management)](reference/apis/js-apis-secureElement.md)
    ...
    - Basic Features
      ...
      - [@ohos.base (Public Callback Information)](reference/apis/js-apis-base.md)
      ...
      - [@ohos.inputMethod.Panel (Input Method Panel)](reference/apis/js-apis-inputmethod-panel.md)
      - [@ohos.inputMethodList (Input Method List)](reference/apis/js-apis-inputmethodlist.md)
    ...
    - Device Management
      ...
      - [@ohos.distributedHardware.hardwareManager (Distributed Hardware Management)](reference/apis/js-apis-distributedHardwareManager.md)
      ...
      - [@ohos.multimodalInput.intentionCode (Intention Code)](reference/apis/js-apis-intentioncode.md)
    ...
    - Enterprise Device Management
      - [Enterprise Device Management Overview (for System Applications Only)](reference/apis/enterpriseDeviceManagement-overview.md)
      ...
      - [@ohos.enterprise.deviceSettings (Device Settings Management)](reference/apis/js-apis-enterprise-deviceSettings.md)
      ...
      - [@ohos.enterprise.locationManager (Location Service Management)](reference/apis/js-apis-enterprise-locationManager.md)
      ...
      - [@ohos.enterprise.securityManager (Security Management)](reference/apis/js-apis-enterprise-securityManager.md)
      - [@ohos.enterprise.bluetoothManager (Bluetooth Management)](reference/apis/js-apis-enterprise-bluetoothManager.md)
      - [@ohos.enterprise.systemManager (System Management)](reference/apis/js-apis-enterprise-systemManager.md)
    ...
    - Application services
      ...
      - [@ohos.advertising (Ads Service Framework)](reference/apis/js-apis-advertising.md)
      - [@ohos.advertising.AdComponent (Non-Full-Screen Ad Component)](reference/apis/js-apis-adcomponent.md)
      - [@ohos.advertising.AdsServiceExtensionAbility (ExtensionAbility for Ads)](reference/apis/js-apis-adsserviceextensionability.md)
      - [@ohos.advertising.AutoAdComponent (Carousel Ad Component)](reference/apis/js-apis-autoadcomponent.md)
    - Test
  ...
  - Component Reference (ArkTS-based Declarative Development Paradigm)
    ...
    - Universal Component Information
      ...
      - Universal Attributes
        ...
        - [Foreground Blur](reference/arkui-ts/ts-universal-attributes-foreground-blur-style.md)
        - [Click Effect](reference/arkui-ts/ts-universal-attributes-click-effect.md)
        - [Accessibility](reference/arkui-ts/ts-universal-attributes-accessibility.md)
        - [Attribute Modifier](reference/arkui-ts/ts-universal-attributes-attribute-modifier.md)
        - [Outline](reference/arkui-ts/ts-universal-attributes-outline.md)
        - Touch Interactions
        ...
        - [Obscuring](reference/arkui-ts/ts-universal-attributes-obscured.md)
        ...
        - [Event Monopolization](reference/arkui-ts/ts-universal-attributes-monopolize-events.md)
        - [Cursor Control](reference/arkui-ts/ts-universal-attributes-cursor.md)
      - Gesture Handling
        ...
        - [Custom Gesture Judgment](reference/arkui-ts/ts-gesture-customize-judge.md)
    - Basic Components
    ...
    - Advanced Components
      - [@ohos.advertising.AdComponent (Non-Full-Screen Ad Component)](reference/arkui-ts/../apis/js-apis-adcomponent.md)
      - [@ohos.advertising.AutoAdComponent (Carousel Ad Component))](reference/arkui-ts/../apis/js-apis-autoadcomponent.md)
      - [@ohos.arkui.advanced.Chip (Chip)](reference/arkui-ts/ts-composite-components-chip.md)
      ...
      - [@ohos.arkui.advanced.Popup (Popup)](reference/arkui-ts/ohos-arkui-advanced-popup.md)
      - [@ohos.arkui.advanced.SegmentButton (Segment Button)](reference/arkui-ts/ohos-arkui-advanced-segmentbutton.md)
      - [@ohos.arkui.advanced.SelectionMenu (Context Menu on Selection)](reference/arkui-ts/ts-composite-components-selectionmenu.md)
  ...
  - Component Reference (JavaScript-compatible Web-like Development Paradigm - ArkUI.Lite)
    ...
    - Universal Component Information
      ...
      - [Media Query](reference/arkui-js-lite/js-components-common-mediaquery.md)
    - Container Components
  ...
  - Error Codes
    ...
    - Security
      ...
      - [Certificate Management Error Codes](reference/errorcodes/errorcode-certManager.md)
    ...
    - Connectivity
      ...
      - [SE Error Codes](reference/errorcodes/errorcode-se.md)
    ...
    - Device Management
      ...
      - [Battery Info Error Codes](reference/errorcodes/errorcode-battery-info.md)
    - Customization
    ...
    - Application services
      ...
      - [Ads Service Framework Error Codes](reference/errorcodes/errorcode-ads.md)
    - Test
      - [UiTest Error Codes](reference/errorcodes/errorcode-uitest.md)
  - Native APIs
    - [Native API Introduction](reference/native-api-intro.md)
    - Modules
    ...
    - Standard Libraries
      - [libc](reference/native-lib/third_party_libc/musl.md)
      - [c++](reference/native-lib/third_party_libc/cpp.md)
