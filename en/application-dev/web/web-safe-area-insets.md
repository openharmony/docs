...
- Use [setWindowLayoutFullScreen](../reference/apis-arkui/js-apis-window.md#setwindowlayoutfullscreen9) to set the application window to full screen. When the window is displayed in full screen, the **Web** component can be displayed in non-safe areas.
