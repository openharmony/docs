...
If a historical record exists, [accessBackward()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#accessbackward) will return **true**. Similarly, you can call [accessForward()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#accessforward) to check whether a next record exists. If you skip the check, [forward()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#forward) and [backward()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#backward) will not trigger any action if the user has navigated to the end of history records.
