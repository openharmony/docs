...
- [onFirstContentfulPaint](../reference/apis-arkweb/ts-basic-components-web-events.md#onfirstcontentfulpaint10): triggered when the web page content such as a text, image, non-blank Canvas, or SVG is drawn for the first time.
