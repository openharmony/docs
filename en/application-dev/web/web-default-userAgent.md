...
In the following example, [getUserAgent()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#getuseragent) is used to obtain the default **User-Agent** string, which you can modify or extend as needed.
...
Since API version 20, you can use the [getCustomUserAgent()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#getcustomuseragent10) API to obtain a custom user agent.
