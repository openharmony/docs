...
The application can listen for page zoom scale changes through the [onScaleChange](../reference/apis-arkweb/ts-basic-components-web-events.md#onscalechange9) API.
...
You can call the [zoom](../reference/apis-arkweb/js-apis-webview-WebviewController.md#zoom), [zoomIn](../reference/apis-arkweb/js-apis-webview-WebviewController.md#zoomin) and [zoomOut](../reference/apis-arkweb/js-apis-webview-WebviewController.md#zoomout) APIs to control the page zoom scale.
