...
Currently, ArkWeb does not provide default dialog boxes. To ensure that the dialog box of a web page can be used properly, the application needs to customize the dialog box through the [onAlert](../reference/apis-arkweb/ts-basic-components-web-events.md#onalert), [onConfirm](../reference/apis-arkweb/ts-basic-components-web-events.md#onconfirm), and [onPrompt](../reference/apis-arkweb/ts-basic-components-web-events.md#onprompt9) APIs.
...
An application can listen for the **alert** method of a web page through the [onAlert](../reference/apis-arkweb/ts-basic-components-web-events.md#onalert) event and create a dialog box.
...
An application can listen for the **confirm** method of a web page through the [onConfirm](../reference/apis-arkweb/ts-basic-components-web-events.md#onconfirm) event and create a dialog box.
...
An application can listen for the **prompt** method of a web page through the [onPrompt](../reference/apis-arkweb/ts-basic-components-web-events.md#onprompt9) event and create a dialog box.
