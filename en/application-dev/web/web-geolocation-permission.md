...
Since API version 9, the **Web** component supports the [GeolocationPermissions](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md) class and [onGeolocationShow](../reference/apis-arkweb/ts-basic-components-web-events.md#ongeolocationshow) method for managing web page location permissions. For details, see <!--RP1-->[Privacy Protection](../../device-dev/security/security-privacy-protection.md)<!--RP1End-->.

The **Web** component determines whether to grant the frontend page permission based on the response of the [GeolocationPermissions](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md) class and [onGeolocationShow](../reference/apis-arkweb/ts-basic-components-web-events.md#ongeolocationshow) method. Users can grant applications access to their location for services such as navigation and weather forecasts.
...
## Managing Location Permissions
The Web component provides the [GeolocationPermissions](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md) class for managing web page location permissions, including [allowgeolocation](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md#allowgeolocation) for adding a location permission, [getaccessiblegeolocation](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md#getaccessiblegeolocation) for viewing location permissions, and [deleteallgeolocation](../reference/apis-arkweb/js-apis-webview-GeolocationPermissions.md#deleteallgeolocation) for deleting a location permission.  
