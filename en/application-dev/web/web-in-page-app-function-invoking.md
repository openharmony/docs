...
- Sample code for using [javaScriptProxy()](../reference/apis-arkweb/ts-basic-components-web-attributes.md#javascriptproxy):
  ...
  ```
- Sample code for the application using [registerJavaScriptProxy()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#registerjavascriptproxy) for registration:
  ...
  > **NOTE**
  >
  > - You need to call the [refresh()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#refresh) method for the registration to take effect after using the [registerJavaScriptProxy()](../reference/apis-arkweb/js-apis-webview-WebviewController.md#registerjavascriptproxy) method.
