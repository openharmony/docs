...
<!--Tester: @lotsof-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=b74b00cc5805225620b940e38531d901e6362478 translatedAt=2026-08-15T01:48:46.331Z pushedAt=2026-08-15T07:39:20.596Z -->
...
- Tasks executed in sequence. For example, a data preprocessing task is executed before a model training task.
...
- task2/task3 and task4 form a consumer-producer dependency. This means that task4 can write data A only after task2 and task3 read data A.
...
> **NOTE**
>
> The `ffrt_submit_h_f` and `ffrt_submit_f` APIs can receive raw function pointer tasks as parameters. If there are pre-processing and post-processing operations on the task, refer to the [ffrt_alloc_auto_managed_function_storage_base](ffrt-api-guideline-c.md#ffrt_alloc_auto_managed_function_storage_base) function to construct the task structure.

## Example: Fibonacci Sequence

Each number in the Fibonacci sequence is the sum of the two preceding numbers. The process of calculating the Fibonacci number can well express the task dependency through the data object. The code for calculating the Fibonacci number using the FFRT framework is as follows:
...
The tasks form a call tree within FFRT.
