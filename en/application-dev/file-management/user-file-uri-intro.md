...
2. Call [getAssets](../reference/apis-media-library-kit/js-apis-photoAccessHelper.md#getassets) or [createAsset](../reference/apis-media-library-kit/js-apis-photoAccessHelper.md#createasset) API in (../reference/apis-media-library-kit/js-apis-photoAccessHelper.md) to obtain the URIs of the selected files.<!--Del-->
