...
- Backup and restore are not supported when [**launchType** is **singleton**](../quick-start/module-configuration-file.md#abilities).
       ...
       "extensionAbilities": [
           {
               ...
               // and onRestore or onRestoreEx. The onBackupEx and onRestoreEx methods are recommended.
...
>
> Assume that the temporary directory is **/data/storage/el2/base/.backup/restore/**, and the data backup directory of the application is **data/storage/el2/base/files/A/**.
>
