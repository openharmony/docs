...
If your application needs to support share and saving of user files (such as images and videos), you can use OpenHarmony [FilePicker](../reference/apis/js-apis-file-picker.md) to implement the functions of selecting and saving user files. No permission is required if your application uses **FilePicker** to access files.
