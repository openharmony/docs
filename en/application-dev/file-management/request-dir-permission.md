...
1. Obtain the path to a user folder, for example, **Download**.
   ...
   ```
    ...
    > **NOTE**
    >
    > Currently, the API for obtaining the user directory cannot be used. You need to specify the sandbox path of the user directory. For details, see [Directory Environment Capability](../reference/apis-core-file-kit/js-apis-file-environment.md).
...
> **NOTE**
>
> Currently, the API for obtaining the user directory cannot be used. You need to specify the sandbox path of the user directory. For details, see [Environment](../reference/apis-core-file-kit/_environment.md).
