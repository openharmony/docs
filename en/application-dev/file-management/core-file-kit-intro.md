...
File management provides capabilities for accessing and managing application files and user files. You can use the file management APIs to manage, search for, and back up different types of files efficiently.

The files are classified into the following types based on the file owner:
