...
> **NOTE**
>
> When calling the update method, you can use it to update the animation parameters. The input parameters are the same as those of [createAnimator](../reference/apis-arkui/js-apis-arkui-UIContext.md#createanimator).
