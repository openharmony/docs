...
In the following example, page transition animations are defined using [pushUrl](../reference/apis-arkui/js-apis-arkui-UIContext.md#pushurl) for all the page transition scenarios.
