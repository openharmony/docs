...
- Component area (blue block): size of the component, subject to the [width](../reference/arkui-ts/ts-universal-attributes-size.md#attributes) and [height](../reference/arkui-ts/ts-universal-attributes-size.md#attributes) attributes.
