...
1. The @Link decorator cannot be used in custom components decorated by [\@Entry](https://gitee.com/openharmony/docs/blob/master/en/application-dev/ui/state-management/arkts-create-custom-components.md#basic-structure-of-a-custom-component).
