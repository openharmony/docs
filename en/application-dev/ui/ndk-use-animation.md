...
> 
> - Animation property changes must be encapsulated within the callback of [ArkUI_ContextCallback](../reference/apis-arkui/_ark_u_i___context_callback.md).
> 
...
1. Obtain [UIContext](../reference//apis-arkui/js-apis-arkui-UIContext.md#uicontext) in the .ets file and pass **this.getUIContext()** as a parameter to the native API.
   ```ts
