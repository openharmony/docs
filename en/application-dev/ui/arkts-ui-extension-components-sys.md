...
| [XComponent](../reference/apis-arkui/arkui-ts/ts-basic-components-xcomponent.md) | Not supported | Can be used for [EGL/OpenGLES](../../third-party-cases/how-to-use-opengl-to-draw-3d-graphics.md) and media data writing, with the content displayed on the XComponent. | — |
