...
You can set the listening port, log output level, and feature switch of the hdc server by configuring the corresponding system environment variables. For details, see [Optional Configuration Items](#optional-configuration-items).
