...
Application error management APIs are provided by the [errorManager](../reference/apis-ability-kit/js-apis-app-ability-errorManager.md) module. For details about how to import the module to use related APIs, see [Development Example](#development-example).
