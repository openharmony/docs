...
8. Executes a specific option of a system capability.
    ...
    **Example**
    ...
    Use the **-t** parameter to disable the automatic screen-off function; use the **-f** parameter to enable the automatic screen-off function or restart the device to enable the automatic screen-off function.
