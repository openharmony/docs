...
> **NOTE**
>
> The ImageReceiver works as a consumer and needs a matching producer to provide data to work properly. Typical producers are the camera's photo or preview streams.
...
Read [Image](../../reference/apis-image-kit/js-apis-image.md#imagereceiver9) for APIs related to ImageReceiver.
