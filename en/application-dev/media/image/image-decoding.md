...
Image decoding refers to the process of decoding an image in a supported format into a [PixelMap](../../reference/apis-image-kit/js-apis-image.md#pixelmap7) for image display or processing. Currently, the following image formats are supported: JPEG, PNG, GIF, WebP, BMP, SVG, ICO, DNG, and HEIF. The supported formats may vary depending on the hardware.
