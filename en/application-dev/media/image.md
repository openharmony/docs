...
// Capture error information when an exception occurs during function invoking.
    ...
    console.log('Failed to create pixelmap.' + error);
})
...
// Capture release failure information.
    ...
    console.log('Failed to release pixelmap.' + error);
})
```
...
if (imageSourceApi == null) {
    console.log('Failed to create imageSource.');
}
...
if (imagePackerApi == null) {
    console.log('Failed to create imagePacker.');
}
