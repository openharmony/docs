...
<!-- md-trans-meta sourceCommit=03da8d98875c99278437bdd28f12d4fdb3efd8f7 translatedAt=2026-08-10T09:15:40.781Z pushedAt=2026-08-10T11:52:16.915Z -->

An app can call **CameraPicker** to take photos or record videos without requesting camera permissions.

The camera interaction UI of the camera picker is provided by the system. After a user taps the capture and confirm buttons, the application that invokes the camera picker obtains a photo or video.
...
For detailed API descriptions, see [@ohos.multimedia.cameraPicker (Camera Picker)](../../reference/apis-camera-kit/js-apis-cameraPicker.md).
...
For the **fileIo** API calling methods, see [createRandomAccessFileSync](../../reference/apis-core-file-kit/js-apis-file-fs.md#fileiocreaterandomaccessfilesync10) and [getUriFromPath](../../reference/apis-core-file-kit/js-apis-file-fileuri.md#fileurigeturifrompath).
