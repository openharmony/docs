...
- Standardize background playback management
  ...
  The system enforces strict control over background playback. For applications that have not integrated with AVSession when they move to the background, their audio playback are forcibly paused. This prevents malicious applications from playing audio in the background.
