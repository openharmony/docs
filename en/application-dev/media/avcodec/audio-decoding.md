...
5. Call **OH_AudioCodec_Configure()** to configure the decoder.
   ...
   The range of values of Audio Decoding Type are described as follows:
   | Audio Decoding Type/Sampling Rate(Hz) | 8000 | 11025 | 12000 | 16000 | 22050 | 24000 | 32000 | 44100 | 48000 | 64000 | 88200 | 96000 | 176400 | 192000 |
   | ------------------------------------- | :--: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :----: | :----: |
   |                  AAC                  |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |        |        |
   |                  Flac                 |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |        |    √   |
   |                 Vorbis                |   √  |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √    |    √   |
   ...
   | Audio Decoding Type/Channels |   1   |   2   |   3   |   4   |   5   |   6   |   7   |   8   |
   | ---------------------------- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
   |              AAC             |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |
   |              Flac            |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |
   |             Vorbis           |   √   |   √   |   √   |   √   |   √   |   √   |   √   |   √   |
...
> **HINT**
>
> The streams generated by the MP3 audio-encoding process cannot be directly decoded by the MP3 audio-decoding process. It is recommended to proceed through process (PCM streams->MP3 audio-encoding->muxer->demuxer->MP3 audio-encoding).
...
10. Call **OH_AudioCodec_FreeOutputBuffer()** to output decoded PCM streams.
