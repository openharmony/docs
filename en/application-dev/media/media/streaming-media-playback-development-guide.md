...
This topic describes only how to implement streaming media playback. For details about other scenarios such as local playback, see [Video Playback](video-playback.md).
