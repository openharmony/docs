...
- After a Worker is created, its lifecycle must be managed manually. A maximum of 64 Worker threads can run simultaneously. For details, see [Precautions for Lifecycle Management](#precautions-for-lifecycle-management).
...
- Before referencing a HAR or HSP, configure the dependency on the HAR or HSP. For details, see [Referencing a Shared Package](https://developer.huawei.com/consumer/en/doc/harmonyos-guides-V14/ide-har-import-V14).
          ...
          RelativeContainer() {
            Text(this.message)
              ...
              .onClick(() => {
                ...
                // Register the onerror callback to capture exceptions generated during the execution of the Worker thread. This callback is executed in the host thread.
