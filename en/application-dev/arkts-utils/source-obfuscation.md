...
The capabilities of each obfuscation option were introduced in different versions of the SDK. For details, see [Mappings Between Obfuscation Options and Minimum SDK Versions](#mappings-between-obfuscation-options-and-minimum-sdk-versions).
...
The capabilities of each retention option were introduced in different versions of the SDK. For details, see [Mappings Between Obfuscation Options and Minimum SDK Versions](#mappings-between-obfuscation-options-and-minimum-sdk-versions).
...
- **Remote HAR packages** 
  Content of the **obfuscation.txt** file in the remote HAR package. 
...
* **obfuscation.txt** files in the dependent remote HAR
...
If a HAP or HSP is built, no **obfuscation.txt** will be generated.
...
The merged result is the current module's obfuscation rules and the dependent modules' obfuscation rules. 

When the obfuscation configuration file specified by **consumerFiles** contains the following obfuscation rules, these rules will be merged into the **obfuscation.txt** file of a remote HAR, whereas other obfuscation rules will not.
```
// Obfuscation options
-enable-property-obfuscation
-enable-string-property-obfuscation
...
**Precautions for Obfuscation in HAR**
