...
## When to Use
Dynamic imports can be used in application development when you need to import modules conditionally or on-demand, as an alternative to [static import]. The following are some cases where you might want to use dynamic import:
