...
1. Import the **uniformTypeDescriptor** module.
2. Obtain the UTD type ID (**typeId**) based on the file name extension .mp3.
...
import { uniformTypeDescriptor } from '@kit.ArkData';
try {
  // 2. Obtain the UTD type ID based on the file name extension .mp3.
  let fileExtention = '.mp3';
...
1. Import the **uniformTypeDescriptor** module.
2. Obtain the UTD type ID based on the MIME type **audio/mp3**.
3. Obtain the MIME types based on the UTD type ID.
