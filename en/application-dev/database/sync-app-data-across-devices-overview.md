...
- Strong consistency: When data is inserted, deleted, or modified on a device, other devices in the same network can immediately read data and obtain the updated data.
