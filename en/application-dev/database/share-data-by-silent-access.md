...
If the service is too complex, you can use [DataShareExtensionAbility](../reference/apis/js-apis-application-dataShareExtensionAbility.md) to start the data provider.
...
Most of the APIs for silent access are executed asynchronously in callback or promise mode. In the following table, callback-based APIs are used as an example. For more information about the APIs, see [Data Sharing](../reference/apis/js-apis-data-dataShare.md).
...
1. In the **module.json5** file, set the data to be shared in **proxyData**. For details about the configuration method, see [module.json5 Configuration File](../quick-start/module-configuration-file.md).
   ...
   **Table 1** proxyData in module.json5
   ...
   | requiredWritePermission | Permission required for writing data to the data proxy. If this parameter is not set, other applications are not allowed to write data to the data proxy. For details about the supported permissions, see [Application Permission List](../security/permission-list.md).         | No   |
...
In the **module.json5** file, set the data to be hosted in **proxyData**. For details about the configuration method, see [module.json5 Configuration File](../quick-start/module-configuration-file.md).
...
| uri                     | URI of the data proxy, which is the unique identifier for cross-application data access.      | Yes   |
| requiredReadPermission  | Permission required for reading data from the data proxy. If this parameter is not set, other applications are not allowed to access data. For details about the supported permissions, see [Application Permission List](../security/permission-list.md).| No   |
| requiredWritePermission | Permission required for writing data to the data proxy. If this parameter is not set, other applications are not allowed to write data to the dta proxy. For details about the supported permissions, see [Application Permission List](../security/permission-list.md).| No   |
