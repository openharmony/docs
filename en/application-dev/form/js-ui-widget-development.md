...
To create a widget in the stage model, you need to implement the lifecycle callbacks of FormExtensionAbility. Create a widget template in DevEco Studio by referring to [Creating a Service Widget](https://developer.harmonyos.com/en/docs/documentation/doc-guides-V3/ide_service_widget-0000001078566997-V3) and then perform the following:
