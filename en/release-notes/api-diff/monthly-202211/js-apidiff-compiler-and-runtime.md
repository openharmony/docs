...
|Added||Method or attribute name: onmessage<br>Function name: onmessage?: (this: ThreadWorkerGlobalScope, ev: MessageEvents) => void;|@ohos.worker.d.ts|
|Added||Method or attribute name: onmessageerror<br>Function name: onmessageerror?: (this: ThreadWorkerGlobalScope, ev: MessageEvents) => void;|@ohos.worker.d.ts|
|Added||Method or attribute name: onmessage<br>Function name: onmessage?: (event: MessageEvents) => void;|@ohos.worker.d.ts|
|Added||Method or attribute name: onmessageerror<br>Function name: onmessageerror?: (event: MessageEvents) => void;|@ohos.worker.d.ts|
