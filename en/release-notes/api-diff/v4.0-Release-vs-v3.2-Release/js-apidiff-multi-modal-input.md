...
|Access level changed|Class name: KeyOptions;<br>Method or attribute name: preKeys: Array\<number>;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: preKeys: Array\<number>;<br>New version: systemapi|@ohos.multimodalInput.inputConsumer.d.ts|
|Access level changed|Class name: KeyOptions;<br>Method or attribute name: finalKey: number;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: finalKey: number;<br>New version: systemapi|@ohos.multimodalInput.inputConsumer.d.ts|
|Access level changed|Class name: KeyOptions;<br>Method or attribute name: isFinalKeyDown: boolean;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: isFinalKeyDown: boolean;<br>New version: systemapi|@ohos.multimodalInput.inputConsumer.d.ts|
|Access level changed|Class name: KeyOptions;<br>Method or attribute name: finalKeyDownDuration: number;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: finalKeyDownDuration: number;<br>New version: systemapi|@ohos.multimodalInput.inputConsumer.d.ts|
|Access level changed|Class name: KeyEvent;<br>Method or attribute name: isPressed: boolean;<br>Deprecated version: |Class name: KeyEvent;<br>Method or attribute name: isPressed: boolean;<br>New version: systemapi|@ohos.multimodalInput.inputEventClient.d.ts|
|Access level changed|Class name: KeyEvent;<br>Method or attribute name: keyCode: number;<br>Deprecated version: |Class name: KeyEvent;<br>Method or attribute name: keyCode: number;<br>New version: systemapi|@ohos.multimodalInput.inputEventClient.d.ts|
|Access level changed|Class name: KeyEvent;<br>Method or attribute name: keyDownDuration: number;<br>Deprecated version: |Class name: KeyEvent;<br>Method or attribute name: keyDownDuration: number;<br>New version: systemapi|@ohos.multimodalInput.inputEventClient.d.ts|
|Access level changed|Class name: KeyEvent;<br>Method or attribute name: isIntercepted: boolean;<br>Deprecated version: |Class name: KeyEvent;<br>Method or attribute name: isIntercepted: boolean;<br>New version: systemapi|@ohos.multimodalInput.inputEventClient.d.ts|
|Permission changed|Class name: TouchEventReceiver;<br>Method or attribute name: interface TouchEventReceiver<br>Deprecated version: |Class name: TouchEventReceiver;<br>Method or attribute name: interface TouchEventReceiver<br>New version: ohos.permission.INPUT_MONITORING|@ohos.multimodalInput.inputMonitor.d.ts|
|Type changed|Class name: KeyOptions;<br>Method or attribute name: preKeys: Array\<number>;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: preKeys: Array\<number>;<br>New version: Array\<number>|@ohos.multimodalInput.inputConsumer.d.ts|
|Type changed|Class name: KeyOptions;<br>Method or attribute name: finalKey: number;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: finalKey: number;<br>New version: number|@ohos.multimodalInput.inputConsumer.d.ts|
|Type changed|Class name: KeyOptions;<br>Method or attribute name: isFinalKeyDown: boolean;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: isFinalKeyDown: boolean;<br>New version: boolean|@ohos.multimodalInput.inputConsumer.d.ts|
|Type changed|Class name: KeyOptions;<br>Method or attribute name: finalKeyDownDuration: number;<br>Deprecated version: |Class name: KeyOptions;<br>Method or attribute name: finalKeyDownDuration: number;<br>New version: number|@ohos.multimodalInput.inputConsumer.d.ts|
|Type changed|Class name: DeviceListener;<br>Method or attribute name: type: ChangedType;<br>Deprecated version: |Class name: DeviceListener;<br>Method or attribute name: type: ChangedType;<br>New version: ChangedType|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: DeviceListener;<br>Method or attribute name: deviceId: number;<br>Deprecated version: |Class name: DeviceListener;<br>Method or attribute name: deviceId: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: source: SourceType;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: source: SourceType;<br>New version: SourceType|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: axis: AxisType;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: axis: AxisType;<br>New version: AxisType|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: max: number;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: max: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: min: number;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: min: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: fuzz: number;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: fuzz: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: flat: number;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: flat: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: AxisRange;<br>Method or attribute name: resolution: number;<br>Deprecated version: |Class name: AxisRange;<br>Method or attribute name: resolution: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: id: number;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: id: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: name: string;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: name: string;<br>New version: string|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: sources: Array\<SourceType>;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: sources: Array\<SourceType>;<br>New version: Array\<SourceType>|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: axisRanges: Array\<AxisRange>;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: axisRanges: Array\<AxisRange>;<br>New version: Array\<AxisRange>|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: bus: number;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: bus: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: product: number;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: product: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: vendor: number;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: vendor: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: version: number;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: version: number;<br>New version: number|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: phys: string;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: phys: string;<br>New version: string|@ohos.multimodalInput.inputDevice.d.ts|
|Type changed|Class name: InputDeviceData;<br>Method or attribute name: uniq: string;<br>Deprecated version: |Class name: InputDeviceData;<br>Method or attribute name: uniq: string;<br>New version: string|@ohos.multimodalInput.inputDevice.d.ts|
