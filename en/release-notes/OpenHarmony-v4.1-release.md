...
- For details about the API changes over OpenHarmony 4.1 Beta1, see [API Differences](api-diff/v4.1-Release-vs-v4.1-beta1/Readme-EN.md).
- For details about the API changes over OpenHarmony 4.0 Release, see [API Differences](api-diff/v4.1-Release-vs-v4.0-Release/Readme-EN.md).

A few API changes over OpenHarmony 4.1 Beta1 may cause your application projects to be incompatible. For details about these changes, see [Changelogs](changelogs/v4.1-Release/Readme-EN.md).
