...
| Public SDK | Ohos_sdk_public 3.2.11.9 (API Version 9 Release) | This toolkit is intended for application developers and does not contain system APIs that require system permissions. It is provided as standard in DevEco Studio.<br/>To use the full SDK, you must download the source code, build the source code, and switch to the full SDK. For details, see [Guide to Building Full SDK](../application-dev/quick-start/full-sdk-compile-guide.md). |
...
- [API Differences Between OpenHarmony 3.2 Release and 3.2 Beta5](api-change/Beta5-to-v3.2-Release/Readme-EN.md)
- [API Differences Between OpenHarmony 3.2 Release and 3.1 Release](api-change/v3.2-Release/Readme-EN.md)
