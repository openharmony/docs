...
A few API changes over OpenHarmony 4.0 Beta2 may cause your application projects to be incompatible. For details about these changes, see [Changelogs](changelogs/v4.0-Release/Readme-EN.md).
