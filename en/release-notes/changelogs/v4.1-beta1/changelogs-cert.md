...
See [Certificate Development Guide](../../../application-dev/security/DeviceCertificateKit/create-parse-verify-cert-object.md) and [Certificate APIs](../../../application-dev/reference/apis/js-apis-cert.md).
