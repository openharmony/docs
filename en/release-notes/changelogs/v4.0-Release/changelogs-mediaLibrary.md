...
The compatibility of some [mediaLibrary](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-medialibrary.md) APIs is changed.

1. Due to the change of the directory structure of the file subsystem, the **mediaLibrary** APIs will no longer be used to access document directories (**Documents** and **Download**). Use the [FilePicker](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-picker.md) APIs instead.
...
2. The URI format of the corresponding assets is changed. For details, see [Change of the userFileManager FileAsset Attribute](changelogs-file-management.md#clfile2-change-of-the-userfilemanager-fileasset-attribute).
...
The **getFileAssets** API cannot be used to obtain file assets in the **Documents** and **Download** directories. Use the [FilePicker](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-picker.md) APIs instead.

**createAsset**:

If **relativePath** in **createAsset()** is set to a directory in **Documents** or **Download**), the file asset cannot be created in the specified directory. Use the [FilePicker](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-picker.md) APIs instead.

**deleteAsset**:

If **URI** in **deleteAsset()** specifies a file asset in the **Documents** or **Download** directory, the specified file asset cannot be deleted. Use [fileAccess.delete](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-fileAccess.md) APIs instead.
...
If **MediaAssetOption.relativePath** in **storeMediaAsset()** is set to a path of the file in the **Documents** or **Download**) directory, the file asset cannot be stored. Use the [FilePicker](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-picker.md) APIs instead.
...
Do not use the **mediaLibrary** APIs to access or operate the files in the **Documents** and **Download** directories. Use the [FilePicker](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-picker.md) APIs instead.
...
5. Call [fs.writeSync](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-fs.md#writesync) to edit the file based on the FD.
...
4. After the UI is returned from **DocumentViewPicker**, call [fs.openSync](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-fs.md#fsopensync) to open the file based on the URI and obtain the FD.
5. Call [fs.writeSync](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-fs.md#writesync) to edit the file based on the FD.
6. After the edit, call [fs.closeSync](https://gitee.com/openharmony/docs/tree/OpenHarmony-4.0-Release/en/application-dev/reference/apis/js-apis-file-fs.md#closesync) to close the FD.
