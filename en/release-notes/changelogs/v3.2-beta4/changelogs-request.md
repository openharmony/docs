...
- Error information is returned via the **error** object in **AsyncCallback** or **Promise**. Wherein, parameter type or quantity error information is returned by throwing an exception.
