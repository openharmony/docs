...
- The processing of the [upload and download error codes](https://gitee.com/openharmony/docs/blob/en/OpenHarmony-3.2-Beta4/application-dev/reference/errorcodes/errorcode-request.md) is added to the upload and download APIs.
